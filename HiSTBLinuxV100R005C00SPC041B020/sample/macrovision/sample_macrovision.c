...
HI_S32 main(HI_S32 argc, HI_CHAR *argv[])
{
    ...
    while (1)
    {
        ...
        if ('a' == InputCmd[0])
        {
            HI_UNF_DISP_SetFormat(HI_UNF_DISPLAY1,HI_UNF_ENC_FMT_720P_50);

            HI_UNF_DISP_SetFormat(HI_UNF_DISPLAY0,HI_UNF_ENC_FMT_PAL);

            HI_UNF_DISP_SetMacrovision(HI_UNF_DISPLAY0,HI_UNF_DISP_MACROVISION_MODE_TYPE0,HI_NULL);
        ...
        if ('b' == InputCmd[0])
        {
            ...
            HI_UNF_DISP_SetMacrovision(HI_UNF_DISPLAY0,HI_UNF_DISP_MACROVISION_MODE_TYPE1,HI_NULL);
        ...
        if ('c' == InputCmd[0])
        {
            ...
            HI_UNF_DISP_SetMacrovision(HI_UNF_DISPLAY0,HI_UNF_DISP_MACROVISION_MODE_TYPE2,HI_NULL);
        ...
        if ('d' == InputCmd[0])
        {
            ...
            HI_UNF_DISP_SetMacrovision(HI_UNF_DISPLAY0,HI_UNF_DISP_MACROVISION_MODE_TYPE3,HI_NULL);
        ...
        if ('e' == InputCmd[0])
        {
            HI_UNF_DISP_SetFormat(HI_UNF_DISPLAY1,HI_UNF_ENC_FMT_720P_60);

            HI_UNF_DISP_SetFormat(HI_UNF_DISPLAY0,HI_UNF_ENC_FMT_NTSC);
