...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/czyong/makefile-gcc5.1-glibc2.22-aarch64/_install/aarch64-gcc51_glibc222-linux-gnu/aarch64-gcc51_glibc222-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
