...
static const char *optstring = "d:T:G:r:m:o:D:h?vVe:c:g:f:Fp:k:x:X:j:R:l:j:UQq";
...
static const struct option longopts[] = {
	...
	{"stat-rulelist" ,     1, NULL, 'T'},
	{"stat-dbglevel" ,     1, NULL, 'G'},
	{NULL, 0, NULL, 0}
};
...
"-T, --rulefile           assign stat-rule in this file\n"
"-G, --debuglevel         debuglevle for stat-rule\n"
...
static int get_options(int argc, char**argv)
{
	...
	while (1) {
		...
		case 'U':
			...
			break;
		case 'T':
			ra_rulefile = strdup(optarg); 
			break;
		case 'G':
			ra_debuglevel = strtoll(optarg, &endp, 10);
			break;
		}
	}
			 ...
			 int non_existing)
{
	...
	for (; !non_existing;) {
		...
		if (ra_sys_lstat(name, &dent_st) == -1) {
