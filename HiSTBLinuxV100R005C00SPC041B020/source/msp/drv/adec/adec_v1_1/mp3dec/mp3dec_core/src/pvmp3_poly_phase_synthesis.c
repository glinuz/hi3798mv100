...
void pvmp3_poly_phase_synthesis_mp2(tmp3dec_chan   *pChVars,
                                int32          numChannels,
                                e_equalization equalizerType,
                                int16          *outPcm,
                                int16 filterbands)
{
    ...
    int16 * ptr_out;
    int32  band;
    pvmp3_equalizer_mp2(pChVars->circ_buffer,
                    equalizerType,
                    pChVars->work_buf_int32,filterbands);
    ...
    {
        int32 *inData  = &pChVars->circ_buffer[((filterbands-1)*SUBBANDS_NUMBER) - (band<<5)];
    ...
    pv_memmove(&pChVars->circ_buffer[(filterbands*SUBBANDS_NUMBER)],
               pChVars->circ_buffer,
               480*sizeof(*pChVars->circ_buffer));
