...
HI_S32 USRDATA_SetUserAddr(HI_HANDLE hHandle, HI_U64 u64Addr)
{
    ...
    return BUFMNG_SetUserAddr(g_stUsrData[hHandle].hBuf, u64Addr);
}
...
HI_S32 USRDATA_Rls(HI_HANDLE hHandle, VDEC_VIDEO_USERDATA_S* pstUsrData)
{
    HI_S32 s32Ret;
    BUFMNG_BUF_S stBuf;
