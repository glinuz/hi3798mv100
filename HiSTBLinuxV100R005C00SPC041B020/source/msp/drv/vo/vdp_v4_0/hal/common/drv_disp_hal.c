...
HI_S32 PF_SetHisiHdrMode(HI_DRV_DISP_HISI_HDR_CFG_S *pstDrvHdrCfg,HI_PQ_HDR_CFG *pstPqHdrCfg)
{
    ...
    VDP_HISI_HDR_CFG_S stHalHdrCfg;
...
{
    VDP_DRV_MaskAndBackupGfx(u32GfxLayerId,pu32Alpha,pu32MuteState);
    return;
}

HI_VOID PF_UnmaskGfx(HI_U32 u32GfxLayerId,HI_U32 u32Alpha,HI_U32 u32MuteState)
{
    VDP_DRV_UnmaskGfx(u32GfxLayerId,u32Alpha,u32MuteState);
    return;
}

HI_VOID PF_SetGfxMixvBypassState(HI_U32 u32GfxLayerId,HI_BOOL bEnable)
{
    VDP_DRV_SetGfxMixvBypassState(u32GfxLayerId,bEnable);
    return;
}
...
HI_S32 DISP_HAL_Init(HI_U32 u32Base)
{
    ...
    s_stIntfOps.PF_MaskAndBackupGfx      = PF_MaskAndBackupGfx;
    s_stIntfOps.PF_UnmaskGfx             = PF_UnmaskGfx;
    s_stIntfOps.PF_SetGfxMixvBypassState = PF_SetGfxMixvBypassState;
