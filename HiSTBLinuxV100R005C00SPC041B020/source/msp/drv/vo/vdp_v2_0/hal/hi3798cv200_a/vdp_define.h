...
#define    VDP_DISP_DIGFMT_TMP  VDP_DISP_DIGFMT_720P50

#define VDP_CLK_MODE_300MHZ     1
#define VDP_CLK_MODE_345_6MHZ   0
//#define VDP_CLK_MODE_250MHZ     2
#define VDP_CLK_MODE_200MHZ     2
...
#define VDP_BUF_SIZE 0x6000000
#define VDP_GFX_BUF_ADDR (VDP_BUF_ADDR + VDP_BUF_SIZE)
#define VDP_WBC_BUF_ADDR VDP_GFX_BUF_ADDR
//(VDP_GFX_BUF_ADDR + 2*VDP_BUF_STRIDE)

#define VDP_BUF_STRIDE  0x01000000




//#define printk HI_PRINT
#define VGA_MUX  0
//#define OPTM_STREAM_MAX_SIZE 0x6000000L
#define VDP_STREAM_PHY_BASE_ADDR ((HI_U32)0x30000000uL)
...
//VOU寄存器列表物理基地址
#define DISP_BASE_ADDRESS   0xf8cc0000
#define DISP_INT_NUMBER   122

//VOU系统时钟控制寄存器

//VOU LVDS 寄存器
#define OPTM_REGS_LVDS_SET 0xF8A22028
...
#define GFX_CSC_EN     1
#define SR_EN          1
#define SR_COEF_AXI    1  //sr coef axi
#define ES_EN          1
#define ZME_NON_LINEAR 1
...
//-----------------------------------
#define VDP_BASE_ADDR     0xff120000
...
#if FPGA_TEST
#define W_2880P   2880
#define W_2160P   128//1920//3840
#define H_2160P   128//1080//2160
#define W_1600P   2560
#define H_1600P   1600
#define W_1080P   1920
#define H_1080P   1080
...
typedef enum tagS5V100_OUTPUT_TYPE_E
{
    S5V100_OUTPUT_INT_LVDSPHY_1080P60Hz = 0,
    S5V100_OUTPUT_INT_LVDSPHY_1080P120Hz,
    S5V100_OUTPUT_INT_VBOPHY_4K2K60Hz,
    S5V100_OUTPUT_INT_CVBS,


    S5V100_OUTPUT_INT_BUTT
} S5V100_OUTPUT_TYPE_E;

typedef enum tagINT_VECTOR
{
    VDP_INT_CHN0 = 1,
    VDP_INT_CHN1    ,
    VDP_INT_CHN2    ,//DSD0
...
typedef enum
{
    ...
    VDP_LAYER_CONN_CBM2 = 0x1,//include HC
...
typedef struct tagVDP_DISP_DIMMING_ZMEV
{
    ...
    int  dPhase;/*（horz/vert,lum/chrom）initial phase*/
...
#define  VDP_FILE_NAME_SIZE 255
typedef struct tagVDP_DISP_DIMMING_CFG_S
{
    char	BLCInputFileBMP[VDP_FILE_NAME_SIZE];
    char	BLCOutputFileBMP[VDP_FILE_NAME_SIZE];
...
typedef enum tagVDP_INTF_MODE_E
{
    VDP_INTF_MODE_NON_4K60  = 0,
    VDP_INTF_MODE_4K60_ALL,
    VDP_INTF_MODE_4K60_HDMI420,
    VDP_INTF_MODE_BUTT
}VDP_INTF_MODE_E;
