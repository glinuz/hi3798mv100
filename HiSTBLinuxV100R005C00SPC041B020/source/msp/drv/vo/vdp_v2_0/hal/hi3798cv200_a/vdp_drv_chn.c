...
HI_U32	gu32_ret[MAX_CHK_CHN][MAX_CHK_FRM];



HI_VOID VDP_DISP_Hdmi420CSel(HI_U32 u32hd_id, HI_U32 hdmi420cSel)
{
    ...
    DHD0_CTRL.bits.hdmi420c_sel = hdmi420cSel;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_CTRL.u32)+u32hd_id*CHN_OFFSET),DHD0_CTRL.u32);
}

HI_VOID VDP_DISP_Hdmi420En(HI_U32 u32hd_id, HI_U32 hdmi420en)
{
    U_DHD0_CTRL DHD0_CTRL;
    if(u32hd_id >= CHN_MAX)
    {
    ...
    DHD0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_CTRL.u32)+u32hd_id*CHN_OFFSET));
    DHD0_CTRL.bits.hdmi420_en = hdmi420en;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_CTRL.u32)+u32hd_id*CHN_OFFSET),DHD0_CTRL.u32);
}
...
//VICAP LOCK
HI_VOID VDP_DISP_LockMeaSure(HI_U32 u32hd_id, HI_U32 measure_en)
{
    ...
    DHD0_LOCKCFG.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_LOCKCFG.u32)+u32hd_id*CHN_OFFSET));
    DHD0_LOCKCFG.bits.measure_en = measure_en;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_LOCKCFG.u32)+u32hd_id*CHN_OFFSET),DHD0_LOCKCFG.u32);
...
HI_VOID VDP_DISP_SetUfOffineEn (HI_U32 u32hd_id, HI_U32 u32UfOfflineEn)
{
    ...
    if(u32hd_id >= CHN_MAX)
    {
        HI_PRINT("Error, VDP_DISP_SetUfOffineEn Select Wrong CHANNEL ID\n");
        return ;
    }
...
HI_VOID VDP_DISP_LockCnt (HI_U32 u32hd_id, HI_U32 cnt_en)
{
    U_DHD0_CTRL DHD0_CTRL;
    if(u32hd_id >= CHN_MAX)
    {
    ...
    DHD0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_CTRL.u32)+u32hd_id*CHN_OFFSET));
    DHD0_CTRL.bits.uf_offline_en = cnt_en;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_CTRL.u32)+u32hd_id*CHN_OFFSET),DHD0_CTRL.u32);
}
...
HI_VOID  VDP_DISP_OpenTypIntf(HI_U32 u32hd_id, VDP_DISP_DIGFMT_E enDigFmt)
{
    ...
    switch(enDigFmt)
    {
        ...
        case VDP_DISP_DIGFMT_2160P60:
        {
            ...
            stSyncInfo.u32Hfb   = 20000;//88*2;
            stSyncInfo.u32Hbb   = 10000;//192*2;
        ...
        case VDP_DISP_DIGFMT_1366x768:
        {
            ...
            stSyncInfo.u32Vact = 768;
            stSyncInfo.u32Vfb  = 3;
            stSyncInfo.u32Vbb  = 27;

            stSyncInfo.u32Hact = 1366;
            stSyncInfo.u32Hfb  = 70;
            stSyncInfo.u32Hbb  = 356;

            stSyncInfo.u32Bvact = 1;
            stSyncInfo.u32Bvfb  = 1;
            stSyncInfo.u32Bvbb  = 1;

            stSyncInfo.u32Hpw = 0x143;
            stSyncInfo.u32Vpw = 0x3;

            stSyncInfo.u32Hmid = 0x1;
            //stIntfFmt = VDP_DISP_INTFDATAFMT_YCBCR422;
        ...
        case VDP_DISP_DIGFMT_3840x2160:
        {
            HI_PRINT("Now is TestMode VDP_DISP_DIGFMT_3840x2160 \n");
            ...
            stSyncInfo.bIop = 1;
                ...
                stSyncInfo.u32Vfb  = 8;
                stSyncInfo.u32Vbb  = 82;

                stSyncInfo.u32Hact = 3840;
                stSyncInfo.u32Hfb  = 1276;
                stSyncInfo.u32Hbb  = 384;
...
//        {
//            DHD0_SYNC_INV.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_SYNC_INV.u32)+u32hd_id*CHN_OFFSET));
...
HI_VOID VDP_DISP_SetPwmCtrlRefreshCmd(HI_U32 u32hd_id, HI_U32 u32RefreshCmd)
{
    U_PWM_CONTROL  PWM_CONTROL;

    if(u32hd_id >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetPwmCtrlRefreshCmd Select Wrong CHANNEL ID\n");
        return ;
    }

    //Set Vou Dhd Channel Gamma Correct Enable
    PWM_CONTROL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET));
    PWM_CONTROL.bits.refresh_cmd = u32RefreshCmd;
    VDP_RegWrite((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET), PWM_CONTROL.u32);
}
HI_VOID VDP_DISP_SetPwmCtrlSyncWhole(HI_U32 u32hd_id, HI_U32 u32SyncWhole)
{
    U_PWM_CONTROL  PWM_CONTROL;

    if(u32hd_id >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetPwmCtrlSyncWhole Select Wrong CHANNEL ID\n");
        return ;
    }

    //Set Vou Dhd Channel Gamma Correct Enable
    PWM_CONTROL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET));
    PWM_CONTROL.bits.sync_whole = u32SyncWhole;
    VDP_RegWrite((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET), PWM_CONTROL.u32);
}

HI_VOID VDP_DISP_SetPwmCtrlSyncVsync(HI_U32 u32hd_id, HI_U32 u32SyncVsync)
{
    U_PWM_CONTROL  PWM_CONTROL;

    if(u32hd_id >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetPwmCtrlSyncVsync Select Wrong CHANNEL ID\n");
        return ;
    }

    //Set Vou Dhd Channel Gamma Correct Enable
    PWM_CONTROL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET));
    PWM_CONTROL.bits.sync_vsync = u32SyncVsync;
    VDP_RegWrite((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET), PWM_CONTROL.u32);
}

HI_VOID VDP_DISP_SetPwmCtrlDutySel(HI_U32 u32hd_id, HI_U32 u32DutySel)
{
    U_PWM_CONTROL  PWM_CONTROL;

    if(u32hd_id >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetPwmCtrlDutySel Select Wrong CHANNEL ID\n");
        return ;
    }

    //Set Vou Dhd Channel Gamma Correct Enable
    PWM_CONTROL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET));
    PWM_CONTROL.bits.dimming_duty_sel = u32DutySel;
    VDP_RegWrite((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET), PWM_CONTROL.u32);
}
HI_VOID VDP_DISP_SetPwmCtrlInv(HI_U32 u32hd_id, HI_U32 u32PwmInv)
{
    U_PWM_CONTROL  PWM_CONTROL;

    if(u32hd_id >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetPwmCtrlInv Select Wrong CHANNEL ID\n");
        return ;
    }

    //Set Vou Dhd Channel Gamma Correct Enable
    PWM_CONTROL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET));
    PWM_CONTROL.bits.dimming_pwm_inv = u32PwmInv;
    VDP_RegWrite((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET), PWM_CONTROL.u32);
}

HI_VOID VDP_DISP_SetPwmVsyncRise(HI_U32 u32hd_id, HI_U32 u32VsyncRise)
{
    U_PWM_CONTROL  PWM_CONTROL;

    if(u32hd_id >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetPwmVsyncRise Select Wrong CHANNEL ID\n");
        return ;
    }

    //Set Vou Dhd Channel Gamma Correct Enable
    PWM_CONTROL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET));
    PWM_CONTROL.bits.dimming_vsync_rise = u32VsyncRise;
    VDP_RegWrite((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET), PWM_CONTROL.u32);
}
HI_VOID VDP_DISP_SetPwmEn(HI_U32 u32hd_id, HI_U32 u32PwmEn)
{
    U_PWM_CONTROL  PWM_CONTROL;

    if(u32hd_id >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetPwmEn Select Wrong CHANNEL ID\n");
        return ;
    }

    //Set Vou Dhd Channel Gamma Correct Enable
    PWM_CONTROL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET));
    PWM_CONTROL.bits.dimming_pwm_en = u32PwmEn;
    VDP_RegWrite((HI_U32)(&(pVdpReg->PWM_CONTROL.u32)+u32hd_id*CHN_OFFSET), PWM_CONTROL.u32);
}

HI_VOID VDP_DISP_SetPwmDuty(HI_U32 u32hd_id, HI_U32 u32PwmDuty)
{
    U_DIMMING_PWM_DUTY  DIMMING_PWM_DUTY;

    if(u32hd_id >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetPwmDuty Select Wrong CHANNEL ID\n");
        return ;
    }

    //Set Vou Dhd Channel Gamma Correct Enable
    DIMMING_PWM_DUTY.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIMMING_PWM_DUTY.u32)+u32hd_id*CHN_OFFSET));
    DIMMING_PWM_DUTY.bits.dimming_pwm_duty = u32PwmDuty;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIMMING_PWM_DUTY.u32)+u32hd_id*CHN_OFFSET), DIMMING_PWM_DUTY.u32);
}

HI_VOID VDP_DISP_SetPwmFreq(HI_U32 u32hd_id, HI_U32 u32PwmFreq)
{
    U_PWM_FREQ  PWM_FREQ;

    if(u32hd_id >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetPwmFreq Select Wrong CHANNEL ID\n");
        return ;
    }

    //Set Vou Dhd Channel Gamma Correct Enable
    PWM_FREQ.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->PWM_FREQ.u32)+u32hd_id*CHN_OFFSET));
    PWM_FREQ.bits.pwm_freq = u32PwmFreq;
    VDP_RegWrite((HI_U32)(&(pVdpReg->PWM_FREQ.u32)+u32hd_id*CHN_OFFSET), PWM_FREQ.u32);
}
...

{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error,VDP_INTF_SetDitherMode Select Wrong INTF ID\n");
        return ;
    }


    INTF_DITHER0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_DITHER0_CTRL.u32)+u32Data*INTF_OFFSET));
    INTF_DITHER0_CTRL.bits.dither_md = enDitherMode;
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_DITHER0_CTRL.u32)+u32Data*INTF_OFFSET), INTF_DITHER0_CTRL.u32);
}
...

{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error,VDP_INTF_SetDitherCoef Select Wrong CHANNEL ID\n");
        return ;
    }

    INTF_DITHER0_COEF0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_DITHER0_COEF0.u32)+u32Data*INTF_OFFSET));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_DITHER0_COEF0.u32)+u32Data*INTF_OFFSET), INTF_DITHER0_COEF0.u32);

    INTF_DITHER0_COEF1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_DITHER0_COEF1.u32)+u32Data*INTF_OFFSET));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_DITHER0_COEF1.u32)+u32Data*INTF_OFFSET), INTF_DITHER0_COEF1.u32);
}
...
HI_VOID  VDP_INTF_SetCscEnable  (HI_U32 u32Data, HI_U32 enCSC)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error,VDP_INTF_SetCscEnable Select Wrong CHANNEL ID\n");
        return ;
    }
    INTF_CSC_IDC.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_CSC_IDC.u32)+u32Data*INTF_OFFSET));
    INTF_CSC_IDC.bits.csc_en = enCSC;
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_CSC_IDC.u32)+u32Data*INTF_OFFSET), INTF_CSC_IDC.u32);
...
HI_VOID   VDP_INTF_SetCscDcCoef(HI_U32 u32Data,VDP_CSC_DC_COEF_S stCscCoef)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error,VDP_INTF_SetCscDcCoef Select Wrong CHANNEL ID\n");
        return ;
    }
    ...
    INTF_CSC_ODC.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_CSC_ODC.u32)+u32Data*INTF_OFFSET));
    INTF_CSC_ODC.bits.cscodc1 = stCscCoef.csc_out_dc1;
    INTF_CSC_ODC.bits.cscodc0 = stCscCoef.csc_out_dc0;
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_CSC_ODC.u32)+u32Data*INTF_OFFSET), INTF_CSC_ODC.u32);

    INTF_CSC_IODC.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_CSC_IODC.u32)+u32Data*INTF_OFFSET));
    INTF_CSC_IODC.bits.cscidc2 = stCscCoef.csc_in_dc2;
    INTF_CSC_IODC.bits.cscodc2 = stCscCoef.csc_out_dc2;
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_CSC_IODC.u32)+u32Data*INTF_OFFSET), INTF_CSC_IODC.u32);
...
HI_VOID   VDP_INTF_SetCscCoef(HI_U32 u32Data,VDP_CSC_COEF_S stCscCoef)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error,VDP_INTF_SetCscCoef Select Wrong INTF ID\n");
        return ;
    }

    INTF_CSC_P0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_CSC_P0.u32)+u32Data*INTF_OFFSET));
    INTF_CSC_P0.bits.cscp00 = stCscCoef.csc_coef00;
    INTF_CSC_P0.bits.cscp01 = stCscCoef.csc_coef01;
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_CSC_P0.u32)+u32Data*INTF_OFFSET), INTF_CSC_P0.u32);

    INTF_CSC_P1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_CSC_P1.u32)+u32Data*INTF_OFFSET));
    INTF_CSC_P1.bits.cscp02 = stCscCoef.csc_coef02;
    INTF_CSC_P1.bits.cscp10 = stCscCoef.csc_coef10;
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_CSC_P1.u32)+u32Data*INTF_OFFSET), INTF_CSC_P1.u32);

    INTF_CSC_P2.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_CSC_P2.u32)+u32Data*INTF_OFFSET));
    INTF_CSC_P2.bits.cscp11 = stCscCoef.csc_coef11;
    INTF_CSC_P2.bits.cscp12 = stCscCoef.csc_coef12;
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_CSC_P2.u32)+u32Data*INTF_OFFSET), INTF_CSC_P2.u32);

    INTF_CSC_P3.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_CSC_P3.u32)+u32Data*INTF_OFFSET));
    INTF_CSC_P3.bits.cscp20 = stCscCoef.csc_coef20;
    INTF_CSC_P3.bits.cscp21 = stCscCoef.csc_coef21;
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_CSC_P3.u32)+u32Data*INTF_OFFSET), INTF_CSC_P3.u32);

    INTF_CSC_P4.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_CSC_P4.u32)+u32Data*INTF_OFFSET));
    INTF_CSC_P4.bits.cscp22 = stCscCoef.csc_coef22;
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_CSC_P4.u32)+u32Data*INTF_OFFSET), INTF_CSC_P4.u32);
...
HI_VOID  VDP_INTF_SetClipCoef (HI_U32 u32Data, VDP_DISP_CLIP_S stClipData)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error,VDP_INTF_SetClipVtt Select Wrong INTF ID\n");
        return ;
    }

    INTF_CLIP0_L.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_CLIP0_L.u32)+u32Data*INTF_OFFSET));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_CLIP0_L.u32)+u32Data*INTF_OFFSET), INTF_CLIP0_L.u32);

    INTF_CLIP0_H.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_CLIP0_H.u32)+u32Data*INTF_OFFSET));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_CLIP0_H.u32)+u32Data*INTF_OFFSET), INTF_CLIP0_H.u32);
}

HI_VOID VDP_INTF_SetHShrpEnable   (HI_U32 u32Data, bool hsp_en)
{
    U_INTF_HSPCFG1 INTF_HSPCFG1;

    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error, VDP_INTF_SetHShrpEnable() select wrong intf ID\n");
        return;
    }

    INTF_HSPCFG1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG1.u32)+u32Data*INTF_OFFSET));

    INTF_HSPCFG1.bits.hsp_en = hsp_en;

    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_HSPCFG1.u32)+u32Data*INTF_OFFSET), INTF_HSPCFG1.u32);
}
...
HI_VOID VDP_INTF_SetHShrpF0coef(HI_U32 u32Data, HI_S16 tmp0, HI_S16 tmp1, HI_S16 tmp2, HI_S16 tmp3)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error, VDP_INTF_SetHShrpF0coef() select wrong intf ID\n");
        return;
    }

    INTF_HSPCFG0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG0.u32)+u32Data*INTF_OFFSET));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_HSPCFG0.u32)+u32Data*INTF_OFFSET), INTF_HSPCFG0.u32);
}
...
HI_VOID VDP_INTF_SetHShrpF1coef(HI_U32 u32Data, HI_S16 tmp0, HI_S16 tmp1, HI_S16 tmp2, HI_S16 tmp3)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error, VDP_INTF_SetHShrpF1coef() select wrong intf ID\n");
        return;
    }

    INTF_HSPCFG7.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG7.u32)+u32Data*INTF_OFFSET));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_HSPCFG7.u32)+u32Data*INTF_OFFSET), INTF_HSPCFG7.u32);
}
...
HI_VOID VDP_INTF_SetHShrpCoring(HI_U32 u32Data, HI_U8 hf0_coring, HI_U8 hf1_coring)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error, VDP_INTF_SetHShrpCoring() select wrong intf ID\n");
        return;
    }

    INTF_HSPCFG1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG1.u32)+u32Data*INTF_OFFSET));
    INTF_HSPCFG8.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG8.u32)+u32Data*INTF_OFFSET));

    INTF_HSPCFG1.bits.hsp_hf0_coring = hf0_coring;
    INTF_HSPCFG8.bits.hsp_hf1_coring = hf1_coring;

    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_HSPCFG1.u32)+u32Data*INTF_OFFSET), INTF_HSPCFG1.u32);
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_HSPCFG8.u32)+u32Data*INTF_OFFSET), INTF_HSPCFG8.u32);
}
...
HI_VOID VDP_INTF_SetHShrpGain(HI_U32 u32Data, HI_S16 hf0_gainneg, HI_S16 hf0_gainpos, HI_S16 hf1_gainneg, HI_S16 hf1_gainpos)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error, VDP_INTF_SetHShrpGain() select wrong intf ID\n");
        return;
    }
    INTF_HSPCFG5.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG5.u32)+u32Data*INTF_OFFSET));
    INTF_HSPCFG12.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG12.u32)+u32Data*INTF_OFFSET));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_HSPCFG5.u32)+u32Data*INTF_OFFSET), INTF_HSPCFG5.u32);
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_HSPCFG12.u32)+u32Data*INTF_OFFSET), INTF_HSPCFG12.u32);
}

HI_VOID VDP_INTF_SetHShrpAdpEn(HI_U32 u32Data, bool hf0_adpshooten, bool hf1_adpshooten)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error, VDP_INTF_SetHShrpAdpEn() select wrong intf ID\n");
        return;
    }
    INTF_HSPCFG6.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG6.u32)+u32Data*INTF_OFFSET));
    INTF_HSPCFG13.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG13.u32)+u32Data*INTF_OFFSET));

    INTF_HSPCFG6.bits.hsp_hf0_adpshoot_en  = hf0_adpshooten;
    INTF_HSPCFG13.bits.hsp_hf1_adpshoot_en = hf1_adpshooten;

    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_HSPCFG6.u32)+u32Data*INTF_OFFSET), INTF_HSPCFG6.u32);
}
...
HI_VOID VDP_INTF_SetHShrpWsize(HI_U32 u32Data, HI_U8 hf0_winsize, HI_U8 hf1_winsize)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error, VDP_INTF_SetHShrpWsize() select wrong intf ID\n");
        return;
    }
    INTF_HSPCFG6.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG6.u32)+u32Data*INTF_OFFSET));
    INTF_HSPCFG13.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG13.u32)+u32Data*INTF_OFFSET));
...
HI_VOID VDP_INTF_SetHShrpThrd(HI_U32 u32Data, HI_U8 hf0_underth, HI_U8 hf0_overth, HI_U8 hf1_underth, HI_U8 hf1_overth)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error, VDP_INTF_SetHShrpThrd() select wrong intf ID\n");
        return;
    }
    INTF_HSPCFG6.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG6.u32)+u32Data*INTF_OFFSET));
    INTF_HSPCFG13.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG13.u32)+u32Data*INTF_OFFSET));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_HSPCFG6.u32)+u32Data*INTF_OFFSET), INTF_HSPCFG6.u32);
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_HSPCFG13.u32)+u32Data*INTF_OFFSET), INTF_HSPCFG13.u32);
}
...
HI_VOID VDP_INTF_SetHShrpMixratio(HI_U32 u32Data, HI_U8 hf0_mixratio, HI_U8 hf1_mixratio)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error, VDP_INTF_SetHShrpMixratio() select wrong intf ID\n");
        return;
    }
    INTF_HSPCFG6.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG6.u32)+u32Data*INTF_OFFSET));
    INTF_HSPCFG13.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG13.u32)+u32Data*INTF_OFFSET));
...
HI_VOID VDP_INTF_SetHShrpEn(HI_U32 u32Data, bool h1_en, bool h2_en, bool ltih_en, bool ctih_en)
{
    U_INTF_HSPCFG14 INTF_HSPCFG14;

    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error,VDP_INTF_SetHShrpEn() select wrong intf ID\n");
        return;
    }
    INTF_HSPCFG14.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG14.u32)+u32Data*INTF_OFFSET));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_HSPCFG14.u32)+u32Data*INTF_OFFSET), INTF_HSPCFG14.u32);
}
...
HI_VOID VDP_INTF_SetHShrpXti(HI_U32 u32Data, HI_U8 hf_shootdiv, HI_U8 lti_ratio, HI_U8 ldti_gain, HI_U8 cdti_gain)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error,VDP_INTF_SetHShrpXti() select wrong intf ID\n");
        return;
    }
    INTF_HSPCFG14.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG14.u32)+u32Data*INTF_OFFSET));
...
HI_VOID VDP_INTF_SetHShrpGlbpara(HI_U32 u32Data, HI_U8 peak_ratio, HI_U16 glb_overth, HI_U16 glb_underth)
{
    ...
    INTF_HSPCFG15.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_HSPCFG15.u32)+u32Data*INTF_OFFSET));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_HSPCFG15.u32)+u32Data*INTF_OFFSET), INTF_HSPCFG15.u32);
}
...
HI_VOID VDP_INTF_SetRegUp (HI_U32 u32Data)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error,VDP_INTF_SetIntfEnable Select Wrong interface ID\n");
        return ;
    }

    INTF_UPD.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_UPD.u32)+u32Data*INTF_OFFSET));
    INTF_UPD.bits.regup = 0x1;
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_UPD.u32)+u32Data*INTF_OFFSET),INTF_UPD.u32);
}
...
HI_VOID VDP_INTF_SetHdmiMode  (HI_U32 u32Data, HI_U32 u32hdmi_md)
{
    ...
    INTF_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_CTRL.u32)+u32Data*INTF_OFFSET));
    INTF_CTRL.bits.hdmi_mode = u32hdmi_md;
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_CTRL.u32)+u32Data*INTF_OFFSET),INTF_CTRL.u32);
}
...
HI_VOID VDP_INTF_SetSyncInv(HI_U32 u32Data, VDP_DISP_SYNCINV_S enInv)
{
    ...
    if(u32Data >= INTF_MAX)
    {
        HI_PRINT("Error,VDP_INTF_SetSync_INV Select Wrong INTF ID\n");
        return ;
    }

    INTF_SYNC_INV.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->INTF_SYNC_INV.u32)+u32Data*INTF_OFFSET));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->INTF_SYNC_INV.u32)+u32Data*INTF_OFFSET),INTF_SYNC_INV.u32);
}

HI_VOID VDP_DISP_SetHShrpEnable   (VDP_CHN_E enLayer, bool hsp_en)
{
    U_DHD0_HSPCFG1 DHD0_HSPCFG1;

    if(enLayer == VDP_CHN_DHD1)
    {
        DHD0_HSPCFG1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_HSPCFG1.u32)+CHN_OFFSET));

        DHD0_HSPCFG1.bits.hsp_en = hsp_en;

        VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_HSPCFG1.u32)+CHN_OFFSET), DHD0_HSPCFG1.u32);
    }
    else
    {
        HI_PRINT("Error, VDP_DISP_SetHShrpEnable() select wrong layer ID\n");
    }
...
HI_VOID VDP_DISP_SetHShrpF0coef(VDP_CHN_E enLayer, HI_S16 tmp0, HI_S16 tmp1, HI_S16 tmp2, HI_S16 tmp3)
{
    ...
    if(enLayer == VDP_CHN_DHD1)
    {
        DHD0_HSPCFG0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_HSPCFG0.u32)+CHN_OFFSET));
        ...
        VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_HSPCFG0.u32)+CHN_OFFSET), DHD0_HSPCFG0.u32);
    }
    else
    {
        HI_PRINT("Error, VDP_DISP_SetHShrpF0coef() select wrong layer ID\n");
    }
}
...
HI_VOID VDP_DISP_SetHShrpF1coef(VDP_CHN_E enLayer, HI_S16 tmp0, HI_S16 tmp1, HI_S16 tmp2, HI_S16 tmp3)
{
    ...
    if(enLayer == VDP_CHN_DHD1)
    {
        DHD0_HSPCFG7.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_HSPCFG7.u32)+CHN_OFFSET));
        ...
        VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_HSPCFG7.u32)+CHN_OFFSET), DHD0_HSPCFG7.u32);
    }
    else
    {
        HI_PRINT("Error, VDP_DISP_SetHShrpF1coef() select wrong layer ID\n");
    }
}
...
HI_VOID VDP_DISP_SetHShrpCoring(VDP_CHN_E enLayer, HI_U8 hf0_coring, HI_U8 hf1_coring)
{
    ...
    {
        DHD0_HSPCFG1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_HSPCFG1.u32)+CHN_OFFSET));
        DHD0_HSPCFG8.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_HSPCFG8.u32)+CHN_OFFSET));

        DHD0_HSPCFG1.bits.hsp_hf0_coring = hf0_coring;
        DHD0_HSPCFG8.bits.hsp_hf1_coring = hf1_coring;

        VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_HSPCFG1.u32)+CHN_OFFSET), DHD0_HSPCFG1.u32);
        VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_HSPCFG8.u32)+CHN_OFFSET), DHD0_HSPCFG8.u32);
    }
    else
    {
        HI_PRINT("Error, VDP_DISP_SetHShrpCoring() select wrong layer ID\n");
    }
...
HI_VOID VDP_DISP_SetHShrpGain(VDP_CHN_E enLayer, HI_S16 hf0_gainneg, HI_S16 hf0_gainpos, HI_S16 hf1_gainneg, HI_S16 hf1_gainpos)
{
    ...
    if(enLayer == VDP_CHN_DHD1)
    {
        ...
        DHD0_HSPCFG5.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_HSPCFG5.u32)+CHN_OFFSET));
        DHD0_HSPCFG12.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_HSPCFG12.u32)+CHN_OFFSET));
        ...
        VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_HSPCFG5.u32)+CHN_OFFSET), DHD0_HSPCFG5.u32);
        VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_HSPCFG12.u32)+CHN_OFFSET), DHD0_HSPCFG12.u32);
    }
    else
    {
        HI_PRINT("Error, VDP_DISP_SetHShrpGain() select wrong layer ID\n");
    }
}

HI_VOID VDP_DISP_SetHShrpAdpEn(VDP_CHN_E enLayer, bool hf0_adpshooten, bool hf1_adpshooten)
{
    ...
    if(enLayer == VDP_CHN_DHD1)
    {
        DHD0_HSPCFG6.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_HSPCFG6.u32)+CHN_OFFSET));
        DHD0_HSPCFG13.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_HSPCFG13.u32)+CHN_OFFSET));

        DHD0_HSPCFG6.bits.hsp_hf0_adpshoot_en  = hf0_adpshooten;
        DHD0_HSPCFG13.bits.hsp_hf1_adpshoot_en = hf1_adpshooten;

        VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_HSPCFG6.u32)+CHN_OFFSET), DHD0_HSPCFG6.u32);
        VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_HSPCFG13.u32)+CHN_OFFSET), DHD0_HSPCFG13.u32);
    }
    else
    {
        HI_PRINT("Error, VDP_DISP_SetHShrpAdpEn() select wrong layer ID\n");
    }
}
...
HI_VOID VDP_DISP_SetHShrpWsize(VDP_CHN_E enLayer, HI_U8 hf0_winsize, HI_U8 hf1_winsize)
{
    ...
    {
        HI_PRINT("Error, VDP_DISP_SetHShrpWsize() select wrong layer ID\n");
    }
...
HI_VOID VDP_DISP_SetHShrpThrd(VDP_CHN_E enLayer, HI_U8 hf0_underth, HI_U8 hf0_overth, HI_U8 hf1_underth, HI_U8 hf1_overth)
{
    ...
    {
        HI_PRINT("Error, VDP_DISP_SetHShrpThrd() select wrong layer ID\n");
    }
}
...
HI_VOID VDP_DISP_SetHShrpMixratio(VDP_CHN_E enLayer, HI_U8 hf0_mixratio, HI_U8 hf1_mixratio)
{
    ...
    {
        HI_PRINT("Error, VDP_DISP_SetHShrpParam() select wrong layer ID\n");
    }

}

HI_VOID VDP_DISP_SetHShrpEn(VDP_CHN_E enLayer, bool h1_en, bool h2_en, bool ltih_en, bool ctih_en)
{
    U_DHD0_HSPCFG14 DHD0_HSPCFG14;

    if(enLayer == VDP_CHN_DHD1)
    {
        DHD0_HSPCFG14.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_HSPCFG14.u32)+CHN_OFFSET));
        ...
        VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_HSPCFG14.u32)+CHN_OFFSET), DHD0_HSPCFG14.u32);
    }
    else
    {
        HI_PRINT("Error, VDP_DISP_SetHShrpEn() select wrong layer ID\n");
    }
...
HI_VOID VDP_DISP_SetHShrpXti(VDP_CHN_E enLayer, HI_U8 hf_shootdiv, HI_U8 lti_ratio, HI_U8 ldti_gain, HI_U8 cdti_gain)
{
    ...
    {
        HI_PRINT("Error, VDP_DISP_SetHShrpXti() select wrong layer ID\n");
    }
...
HI_VOID VDP_DISP_SetHShrpGlbpara(VDP_CHN_E enLayer, HI_U8 peak_ratio, HI_U16 glb_overth, HI_U16 glb_underth)
{
    ...
    if(enLayer == VDP_CHN_DHD1)
    {
        DHD0_HSPCFG15.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_HSPCFG15.u32)+CHN_OFFSET));
        ...
        VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_HSPCFG15.u32)+CHN_OFFSET), DHD0_HSPCFG15.u32);
    }
    else
    {
        HI_PRINT("Error, VDP_DISP_SetHShrpReg15() select wrong layer ID\n");
    }
}
...
HI_VOID VDP_DISP_SetTriggerEnable         (HI_U32 u32Data, HI_U32 u32Enable)
{
    ...
    DHD0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_CTRL.u32)+CHN_OFFSET));
    DHD0_CTRL.bits.trigger_en = u32Enable;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_CTRL.u32)+CHN_OFFSET), DHD0_CTRL.u32);
}
#endif
#if  0
...
HI_VOID VDP_INTF_SetLvdsBitMode(bool bBitSel)
{
    U_LVDS_CTRL LVDS_CTRL;
    U_LVDS_PHYCTRL0 LVDS_PHYCTRL0;
...
HI_VOID VDP_DISP_SetWcgEnable  (HI_U32 u32Data, HI_U32 u32Enable)
{
	...
	//set csc sign mode
	SR_CSC1_ODC.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_CSC1_ODC.u32)+ u32Data * CHN_OFFSET));
	SR_CSC1_ODC.bits.csc_sign_mode = u32Enable;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_CSC1_ODC.u32)+ u32Data * CHN_OFFSET), SR_CSC1_ODC.u32);
...
HI_VOID VDP_DISP_SetWcgCoef  (HI_U32 u32Data, VDP_WCG_COEF_S  stWcgCoef)
{
	...
	if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DHD_SetWcgCoef() Select Wrong DHD ID\n");
		return ;
	}

	DHDWCG_CSC2CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDWCG_CSC2CTRL.u32)+ u32Data * CHN_OFFSET));
	DHDWCG_CSC2CTRL.bits.csc2_scale_sel = stWcgCoef.csc2_scale_sel;
	DHDWCG_CSC2CTRL.bits.csc2_r_r_coef  = (stWcgCoef.csc2_r_r_coef);
	DHDWCG_CSC2CTRL.bits.csc2_r_g_coef  = (stWcgCoef.csc2_r_g_coef);
	VDP_RegWrite((HI_U32)(&(pVdpReg->DHDWCG_CSC2CTRL.u32)+ u32Data * CHN_OFFSET), DHDWCG_CSC2CTRL.u32);

	DHDWCG_CSC2COEF0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDWCG_CSC2COEF0.u32)+ u32Data * CHN_OFFSET));
	DHDWCG_CSC2COEF0.bits.csc2_r_b_coef  = (stWcgCoef.csc2_r_b_coef);
	DHDWCG_CSC2COEF0.bits.csc2_g_r_coef  = (stWcgCoef.csc2_g_r_coef);
	VDP_RegWrite((HI_U32)(&(pVdpReg->DHDWCG_CSC2COEF0.u32)+ u32Data * CHN_OFFSET), DHDWCG_CSC2COEF0.u32);

	DHDWCG_CSC2COEF1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDWCG_CSC2COEF1.u32)+ u32Data * CHN_OFFSET));
	DHDWCG_CSC2COEF1.bits.csc2_g_g_coef  = (stWcgCoef.csc2_g_g_coef);
	DHDWCG_CSC2COEF1.bits.csc2_g_b_coef  = (stWcgCoef.csc2_g_b_coef);
	VDP_RegWrite((HI_U32)(&(pVdpReg->DHDWCG_CSC2COEF1.u32)+ u32Data * CHN_OFFSET), DHDWCG_CSC2COEF1.u32);

	DHDWCG_CSC2COEF2.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDWCG_CSC2COEF2.u32)+ u32Data * CHN_OFFSET));
	DHDWCG_CSC2COEF2.bits.csc2_b_r_coef  = (stWcgCoef.csc2_b_r_coef);
	DHDWCG_CSC2COEF2.bits.csc2_b_g_coef  = (stWcgCoef.csc2_b_g_coef);
	VDP_RegWrite((HI_U32)(&(pVdpReg->DHDWCG_CSC2COEF2.u32)+ u32Data * CHN_OFFSET), DHDWCG_CSC2COEF2.u32);

	DHDWCG_CSC2COEF3.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDWCG_CSC2COEF3.u32)+ u32Data * CHN_OFFSET));
	DHDWCG_CSC2COEF3.bits.csc2_b_b_coef  = (stWcgCoef.csc2_b_b_coef);
	VDP_RegWrite((HI_U32)(&(pVdpReg->DHDWCG_CSC2COEF3.u32)+ u32Data * CHN_OFFSET), DHDWCG_CSC2COEF3.u32);

	//-------------------------

	DHDWCG_NON2LCTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDWCG_NON2LCTRL.u32)+ u32Data * CHN_OFFSET));
	DHDWCG_NON2LCTRL.bits.gma_lin_neg_scl  = stWcgCoef.gma_lin_neg_scl;
	DHDWCG_NON2LCTRL.bits.gma_lin_init_slp = stWcgCoef.gma_lin_init_slp;
	DHDWCG_NON2LCTRL.bits.gma_lin_thre_0   = stWcgCoef.gma_lin_thre_0;
	DHDWCG_NON2LCTRL.bits.gma_lin_thre_1   = stWcgCoef.gma_lin_thre_1;
	DHDWCG_NON2LCTRL.bits.gma_lin_thre_2   = stWcgCoef.gma_lin_thre_2;
	VDP_RegWrite((HI_U32)(&(pVdpReg->DHDWCG_NON2LCTRL.u32)+ u32Data * CHN_OFFSET), DHDWCG_NON2LCTRL.u32);

	DHDWCG_NON2LCOEF0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDWCG_NON2LCOEF0.u32)+ u32Data * CHN_OFFSET));
	DHDWCG_NON2LCOEF0.bits.gma_lin_coef_a_0  = stWcgCoef.gma_lin_coef_a_0;
	DHDWCG_NON2LCOEF0.bits.gma_lin_coef_b_0  = stWcgCoef.gma_lin_coef_b_0;
	DHDWCG_NON2LCOEF0.bits.gma_lin_coef_c_0  = stWcgCoef.gma_lin_coef_c_0;
	VDP_RegWrite((HI_U32)(&(pVdpReg->DHDWCG_NON2LCOEF0.u32)+ u32Data * CHN_OFFSET), DHDWCG_NON2LCOEF0.u32);

	DHDWCG_NON2LCOEF1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDWCG_NON2LCOEF1.u32)+ u32Data * CHN_OFFSET));
	DHDWCG_NON2LCOEF1.bits.gma_lin_coef_a_1  = stWcgCoef.gma_lin_coef_a_1;
	DHDWCG_NON2LCOEF1.bits.gma_lin_coef_b_1  = stWcgCoef.gma_lin_coef_b_1;
	DHDWCG_NON2LCOEF1.bits.gma_lin_coef_c_1  = stWcgCoef.gma_lin_coef_c_1;
	VDP_RegWrite((HI_U32)(&(pVdpReg->DHDWCG_NON2LCOEF1.u32)+ u32Data * CHN_OFFSET), DHDWCG_NON2LCOEF1.u32);

	DHDWCG_NON2LCOEF2.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDWCG_NON2LCOEF2.u32)+ u32Data * CHN_OFFSET));
	DHDWCG_NON2LCOEF2.bits.gma_lin_coef_a_2  = stWcgCoef.gma_lin_coef_a_2;
	DHDWCG_NON2LCOEF2.bits.gma_lin_coef_b_2  = stWcgCoef.gma_lin_coef_b_2;
	DHDWCG_NON2LCOEF2.bits.gma_lin_coef_c_2  = stWcgCoef.gma_lin_coef_c_2;
	VDP_RegWrite((HI_U32)(&(pVdpReg->DHDWCG_NON2LCOEF2.u32)+ u32Data * CHN_OFFSET), DHDWCG_NON2LCOEF2.u32);

	DHDWCG_L2NONTHD.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDWCG_L2NONTHD.u32)+ u32Data * CHN_OFFSET));
	DHDWCG_L2NONTHD.bits.lin_gma_thre_0  = stWcgCoef.lin_gma_thre_0;
	DHDWCG_L2NONTHD.bits.lin_gma_thre_1  = stWcgCoef.lin_gma_thre_1;
	DHDWCG_L2NONTHD.bits.lin_gma_thre_2  = stWcgCoef.lin_gma_thre_2;
	VDP_RegWrite((HI_U32)(&(pVdpReg->DHDWCG_L2NONTHD.u32)+ u32Data * CHN_OFFSET), DHDWCG_L2NONTHD.u32);

	DHDWCG_L2NONCOEF0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDWCG_L2NONCOEF0.u32)+ u32Data * CHN_OFFSET));
	DHDWCG_L2NONCOEF0.bits.lin_gma_coef_a_0  = stWcgCoef.lin_gma_coef_a_0;
	DHDWCG_L2NONCOEF0.bits.lin_gma_coef_b_0  = stWcgCoef.lin_gma_coef_b_0;
	DHDWCG_L2NONCOEF0.bits.lin_gma_coef_c_0  = stWcgCoef.lin_gma_coef_c_0;
	VDP_RegWrite((HI_U32)(&(pVdpReg->DHDWCG_L2NONCOEF0.u32)+ u32Data * CHN_OFFSET), DHDWCG_L2NONCOEF0.u32);

	DHDWCG_L2NONCOEF1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDWCG_L2NONCOEF1.u32)+ u32Data * CHN_OFFSET));
	DHDWCG_L2NONCOEF1.bits.lin_gma_coef_a_1  = stWcgCoef.lin_gma_coef_a_1;
	DHDWCG_L2NONCOEF1.bits.lin_gma_coef_b_1  = stWcgCoef.lin_gma_coef_b_1;
	DHDWCG_L2NONCOEF1.bits.lin_gma_coef_c_1  = stWcgCoef.lin_gma_coef_c_1;
	VDP_RegWrite((HI_U32)(&(pVdpReg->DHDWCG_L2NONCOEF1.u32)+ u32Data * CHN_OFFSET), DHDWCG_L2NONCOEF1.u32);

	DHDWCG_L2NONCOEF2.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDWCG_L2NONCOEF2.u32)+ u32Data * CHN_OFFSET));
	DHDWCG_L2NONCOEF2.bits.lin_gma_coef_a_2  = stWcgCoef.lin_gma_coef_a_2;
	DHDWCG_L2NONCOEF2.bits.lin_gma_coef_b_2  = stWcgCoef.lin_gma_coef_b_2;
	DHDWCG_L2NONCOEF2.bits.lin_gma_coef_c_2  = stWcgCoef.lin_gma_coef_c_2;
	VDP_RegWrite((HI_U32)(&(pVdpReg->DHDWCG_L2NONCOEF2.u32)+ u32Data * CHN_OFFSET), DHDWCG_L2NONCOEF2.u32);
...
HI_VOID VDP_DISP_SetSrDspSta (HI_U32 u32Data, VDP_SR_MODE_E enMd)
{
	...
	if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrDspSta() Select Wrong Video Layer ID\n");
		return ;
	}
...
HI_VOID VDP_DISP_SetSrDemoCtrl (HI_U32 u32Data, VDP_SR_DEMO_E DemoCtrl)
{
	...
	if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_VID_SetSrMux() Select Wrong Video Layer ID\n");
		return ;
	}
...
HI_VOID VDP_DISP_SetSrDirCtrl (HI_U32 u32Data, HI_U32 u32DirHvCtrl,HI_U32 u32DirDgCtrl)
{
	...
	if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrDirCtrl() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_DIR_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_DIR_CTRL.u32) + u32Data * CHN_OFFSET));
	SR_DIR_CTRL.bits.dir_hv_ctrl = u32DirHvCtrl;
	SR_DIR_CTRL.bits.dir_dg_ctrl = u32DirDgCtrl;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_DIR_CTRL.u32) + u32Data * CHN_OFFSET), SR_DIR_CTRL.u32);
}
...
HI_VOID VDP_DISP_SetSrZmeAlphaFirMode (HI_U32 u32Data, HI_U32 u32HFirMode, HI_U32 u32VFirMode)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetSrZmeAlphaFirMode() Select Wrong Video Layer ID\n");
        return ;
    }
...
HI_VOID VDP_DISP_SetSrGradThres (HI_U32 u32Data, HI_U32 u32GradThresH, HI_U32 u32GradThresL)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrGradThres() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_RINGDT0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_RINGDT0.u32) + u32Data * CHN_OFFSET));
	SR_RINGDT0.bits.grad_thres_h = u32GradThresH;
	SR_RINGDT0.bits.grad_thres_l = u32GradThresL;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_RINGDT0.u32) + u32Data * CHN_OFFSET), SR_RINGDT0.u32);
}
...
HI_VOID VDP_DISP_SetSrGradFlatThr (HI_U32 u32Data, HI_U32 u32GradFlatThr)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrGradFlatThr() Select Wrong Video Layer ID\n");
		return ;
	}
...
HI_VOID VDP_DISP_SetSrRingdtEn (HI_U32 u32Data, HI_U32 u32RingdtEn)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrRingdtEn() Select Wrong Video Layer ID\n");
		return ;
	}
...
HI_VOID VDP_DISP_SetSrGradFlatThr2 (HI_U32 u32Data, HI_U32 u32GradFlatThr2)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrGradFlatThr2() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_RINGDT1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_RINGDT1.u32) + u32Data * CHN_OFFSET));
	SR_RINGDT1.bits.grad_flat_thr2 = u32GradFlatThr2;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_RINGDT1.u32) + u32Data * CHN_OFFSET), SR_RINGDT1.u32);
}
...
HI_VOID VDP_DISP_SetSrSkindtEn (HI_U32 u32Data, HI_U32 u32SkindtEn)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrSkindtEn() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_SKINDT_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_SKINDT_CTRL.u32) + u32Data * CHN_OFFSET));
	SR_SKINDT_CTRL.bits.skindt_en = u32SkindtEn;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_SKINDT_CTRL.u32) + u32Data * CHN_OFFSET), SR_SKINDT_CTRL.u32);
}
...
HI_VOID VDP_DISP_SetSrClipData (HI_U32 u32Data, HI_U32 u32ClipData)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrClipData() Select Wrong Video Layer ID\n");
		return ;
	}
...
HI_VOID VDP_DISP_SetSrSkindtExp (HI_U32 u32Data, HI_U32 u32SkindtExpY, HI_U32 u32SkindtExpU, HI_U32 u32SkindtExpV)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrSkindtExp() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_SKINDT_EXP.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_SKINDT_EXP.u32) + u32Data * CHN_OFFSET));
	...
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_SKINDT_EXP.u32) + u32Data * CHN_OFFSET), SR_SKINDT_EXP.u32);
}
...
HI_VOID VDP_DISP_SetSrSkindtYthr (HI_U32 u32Data, HI_U32 u32YThresH, HI_U32 u32YThresL, HI_U32 u32YSlop)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrSkindtYthr() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_SKINDT_YTHR.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_SKINDT_YTHR.u32) + u32Data * CHN_OFFSET));
	SR_SKINDT_YTHR.bits.y_thres_h = u32YThresH;
	SR_SKINDT_YTHR.bits.y_thres_l = u32YThresL;
	SR_SKINDT_YTHR.bits.y_slop = u32YSlop;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_SKINDT_YTHR.u32) + u32Data * CHN_OFFSET), SR_SKINDT_YTHR.u32);
}
...
HI_VOID VDP_DISP_SetSrSkindtUthr (HI_U32 u32Data, HI_U32 u32UThresH, HI_U32 u32UThresL, HI_U32 u32USlop)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrSkindtUthr() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_SKINDT_UTHR.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_SKINDT_UTHR.u32) + u32Data * CHN_OFFSET));
	SR_SKINDT_UTHR.bits.u_thres_h = u32UThresH;
	SR_SKINDT_UTHR.bits.u_thres_l = u32UThresL;
	SR_SKINDT_UTHR.bits.u_slop = u32USlop;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_SKINDT_UTHR.u32) + u32Data * CHN_OFFSET), SR_SKINDT_UTHR.u32);
}
...
HI_VOID VDP_DISP_SetSrSkindtVthr (HI_U32 u32Data, HI_U32 u32VThresH, HI_U32 u32VThresL, HI_U32 u32VSlop)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrSkindtVthr() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_SKINDT_VTHR.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_SKINDT_VTHR.u32) + u32Data * CHN_OFFSET));
	SR_SKINDT_VTHR.bits.v_thres_h = u32VThresH;
	SR_SKINDT_VTHR.bits.v_thres_l = u32VThresL;
	SR_SKINDT_VTHR.bits.v_slop = u32VSlop;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_SKINDT_VTHR.u32) + u32Data * CHN_OFFSET), SR_SKINDT_VTHR.u32);
}
...
HI_VOID VDP_DISP_SetSrHanceSlop (HI_U32 u32Data, HI_U32 u32HighSlop, HI_U32 u32LowSlop)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrHanceSlop() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_HANCE_SLOP.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HANCE_SLOP.u32) + u32Data * CHN_OFFSET));
	SR_HANCE_SLOP.bits.sharp_high_slop   = u32HighSlop;
	SR_HANCE_SLOP.bits.sharp_low_slop    = u32LowSlop ;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HANCE_SLOP.u32) + u32Data * CHN_OFFSET), SR_HANCE_SLOP.u32);
}
...
HI_VOID VDP_DISP_SetSrSharpThr (HI_U32 u32Data, HI_U32 u32SrSharpThrH, HI_U32 u32SrSharpThrL)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrSharpThr() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_HANCE_SHARP_THR.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HANCE_SHARP_THR.u32) + u32Data * CHN_OFFSET));
	SR_HANCE_SHARP_THR.bits.sharp_thres_h = u32SrSharpThrH;
	SR_HANCE_SHARP_THR.bits.sharp_thres_l = u32SrSharpThrL;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HANCE_SHARP_THR.u32) + u32Data * CHN_OFFSET), SR_HANCE_SHARP_THR.u32);
}
...
HI_VOID VDP_DISP_SetSrHanceLowCtrl (HI_U32 u32Data, HI_U32 u32LowCtrlH, HI_U32 u32LowCtrlL)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrHanceLowCtrl() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_HANCE_LOW_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HANCE_LOW_CTRL.u32) + u32Data * CHN_OFFSET));
	SR_HANCE_LOW_CTRL.bits.sharp_low_ctrl_h = u32LowCtrlH;
	SR_HANCE_LOW_CTRL.bits.sharp_low_ctrl_l = u32LowCtrlL;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HANCE_LOW_CTRL.u32) + u32Data * CHN_OFFSET), SR_HANCE_LOW_CTRL.u32);
}
...
HI_VOID VDP_DISP_SetSrHanceHighCtrl (HI_U32 u32Data, HI_U32 u32HighCtrlH, HI_U32 u32HighCtrlL)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrHanceHighCtrl() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_HANCE_HIGH_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HANCE_HIGH_CTRL.u32) + u32Data * CHN_OFFSET));
	SR_HANCE_HIGH_CTRL.bits.sharp_high_ctrl_h = u32HighCtrlH;
	SR_HANCE_HIGH_CTRL.bits.sharp_high_ctrl_l = u32HighCtrlL;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HANCE_HIGH_CTRL.u32) + u32Data * CHN_OFFSET), SR_HANCE_HIGH_CTRL.u32);
}
...
HI_VOID VDP_DISP_SetSrSharpStart (HI_U32 u32Data, HI_U32 u32SharpStartH, HI_U32 u32SharpStartL)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrSharpStart() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_HANCE_THR0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HANCE_THR0.u32) + u32Data * CHN_OFFSET));
	SR_HANCE_THR0.bits.sharp_high_start = u32SharpStartH;
	SR_HANCE_THR0.bits.sharp_low_start = u32SharpStartL;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HANCE_THR0.u32) + u32Data * CHN_OFFSET), SR_HANCE_THR0.u32);
}
...
HI_VOID VDP_DISP_SetSrSharpStrengh (HI_U32 u32Data, HI_U32 u32SharpStrengh)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrSharpStrengh() Select Wrong Video Layer ID\n");
		return ;
	}
...
HI_VOID VDP_DISP_SetSrEdgeFactorCtrl (HI_U32 u32Data, HI_U32 u32EdgeFactorCtrl)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrEdgeFactorCtrl() Select Wrong Video Layer ID\n");
		return ;
	}
...
HI_VOID VDP_DISP_SetSrSkinThres (HI_U32 u32Data, HI_U32 u32SkinThresH, HI_U32 u32SkinThresL)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrSkinThres() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_HANCE_THR1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HANCE_THR1.u32) + u32Data * CHN_OFFSET));
	SR_HANCE_THR1.bits.skin_thres_h = u32SkinThresH;
	SR_HANCE_THR1.bits.skin_thres_l = u32SkinThresL;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HANCE_THR1.u32) + u32Data * CHN_OFFSET), SR_HANCE_THR1.u32);
}
...
HI_VOID VDP_DISP_SetSrRingThres (HI_U32 u32Data, HI_U32 u32RingThresH, HI_U32 u32RingThresL)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrRingThres() Select Wrong Video Layer ID\n");
		return ;
	}
...
HI_VOID VDP_DISP_SetSrSharpHighCtrl (HI_U32 u32Data, HI_U32 u32SharpHighCtrl)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrSharpHighCtrl() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_HANCE_THR2.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HANCE_THR2.u32) + u32Data * CHN_OFFSET));
	SR_HANCE_THR2.bits.sharp_high_ctrl = u32SharpHighCtrl;
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HANCE_THR2.u32) + u32Data * CHN_OFFSET), SR_HANCE_THR2.u32);
}
...
HI_VOID VDP_DISP_SetSrNolinearCtrl (HI_U32 u32Data, HI_U32 u32NolinearCtrl)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrNolinearCtrl() Select Wrong Video Layer ID\n");
		return ;
	}
...
HI_VOID VDP_DISP_SetSrShootThrsh (HI_U32 u32Data, HI_U32 u32ShootThrsh)
{
    ...
    if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrShootThrsh() Select Wrong Video Layer ID\n");
		return ;
	}
...
HI_VOID VDP_DISP_SetSrHorCoef (HI_U32 u32Data, VDP_SR_HORCOEF_S stSrHorCoef)
{
	...
	if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrHorCoef() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_HCOEF0.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HCOEF0.u32)  + u32Data * CHN_OFFSET));
	SR_HCOEF1.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HCOEF1.u32)  + u32Data * CHN_OFFSET));
	SR_HCOEF2.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HCOEF2.u32)  + u32Data * CHN_OFFSET));
	SR_HCOEF3.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HCOEF3.u32)  + u32Data * CHN_OFFSET));
	SR_HCOEF4.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HCOEF4.u32)  + u32Data * CHN_OFFSET));
	SR_HCOEF5.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HCOEF5.u32)  + u32Data * CHN_OFFSET));
	SR_HCOEF6.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HCOEF6.u32)  + u32Data * CHN_OFFSET));
	SR_HCOEF7.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HCOEF7.u32)  + u32Data * CHN_OFFSET));
	SR_HCOEF8.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HCOEF8.u32)  + u32Data * CHN_OFFSET));
	SR_HCOEF9.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HCOEF9.u32)  + u32Data * CHN_OFFSET));
	SR_HCOEF10.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_HCOEF10.u32) + u32Data * CHN_OFFSET));
	...
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HCOEF0.u32)  + u32Data * CHN_OFFSET), SR_HCOEF0.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HCOEF1.u32)  + u32Data * CHN_OFFSET), SR_HCOEF1.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HCOEF2.u32)  + u32Data * CHN_OFFSET), SR_HCOEF2.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HCOEF3.u32)  + u32Data * CHN_OFFSET), SR_HCOEF3.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HCOEF4.u32)  + u32Data * CHN_OFFSET), SR_HCOEF4.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HCOEF5.u32)  + u32Data * CHN_OFFSET), SR_HCOEF5.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HCOEF6.u32)  + u32Data * CHN_OFFSET), SR_HCOEF6.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HCOEF7.u32)  + u32Data * CHN_OFFSET), SR_HCOEF7.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HCOEF8.u32)  + u32Data * CHN_OFFSET), SR_HCOEF8.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HCOEF9.u32)  + u32Data * CHN_OFFSET), SR_HCOEF9.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_HCOEF10.u32) + u32Data * CHN_OFFSET), SR_HCOEF10.u32);
...
HI_VOID VDP_DISP_SetSrVerCoef (HI_U32 u32Data, VDP_SR_VERCOEF_S  stSrVerCoef)
{
	...
	if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrVerCoef() Select Wrong Video Layer ID\n");
		return ;
	}

	SR_VCOEF0.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_VCOEF0.u32)  + u32Data * CHN_OFFSET));
	SR_VCOEF1.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_VCOEF1.u32)  + u32Data * CHN_OFFSET));
	SR_VCOEF2.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_VCOEF2.u32)  + u32Data * CHN_OFFSET));
	SR_VCOEF3.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_VCOEF3.u32)  + u32Data * CHN_OFFSET));
	SR_VCOEF4.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_VCOEF4.u32)  + u32Data * CHN_OFFSET));
	SR_VCOEF5.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_VCOEF5.u32)  + u32Data * CHN_OFFSET));
	SR_VCOEF6.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_VCOEF6.u32)  + u32Data * CHN_OFFSET));
	SR_VCOEF7.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->SR_VCOEF7.u32)  + u32Data * CHN_OFFSET));
	...
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_VCOEF0.u32)  + u32Data * CHN_OFFSET), SR_VCOEF0.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_VCOEF1.u32)  + u32Data * CHN_OFFSET), SR_VCOEF1.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_VCOEF2.u32)  + u32Data * CHN_OFFSET), SR_VCOEF2.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_VCOEF3.u32)  + u32Data * CHN_OFFSET), SR_VCOEF3.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_VCOEF4.u32)  + u32Data * CHN_OFFSET), SR_VCOEF4.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_VCOEF5.u32)  + u32Data * CHN_OFFSET), SR_VCOEF5.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_VCOEF6.u32)  + u32Data * CHN_OFFSET), SR_VCOEF6.u32);
	VDP_RegWrite((HI_U32)(&(pVdpReg->SR_VCOEF7.u32)  + u32Data * CHN_OFFSET), SR_VCOEF7.u32);
...
HI_VOID VDP_DISP_SetSrIReso (HI_U32 u32Data, HI_U32 u32Sriw, HI_U32 u32Srih)
{
	...
	if(u32Data >= CHN_MAX)
	{
		HI_PRINT("Error,VDP_DISP_SetSrIReso() Select Wrong Video Layer ID\n");
		return ;
	}

	DHD0_SRIRESO.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->SR_LTEX_THR.u32) + u32Data * CHN_OFFSET));
...
HI_VOID VDP_DISP_SetDimmingbEn(HI_U32 u32Data,HI_U32 bEn)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingbEn() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_GLB_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_GLB_CTRL.u32)));
	//temp version
    DIM_GLB_CTRL.bits.diming_en = bEn;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_GLB_CTRL.u32)), DIM_GLB_CTRL.u32);
...
HI_VOID VDP_DISP_SetDimmingledbypass(HI_U32 u32Data, HI_U32 bypassled)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingledbypass() Select Wrong Video Layer ID\n");
        return ;
    }
...
HI_VOID VDP_DISP_SetDimminglcdbypass(HI_U32 u32Data, HI_U32 bypasslcd)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimminglcdbypass() Select Wrong Video Layer ID\n");
        return ;
    }
...
HI_VOID VDP_DISP_SetDimmingdisable_2d(HI_U32 u32Data, HI_U32 disable_2d)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingdisable_2d() Select Wrong Video Layer ID\n");
        return ;
    }
...
HI_VOID VDP_DISP_SetDimmingSelUhd(HI_U32 u32Data, HI_U32 u32SelUhd)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingSelUhd() Select Wrong Video Layer ID\n");
        return ;
    }
...
HI_VOID VDP_DISP_SetDimmingModeInitLed( HI_U32 u32Data, HI_U32 u32modeinitled)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingModeInitLed() Select Wrong Video Layer ID\n");
        return ;
    }
...
HI_VOID VDP_DISP_SetDimmingLedNum(HI_U32 u32Data,HI_U32 u32lednumv,HI_U32 u32lednumh)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingLedNum() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_LED_NUM.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED_NUM.u32)));
    DIM_LED_NUM.bits.led_numv = u32lednumv-1;
    DIM_LED_NUM.bits.led_numh = u32lednumh-1;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_LED_NUM.u32)), DIM_LED_NUM.u32);
}
...
HI_VOID  VDP_DISP_SetDimmingStartPos ( HI_U32 u32Data,HI_U32 u32hcnt_init ,HI_U32 u32vcnt_init)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingStartPos() Select Wrong Video Layer ID\n");
        return ;
    }


    DIM_START_POS.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_START_POS.u32)));
    DIM_START_POS.bits.hcnt_init= u32hcnt_init;
    DIM_START_POS.bits.vcnt_init= u32vcnt_init;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_START_POS.u32)), DIM_START_POS.u32);
...
HI_VOID VDP_DISP_SetDimmingSegMetircs(HI_U32 u32Data,HI_U32 u32seg_height ,HI_U32 u32seg_width)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingSegMetircs() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_SEG_METIRCS.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_SEG_METIRCS.u32)));
    DIM_SEG_METIRCS.bits.seg_height = u32seg_height;
    DIM_SEG_METIRCS.bits.seg_width  = u32seg_width;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_SEG_METIRCS.u32)), DIM_SEG_METIRCS.u32);
}
...
HI_VOID VDP_DISP_SetDimmingNormUnit        (HI_U32 u32Data, HI_U32 u32glb_norm_unit ,HI_U32 u32seg_norm_unit)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingNormUnit() Select Wrong Video Layer ID\n");
        return ;
    }


    DIM_GLB_NORM_UNIT.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_GLB_NORM_UNIT.u32)));
    DIM_SEG_NORM_UNIT.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_SEG_NORM_UNIT.u32)));

    DIM_GLB_NORM_UNIT.bits.glb_norm_unit = u32glb_norm_unit;
    DIM_SEG_NORM_UNIT.bits.seg_norm_unit = u32seg_norm_unit;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_GLB_NORM_UNIT.u32)), DIM_GLB_NORM_UNIT.u32);
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_SEG_NORM_UNIT.u32)), DIM_SEG_NORM_UNIT.u32);
...
HI_VOID VDP_DISP_SetDimmingHistStat        ( HI_U32 u32Data,HI_U32 u32thresh_md2 ,HI_U32 u32thresh_md0, HI_U32 u32bits_w_hist ,HI_U32 u32bits_b_hist)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingHistStat() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_HIST_STAT.u32                                     = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_HIST_STAT.u32)));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_HIST_STAT.u32)), DIM_HIST_STAT.u32);
}

HI_VOID VDP_DISP_SetDimming0DLedThd        (HI_U32 u32Data, VDP_DISP_DIMMING_THD_S stThd)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimming0DLedThd() Select Wrong Video Layer ID\n");
        return ;
    }


    DIM_ADJ0D_CORE0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_ADJ0D_CORE0.u32)));
    DIM_ADJ0D_CORE1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_ADJ0D_CORE1.u32)));
    DIM_LED0D_LOW_THRESH0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_LOW_THRESH0.u32)));
    DIM_LED0D_LOW_THRESH1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_LOW_THRESH1.u32)));
    DIM_LED0D_LOW_OFFSET0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_LOW_OFFSET0.u32)));
    DIM_LED0D_LOW_OFFSET1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_LOW_OFFSET1.u32)));
    DIM_LED0D_LOW_GAIN0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_LOW_GAIN0.u32)));
    DIM_LED0D_LOW_GAIN1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_LOW_GAIN1.u32)));
    DIM_LED0D_MID_THRESH0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_MID_THRESH0.u32)));
    DIM_LED0D_MID_THRESH1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_MID_THRESH1.u32)));
    DIM_LED0D_MID_OFFSET0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_MID_OFFSET0.u32)));
    DIM_LED0D_MID_OFFSET1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_MID_OFFSET1.u32)));
    DIM_LED0D_MID_GAIN0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_MID_GAIN0.u32)));
    DIM_LED0D_MID_GAIN1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_MID_GAIN1.u32)));
    DIM_LED0D_HIGH_THRESH0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_HIGH_THRESH0.u32)));
    DIM_LED0D_HIGH_THRESH1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_HIGH_THRESH1.u32)));
    DIM_LED0D_HIGH_OFFSET0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_HIGH_OFFSET0.u32)));
    DIM_LED0D_HIGH_OFFSET1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_HIGH_OFFSET1.u32)));
    DIM_LED0D_HIGH_GAIN0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_HIGH_GAIN0.u32)));
    DIM_LED0D_HIGH_GAIN1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_HIGH_GAIN1.u32)));

    DIM_ADJ0D_CORE0.bits.core_low_0d  = stThd.u32CoreLow ;
    DIM_ADJ0D_CORE0.bits.core_mid_0d  = stThd.u32CoreMid ;
    DIM_ADJ0D_CORE1.bits.core_high_0d  = stThd.u32CoreHigh ;

    DIM_LED0D_LOW_THRESH0.bits.x0_low_0d    =   stThd.u32X0Low;
    DIM_LED0D_LOW_THRESH0.bits.x1_low_0d    =   stThd.u32X1Low;
    DIM_LED0D_LOW_THRESH1.bits.x2_low_0d    =   stThd.u32X2Low;
    DIM_LED0D_LOW_OFFSET0.bits.g0_low_0d    =   stThd.u32G0Low;
    DIM_LED0D_LOW_OFFSET0.bits.g1_low_0d    =   stThd.u32G1Low;
    DIM_LED0D_LOW_OFFSET1.bits.g2_low_0d    =   stThd.u32G2Low;
    DIM_LED0D_LOW_GAIN0.bits.k0_low_0d      =   stThd.u32K0Low;
    DIM_LED0D_LOW_GAIN0.bits.k1_low_0d      =   stThd.u32K1Low;
    DIM_LED0D_LOW_GAIN1.bits.k2_low_0d      =   stThd.u32K2Low;

    DIM_LED0D_MID_THRESH0.bits.x0_mid_0d    =   stThd.u32X0Mid;
    DIM_LED0D_MID_THRESH0.bits.x1_mid_0d    =   stThd.u32X1Mid;
    DIM_LED0D_MID_THRESH1.bits.x2_mid_0d    =   stThd.u32X2Mid;
    DIM_LED0D_MID_OFFSET0.bits.g0_mid_0d    =   stThd.u32G0Mid;
    DIM_LED0D_MID_OFFSET0.bits.g1_mid_0d    =   stThd.u32G1Mid;
    DIM_LED0D_MID_OFFSET1.bits.g2_mid_0d    =   stThd.u32G2Mid;
    DIM_LED0D_MID_GAIN0.bits.k0_mid_0d      =   stThd.u32K0Mid;
    DIM_LED0D_MID_GAIN0.bits.k1_mid_0d      =   stThd.u32K1Mid;
    DIM_LED0D_MID_GAIN1.bits.k2_mid_0d      =   stThd.u32K2Mid;

    DIM_LED0D_HIGH_THRESH0.bits.x0_high_0d    =   stThd.u32X0High;
    DIM_LED0D_HIGH_THRESH0.bits.x1_high_0d    =   stThd.u32X1High;
    DIM_LED0D_HIGH_THRESH1.bits.x2_high_0d    =   stThd.u32X2High;
    DIM_LED0D_HIGH_OFFSET0.bits.g0_high_0d    =   stThd.u32G0High;
    DIM_LED0D_HIGH_OFFSET0.bits.g1_high_0d    =   stThd.u32G1High;
    DIM_LED0D_HIGH_OFFSET1.bits.g2_high_0d    =   stThd.u32G2High;
    DIM_LED0D_HIGH_GAIN0.bits.k0_high_0d      =   stThd.u32K0High;
    DIM_LED0D_HIGH_GAIN0.bits.k1_high_0d      =   stThd.u32K1High;
    DIM_LED0D_HIGH_GAIN1.bits.k2_high_0d      =   stThd.u32K2High;

VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_ADJ0D_CORE0.u32        )) ,DIM_ADJ0D_CORE0.u32        ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_ADJ0D_CORE1.u32        )) ,DIM_ADJ0D_CORE1.u32        ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_LOW_THRESH0.u32  )) ,DIM_LED0D_LOW_THRESH0.u32  ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_LOW_THRESH1.u32  )) ,DIM_LED0D_LOW_THRESH1.u32  ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_LOW_OFFSET0.u32  )) ,DIM_LED0D_LOW_OFFSET0.u32  ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_LOW_OFFSET1.u32  )) ,DIM_LED0D_LOW_OFFSET1.u32  ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_LOW_GAIN0.u32    )) ,DIM_LED0D_LOW_GAIN0.u32    ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_LOW_GAIN1.u32    )) ,DIM_LED0D_LOW_GAIN1.u32    ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_MID_THRESH0.u32  )) ,DIM_LED0D_MID_THRESH0.u32  ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_MID_THRESH1.u32  )) ,DIM_LED0D_MID_THRESH1.u32  ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_MID_OFFSET0.u32  )) ,DIM_LED0D_MID_OFFSET0.u32  ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_MID_OFFSET1.u32  )) ,DIM_LED0D_MID_OFFSET1.u32  ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_MID_GAIN0.u32    )) ,DIM_LED0D_MID_GAIN0.u32    ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_MID_GAIN1.u32    )) ,DIM_LED0D_MID_GAIN1.u32    ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_HIGH_THRESH0.u32 )) ,DIM_LED0D_HIGH_THRESH0.u32 ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_HIGH_THRESH1.u32 )) ,DIM_LED0D_HIGH_THRESH1.u32 ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_HIGH_OFFSET0.u32 )) ,DIM_LED0D_HIGH_OFFSET0.u32 ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_HIGH_OFFSET1.u32 )) ,DIM_LED0D_HIGH_OFFSET1.u32 ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_HIGH_GAIN0.u32   )) ,DIM_LED0D_HIGH_GAIN0.u32   ) ;
VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED0D_HIGH_GAIN1.u32   )) ,DIM_LED0D_HIGH_GAIN1.u32   ) ;

}

HI_VOID VDP_DISP_SetDimming2DLedThd(HI_U32 u32Data, VDP_DISP_DIMMING_THD_S stThd2D)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimming2DLedThd() Select Wrong Video Layer ID\n");
        return ;
    }


    DIM_ADJ2D_CORE0.u32        = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_ADJ2D_CORE0.u32)));
    DIM_ADJ2D_CORE1.u32        = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_ADJ2D_CORE1.u32)));
    DIM_LED2D_LOW_THRESH0.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_LOW_THRESH0.u32)));
    DIM_LED2D_LOW_THRESH1.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_LOW_THRESH1.u32)));
    DIM_LED2D_LOW_OFFSET0.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_LOW_OFFSET0.u32)));
    DIM_LED2D_LOW_OFFSET1.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_LOW_OFFSET1.u32)));
    DIM_LED2D_LOW_GAIN0.u32    = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_LOW_GAIN0.u32)));
    DIM_LED2D_LOW_GAIN1.u32    = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_LOW_GAIN1.u32)));
    DIM_LED2D_MID_THRESH0.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_MID_THRESH0.u32)));
    DIM_LED2D_MID_THRESH1.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_MID_THRESH1.u32)));
    DIM_LED2D_MID_OFFSET0.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_MID_OFFSET0.u32)));
    DIM_LED2D_MID_OFFSET1.u32  = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_MID_OFFSET1.u32)));
    DIM_LED2D_MID_GAIN0.u32    = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_MID_GAIN0.u32)));
    DIM_LED2D_MID_GAIN1.u32    = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_MID_GAIN1.u32)));
    DIM_LED2D_HIGH_THRESH0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_HIGH_THRESH0.u32)));
    DIM_LED2D_HIGH_THRESH1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_HIGH_THRESH1.u32)));
    DIM_LED2D_HIGH_OFFSET0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_HIGH_OFFSET0.u32)));
    DIM_LED2D_HIGH_OFFSET1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_HIGH_OFFSET1.u32)));
    DIM_LED2D_HIGH_GAIN0.u32   = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_HIGH_GAIN0.u32)));
    DIM_LED2D_HIGH_GAIN1.u32   = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_HIGH_GAIN1.u32)));

    DIM_ADJ2D_CORE0.bits.core_low_2d  = stThd2D.u32CoreLow ;
    DIM_ADJ2D_CORE0.bits.core_mid_2d  = stThd2D.u32CoreMid ;
    DIM_ADJ2D_CORE1.bits.core_high_2d = stThd2D.u32CoreHigh ;

    DIM_LED2D_LOW_THRESH0.bits.x0_low_2d    =   stThd2D.u32X0Low;
    DIM_LED2D_LOW_THRESH0.bits.x1_low_2d    =   stThd2D.u32X1Low;
    DIM_LED2D_LOW_THRESH1.bits.x2_low_2d    =   stThd2D.u32X2Low;
    DIM_LED2D_LOW_OFFSET0.bits.g0_low_2d    =   stThd2D.u32G0Low;
    DIM_LED2D_LOW_OFFSET0.bits.g1_low_2d    =   stThd2D.u32G1Low;
    DIM_LED2D_LOW_OFFSET1.bits.g2_low_2d    =   stThd2D.u32G2Low;
    DIM_LED2D_LOW_GAIN0.bits.k0_low_2d      =   stThd2D.u32K0Low;
    DIM_LED2D_LOW_GAIN0.bits.k1_low_2d      =   stThd2D.u32K1Low;
    DIM_LED2D_LOW_GAIN1.bits.k2_low_2d      =   stThd2D.u32K2Low;

    DIM_LED2D_MID_THRESH0.bits.x0_mid_2d    =   stThd2D.u32X0Mid;
    DIM_LED2D_MID_THRESH0.bits.x1_mid_2d    =   stThd2D.u32X1Mid;
    DIM_LED2D_MID_THRESH1.bits.x2_mid_2d    =   stThd2D.u32X2Mid;
    DIM_LED2D_MID_OFFSET0.bits.g0_mid_2d    =   stThd2D.u32G0Mid;
    DIM_LED2D_MID_OFFSET0.bits.g1_mid_2d    =   stThd2D.u32G1Mid;
    DIM_LED2D_MID_OFFSET1.bits.g2_mid_2d    =   stThd2D.u32G2Mid;
    DIM_LED2D_MID_GAIN0.bits.k0_mid_2d      =   stThd2D.u32K0Mid;
    DIM_LED2D_MID_GAIN0.bits.k1_mid_2d      =   stThd2D.u32K1Mid;
    DIM_LED2D_MID_GAIN1.bits.k2_mid_2d      =   stThd2D.u32K2Mid;

    DIM_LED2D_HIGH_THRESH0.bits.x0_high_2d    =   stThd2D.u32X0High;
    DIM_LED2D_HIGH_THRESH0.bits.x1_high_2d    =   stThd2D.u32X1High;
    DIM_LED2D_HIGH_THRESH1.bits.x2_high_2d    =   stThd2D.u32X2High;
    DIM_LED2D_HIGH_OFFSET0.bits.g0_high_2d    =   stThd2D.u32G0High;
    DIM_LED2D_HIGH_OFFSET0.bits.g1_high_2d    =   stThd2D.u32G1High;
    DIM_LED2D_HIGH_OFFSET1.bits.g2_high_2d    =   stThd2D.u32G2High;
    DIM_LED2D_HIGH_GAIN0.bits.k0_high_2d      =   stThd2D.u32K0High;
    DIM_LED2D_HIGH_GAIN0.bits.k1_high_2d      =   stThd2D.u32K1High;
    DIM_LED2D_HIGH_GAIN1.bits.k2_high_2d      =   stThd2D.u32K2High;

    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_ADJ2D_CORE0.u32        )) ,DIM_ADJ2D_CORE0.u32        ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_ADJ2D_CORE1.u32        )) ,DIM_ADJ2D_CORE1.u32        ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_LOW_THRESH0.u32  )) ,DIM_LED2D_LOW_THRESH0.u32  ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_LOW_THRESH1.u32  )) ,DIM_LED2D_LOW_THRESH1.u32  ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_LOW_OFFSET0.u32  )) ,DIM_LED2D_LOW_OFFSET0.u32  ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_LOW_OFFSET1.u32  )) ,DIM_LED2D_LOW_OFFSET1.u32  ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_LOW_GAIN0.u32    )) ,DIM_LED2D_LOW_GAIN0.u32    ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_LOW_GAIN1.u32    )) ,DIM_LED2D_LOW_GAIN1.u32    ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_MID_THRESH0.u32  )) ,DIM_LED2D_MID_THRESH0.u32  ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_MID_THRESH1.u32  )) ,DIM_LED2D_MID_THRESH1.u32  ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_MID_OFFSET0.u32  )) ,DIM_LED2D_MID_OFFSET0.u32  ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_MID_OFFSET1.u32  )) ,DIM_LED2D_MID_OFFSET1.u32  ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_MID_GAIN0.u32    )) ,DIM_LED2D_MID_GAIN0.u32    ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_MID_GAIN1.u32    )) ,DIM_LED2D_MID_GAIN1.u32    ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_HIGH_THRESH0.u32 )) ,DIM_LED2D_HIGH_THRESH0.u32 ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_HIGH_THRESH1.u32 )) ,DIM_LED2D_HIGH_THRESH1.u32 ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_HIGH_OFFSET0.u32 )) ,DIM_LED2D_HIGH_OFFSET0.u32 ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_HIGH_OFFSET1.u32 )) ,DIM_LED2D_HIGH_OFFSET1.u32 ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_HIGH_GAIN0.u32   )) ,DIM_LED2D_HIGH_GAIN0.u32   ) ;
    VDP_RegWrite((HI_U32 ) (&(pVdpReg->DIM_LED2D_HIGH_GAIN1.u32   )) ,DIM_LED2D_HIGH_GAIN1.u32   ) ;
...
HI_VOID VDP_DISP_SetDimmingfirCoef         (HI_U32 u32Data, VDP_DISP_DIMMING_FIR_COEF_S stCoef )
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingfirCoef() Select Wrong Video Layer ID\n");
        return ;
    }


    DIM_VFIR_COEF_0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_VFIR_COEF_0.u32)));
    DIM_VFIR_COEF_1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_VFIR_COEF_1.u32)));
    DIM_HFIR_COEF_0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_HFIR_COEF_0.u32)));
    DIM_HFIR_COEF_1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_HFIR_COEF_1.u32)));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_VFIR_COEF_0.u32)) ,DIM_VFIR_COEF_0.u32);
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_VFIR_COEF_1.u32)) ,DIM_VFIR_COEF_1.u32);
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_HFIR_COEF_0.u32)) ,DIM_HFIR_COEF_0.u32);
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_HFIR_COEF_1.u32)) ,DIM_HFIR_COEF_1.u32);
...
HI_VOID VDP_DISP_SetDimming0DLedCore       (HI_U32 u32Data, HI_U32 u32core_dstat_high ,HI_U32 u32core_dstat_mid,HI_U32 u32core_dstat_low,HI_U32 u32k_dstat_0d)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimming0DLedCore() Select Wrong Video Layer ID\n");
        return ;
    }


    DIM_LED0D_CORE.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_CORE.u32)));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_LED0D_CORE.u32)) ,DIM_LED0D_CORE.u32);
...
HI_VOID VDP_DISP_SetDimming0DLedGainMisc   (HI_U32 u32Data, HI_U32 u32gain_led0d ,HI_U32 u32gain_led0d_tf)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimming0DLedGainMisc() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_LED0D_GAIN_MISC.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_GAIN_MISC.u32)));
    DIM_LED0D_GAIN_MISC.bits.gain_led0d   =u32gain_led0d  ;
    DIM_LED0D_GAIN_MISC.bits.gain_led0d_tf=u32gain_led0d_tf;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_LED0D_GAIN_MISC.u32) ),DIM_LED0D_GAIN_MISC.u32)   ;
...
HI_VOID VDP_DISP_SetDimming2DLedGainMisc   ( HI_U32 u32Data,HI_U32 u32gain_led2d,HI_U32 u32gain_bldmax2d,HI_U32 u32gain_bld_0d2d)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimming2DLedGainMisc() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_LED2D_GAIN_MISC.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED2D_GAIN_MISC.u32)));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_LED2D_GAIN_MISC.u32) ),DIM_LED2D_GAIN_MISC.u32)    ;
}
...
HI_VOID VDP_DISP_SetDimmingFinalGain       (HI_U32 u32Data, HI_U32 u32gain_final_0d,HI_S32 u32offset_final_0d)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingFinalGain() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_FINAL_GAIN_0D.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_FINAL_GAIN_0D.u32)));
    DIM_FINAL_GAIN_0D.bits.gain_final_0d  =u32gain_final_0d  ;
    DIM_FINAL_GAIN_0D.bits.offset_final_0d =u32offset_final_0d;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_FINAL_GAIN_0D.u32)) ,DIM_FINAL_GAIN_0D.u32)    ;
...
HI_VOID VDP_DISP_SetDimmingFinalGain2D       (HI_U32 u32Data, HI_U32 u32gain_final_2d,HI_S32 u32offset_final_2d)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingFinalGain2D() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_FINAL_GAIN_2D.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_FINAL_GAIN_2D.u32)));
    DIM_FINAL_GAIN_2D.bits.gain_final_2d  =u32gain_final_2d  ;
    DIM_FINAL_GAIN_2D.bits.offset_final_2d =u32offset_final_2d;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_FINAL_GAIN_2D.u32)) ,DIM_FINAL_GAIN_2D.u32)    ;
...
HI_VOID VDP_DISP_SetDimmingFinalClip       ( HI_U32 u32Data,HI_U32 u32clip_btm_final_0d,HI_U32 u32clip_up_final_0d)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingFinalClip() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_FINAL_CLIP_0D.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_FINAL_CLIP_0D.u32)));
    DIM_FINAL_CLIP_0D.bits.clip_btm_final_0d =u32clip_btm_final_0d  ;
    DIM_FINAL_CLIP_0D.bits.clip_up_final_0d =u32clip_up_final_0d;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_FINAL_CLIP_0D.u32)) ,DIM_FINAL_CLIP_0D.u32)    ;
...
HI_VOID VDP_DISP_SetDimmingFinalClip2D       (HI_U32 u32Data, HI_U32 u32clip_btm_final_2d,HI_U32 u32clip_up_final_2d)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingFinalClip2D() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_FINAL_CLIP_2D.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_FINAL_CLIP_2D.u32)));
    DIM_FINAL_CLIP_2D.bits.clip_btm_final_2d =u32clip_btm_final_2d  ;
    DIM_FINAL_CLIP_2D.bits.clip_up_final_2d =u32clip_up_final_2d;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_FINAL_CLIP_2D.u32)) ,DIM_FINAL_CLIP_2D.u32)    ;
...
HI_VOID VDP_DISP_SetDimming0DLedStatus     ( HI_U32 u32Data,HI_U32 u32led0d_sw, HI_U32 u32sc_0d_sw)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimming0DLedStatus() Select Wrong Video Layer ID\n");
        return ;
    }


    DIM_LED0D_STATUS.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D_STATUS.u32)));
...
HI_VOID VDP_DISP_SetDimmingPreBld          ( HI_U32 u32Data,HI_U32 u32core_led, HI_U32 u32k_led)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingPreBld() Select Wrong Video Layer ID\n");
        return ;
    }



    DIM_LCD_COMP_0D.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LCD_COMP_0D.u32)));
    DIM_LCD_COMP_0D.bits.lcd_core_led0d   = u32core_led  ;
    DIM_LCD_COMP_0D.bits.lcd_k_led0d   = u32k_led  ;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_LCD_COMP_0D.u32)) ,DIM_LCD_COMP_0D.u32)    ;
...
HI_VOID VDP_DISP_SetDimmingStatMetrics(HI_U32 u32Data,HI_U32 u32stat_height ,HI_U32 u32stat_width)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingStatMetrics() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_STAT_METRICS.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_STAT_METRICS.u32)));
    DIM_STAT_METRICS.bits.stat_height = u32stat_height;
    DIM_STAT_METRICS.bits.stat_width  = u32stat_width;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_STAT_METRICS.u32)), DIM_STAT_METRICS.u32);
}
...
HI_VOID VDP_DISP_SetDimmingPre0D2DBld          (HI_U32 u32Data, HI_U32 u32core_led0d, HI_U32 u32k_led0d)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingPre0D2DBld() Select Wrong Video Layer ID\n");
        return ;
    }



    DIM_PRE_0D2D_BLD.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_PRE_0D2D_BLD.u32)));
    DIM_PRE_0D2D_BLD.bits.core_led0d=u32core_led0d ;
    DIM_PRE_0D2D_BLD.bits.k_led0d=u32k_led0d ;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_PRE_0D2D_BLD.u32)) ,DIM_PRE_0D2D_BLD.u32)    ;
...
HI_VOID VDP_DISP_SetDimmingPostFirBld      (HI_U32 u32Data, HI_U32 u32gain_hfir,HI_U32 u32gain_vfir)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingPostFirBld() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_POST_FIR_BLD.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_POST_FIR_BLD.u32)));
    DIM_POST_FIR_BLD.bits.gain_hfir      =u32gain_hfir   ;
    DIM_POST_FIR_BLD.bits.gain_vfir      =u32gain_vfir   ;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_POST_FIR_BLD.u32)) ,DIM_POST_FIR_BLD.u32)    ;
...
HI_VOID VDP_DISP_SetDimmingPostFirGain     (HI_U32 u32Data, HI_U32 u32k_led2d, HI_U32 u32core_led2d, HI_U32 u32gain_tf)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingPostFirGain() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_POST_FIR_GAIN.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_POST_FIR_GAIN.u32)));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_POST_FIR_GAIN.u32)) ,DIM_POST_FIR_GAIN.u32)    ;
...
HI_VOID VDP_DISP_SetDimming0DLcdComp       (HI_U32 u32Data, HI_U32 u32lcd_k_led, HI_U32 u32lcd_core_led)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimming0DLcdComp() Select Wrong Video Layer ID\n");
        return ;
    }
...
HI_VOID VDP_DISP_SetDimming2DLcdComp       (HI_U32 u32Data, HI_U32 u32lcd_k_led, HI_U32 u32lcd_core_led)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimming2DLcdComp() Select Wrong Video Layer ID\n");
        return ;
    }


    DIM_LCD_COMP_2D.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LCD_COMP_2D.u32)));
    DIM_LCD_COMP_2D.bits.lcd_k_led2d       = u32lcd_k_led    ;
    DIM_LCD_COMP_2D.bits.lcd_core_led2d    = u32lcd_core_led ;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_LCD_COMP_2D.u32)) ,DIM_LCD_COMP_2D.u32)    ;
}
...
HI_VOID VDP_DISP_SetDimmingLcdCompgain     (HI_U32 u32Data, HI_U32 u32lcd_compgain)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingLcdCompgain() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_LCD_COMPGAIN.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LCD_COMPGAIN.u32)));
    DIM_LCD_COMPGAIN.bits.lcd_compgain_2d  =  u32lcd_compgain ;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_LCD_COMPGAIN.u32)) ,DIM_LCD_COMPGAIN.u32)    ;
...
HI_VOID VDP_DISP_SetDimmingLedPanel        (HI_U32 u32Data, HI_U32 u32max_led_panel,HI_U32 u32k_led_panel)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingLedPanel() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_LED_PANEL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED_PANEL.u32)));
    DIM_LED_PANEL.bits.max_led_panel  = u32max_led_panel  ;
    DIM_LED_PANEL.bits.k_led_panel  = u32k_led_panel  ;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_LED_PANEL.u32)) ,DIM_LED_PANEL.u32)    ;
}
HI_VOID VDP_DISP_SetDimmingLed0D2D( HI_U32 u32Data,HI_U32 u32led2d_final,HI_U32 u32led0d_final)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingLed0D2D() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_LED0D2D.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_LED0D2D.u32)));
    DIM_LED0D2D.bits.led2d_final= u32led2d_final;
    DIM_LED0D2D.bits.led0d_final= u32led0d_final;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_LED0D2D.u32) ),DIM_LED0D2D.u32)    ;
}
...
HI_VOID VDP_DISP_SetDimmingSclRatioH(HI_U32 u32Data, HI_U32 u32lhfir_scl_dec,HI_U32 u32lhfir_scl_int)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingSclRatioH() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_SCL_RATIO_H.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_SCL_RATIO_H.u32)));
    DIM_SCL_RATIO_H.bits.lhfir_scl_dec= u32lhfir_scl_dec;
    DIM_SCL_RATIO_H.bits.lhfir_scl_int= u32lhfir_scl_int;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_SCL_RATIO_H.u32) ),DIM_SCL_RATIO_H.u32)    ;
}
...
HI_VOID VDP_DISP_SetDimmingSclRatioV( HI_U32 u32Data,HI_U32 u32lvfir_scl_dec,HI_U32 u32lvfir_scl_int)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingSclRatioV() Select Wrong Video Layer ID\n");
        return ;
    }

    DIM_SCL_RATIO_V.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_SCL_RATIO_V.u32)));
    DIM_SCL_RATIO_V.bits.lvfir_scl_dec= u32lvfir_scl_dec;
    DIM_SCL_RATIO_V.bits.lvfir_scl_int= u32lvfir_scl_int;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_SCL_RATIO_V.u32)) ,DIM_SCL_RATIO_V.u32)    ;
}
...
HI_VOID VDP_DISP_SetDimmingSclEnable( HI_U32 u32Data,VDP_ZME_MODE_E  enMode, HI_U32 bEnable)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingSclEnable() Select Wrong Video Layer ID\n");
        return ;
    }
    ...
    if((enMode == VDP_ZME_MODE_HORL)||(enMode == VDP_ZME_MODE_HOR)||(enMode == VDP_ZME_MODE_ALL))
    {
        DIM_SCL_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_SCL_CTRL.u32)));
        DIM_SCL_CTRL.bits.lhfir_en= bEnable;
        VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_SCL_CTRL.u32)), DIM_SCL_CTRL.u32);
    }
...
HI_VOID VDP_DISP_SetDimmingSclMidEnable(HI_U32 u32Data, VDP_ZME_MODE_E  enMode, HI_U32 bEnable)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingSclMidEnable() Select Wrong Video Layer ID\n");
        return ;
    }
...
HI_VOID VDP_DISP_SetDimmingSclFirEnable( HI_U32 u32Data,VDP_ZME_MODE_E  enMode, HI_U32 bEnable)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingSclOffsetH() Select Wrong Video Layer ID\n");
        return ;
    }
...
HI_VOID VDP_DISP_SetDimmingSclOffsetH(HI_U32 u32Data, VDP_ZME_MODE_E enMode, HI_S32 s32Offset)
{
    ...
    if((enMode == VDP_ZME_MODE_HORL)||(enMode == VDP_ZME_MODE_HOR)||(enMode == VDP_ZME_MODE_ALL))
    {
        DIM_SCL_OFFSET_H.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_SCL_OFFSET_H.u32)));
        DIM_SCL_OFFSET_H.bits.lhfir_offset=s32Offset ;
        VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_SCL_OFFSET_H.u32)), DIM_SCL_OFFSET_H.u32);
    }
...
HI_VOID VDP_DISP_SetDimmingSclOffsetV       (HI_U32 u32Data, VDP_ZME_MODE_E  enMode, HI_S32 s32Offset)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimmingSclOffsetV() Select Wrong Video Layer ID\n");
        return ;
    }
    ...
    if((enMode == VDP_ZME_MODE_VERL)||(enMode == VDP_ZME_MODE_VER)||(enMode == VDP_ZME_MODE_ALL))
    {
        DIM_SCL_OFFSET_V.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DIM_SCL_OFFSET_V.u32)));
        DIM_SCL_OFFSET_V.bits.lvfir_offset=s32Offset ;
        VDP_RegWrite((HI_U32)(&(pVdpReg->DIM_SCL_OFFSET_V.u32)), DIM_SCL_OFFSET_V.u32);
    }
...
HI_VOID VDP_DISP_SetLocalDimCoefAddr(HI_U32 u32hd_id, HI_U32 u32CoefAddr)
{
    ...
    if(u32hd_id >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetLocalDimCoefAddrSelect Wrong CHANNEL ID\n");
        return ;
    }
    DHDDIMLUTAD.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDDIMLUTAD.u32)));
    DHDDIMLUTAD.bits.dhddimlutad= u32CoefAddr;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHDDIMLUTAD.u32)), DHDDIMLUTAD.u32);
}
...
HI_VOID VDP_DISP_SetDimHZmeCoefAddr(HI_U32 u32hd_id, HI_U32 u32CoefAddr)
{
    ...
    if(u32hd_id >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimHZmeCoefAddr  Select Wrong CHANNEL ID\n");
        return ;
    }

    DHDDIMHFAD.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDDIMHFAD.u32)));
    DHDDIMHFAD.bits.dhddimhfad= u32CoefAddr;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHDDIMHFAD.u32)), DHDDIMHFAD.u32);
...
HI_VOID VDP_DISP_SetDimVZmeCoefAddr(HI_U32 u32hd_id, HI_U32 u32CoefAddr)
{
    ...
    if(u32hd_id >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetDimHZmeCoefAddrSelect Wrong CHANNEL ID\n");
        return ;
    }

    DHDDIMVFAD.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHDDIMVFAD.u32)));
    DHDDIMVFAD.bits.dhddimvfad= u32CoefAddr;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHDDIMVFAD.u32)), DHDDIMVFAD.u32);
}
...
HI_VOID VDP_DISP_SetStartPos (HI_U32 u32Data, HI_U32 u32StartPos)
{
    ...
    if(u32Data >= CHN_MAX)
    {
        HI_PRINT("Error,VDP_DISP_SetStartPos() Select Wrong Video Layer ID\n");
        return ;
    }

    DHD0_START_POS.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_START_POS.u32)+u32Data*CHN_OFFSET));
    DHD0_START_POS.bits.start_pos = u32StartPos;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_START_POS.u32)+u32Data*CHN_OFFSET),DHD0_START_POS.u32);
}
...
HI_VOID VDP_DISP_SetParaLoadPos (HI_U32 u32Data, HI_U32 u32StartPos)
{
    ...
    DHD0_PARATHD.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_PARATHD.u32)+u32Data*CHN_OFFSET));
    DHD0_PARATHD.bits.para_thd = u32StartPos;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_PARATHD.u32)+u32Data*CHN_OFFSET),DHD0_PARATHD.u32);
}
...
//BS  begin
//--------------------------------------------------------------------
HI_VOID VDP_DISP_SetBsEnable(HI_U32 u32hd_id, HI_U32 u32Enable)
{
    U_DHD0_BSCTRL  DHD0_BSCTRL ;
    ...
    DHD0_BSCTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_BSCTRL.u32)));
    DHD0_BSCTRL.bits.bs_en= u32Enable;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_BSCTRL.u32)), DHD0_BSCTRL.u32);

}

HI_VOID VDP_DISP_SetBsRDelta0(HI_U32 u32hd_id, HI_U32 G0_R_BE,HI_U32 K0_R_BE,HI_U32 X0_R_BE)
{
    U_DHD0_BSRDELTA0  DHD0_BSRDELTA0 ;
    ...
    DHD0_BSRDELTA0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_BSRDELTA0.u32)));
    DHD0_BSRDELTA0.bits.g0_r_be= G0_R_BE;
    DHD0_BSRDELTA0.bits.k0_r_be= K0_R_BE;
    DHD0_BSRDELTA0.bits.x0_r_be= X0_R_BE;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_BSRDELTA0.u32)), DHD0_BSRDELTA0.u32);

}
HI_VOID VDP_DISP_SetBsRDelta1(HI_U32 u32hd_id, HI_U32 G1_R_BE,HI_U32 K1_R_BE,HI_U32 X1_R_BE)
{
    U_DHD0_BSRDELTA1  DHD0_BSRDELTA1 ;
    ...
    DHD0_BSRDELTA1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_BSRDELTA1.u32)));
    DHD0_BSRDELTA1.bits.g1_r_be= G1_R_BE;
    DHD0_BSRDELTA1.bits.k1_r_be= K1_R_BE;
    DHD0_BSRDELTA1.bits.x1_r_be= X1_R_BE;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_BSRDELTA1.u32)), DHD0_BSRDELTA1.u32);

}

HI_VOID VDP_DISP_SetBsGDelta0(HI_U32 u32hd_id, HI_U32 G0_G_BE,HI_U32 K0_G_BE,HI_U32 X0_G_BE)
{
    U_DHD0_BSGDELTA0  DHD0_BSGDELTA0 ;
    ...
    DHD0_BSGDELTA0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_BSGDELTA0.u32)));
    DHD0_BSGDELTA0.bits.g0_g_be= G0_G_BE;
    DHD0_BSGDELTA0.bits.k0_g_be= K0_G_BE;
    DHD0_BSGDELTA0.bits.x0_g_be= X0_G_BE;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_BSGDELTA0.u32)), DHD0_BSGDELTA0.u32);

}

HI_VOID VDP_DISP_SetBsGDelta1(HI_U32 u32hd_id, HI_U32 G1_G_BE,HI_U32 K1_G_BE,HI_U32 X1_G_BE)
{
    U_DHD0_BSGDELTA1  DHD0_BSGDELTA1 ;
    ...
    DHD0_BSGDELTA1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_BSGDELTA1.u32)));
    DHD0_BSGDELTA1.bits.g1_g_be= G1_G_BE;
    DHD0_BSGDELTA1.bits.k1_g_be= K1_G_BE;
    DHD0_BSGDELTA1.bits.x1_g_be= X1_G_BE;
    VDP_RegWrite((HI_U32)(&(pVdpReg->DHD0_BSGDELTA1.u32)), DHD0_BSGDELTA1.u32);
...
//BS  end
//--------------------------------------------------------------------
HI_U32 VDP_DISP_Get_Vcnt(HI_VOID)
{
    volatile U_DHD0_STATE DHD0_STATE;
    DHD0_STATE.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->DHD0_STATE.u32)));

    return (HI_U32)(DHD0_STATE.bits.vcnt);
}
