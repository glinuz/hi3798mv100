...
HI_VOID VDP_WBC_SetOflStart(HI_U32 u32Data)
{

    U_WBC_OFL_EN WBC_OFL_EN;

    WBC_OFL_EN.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_OFL_EN.u32)));
    WBC_OFL_EN.bits.ofl_start = u32Data;
    VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_OFL_EN.u32)), WBC_OFL_EN.u32);
}
...
HI_VOID VDP_WBC_SetCropPos (VDP_LAYER_WBC_E enLayer, VDP_RECT_S stRect)
{
    ...
    )
    {
        ...
        WBC_DHD0_LCROP.bits.wlcrop = stRect.u32X + stRect.u32Wth-1;
        WBC_DHD0_LCROP.bits.hlcrop = stRect.u32Y + stRect.u32Hgt-1;
...
HI_VOID VDP_WBC_SetZmeCoefAddr(VDP_LAYER_WBC_E enLayer, VDP_WBC_PARA_E u32Mode, HI_U32 u32Addr, HI_U32 u32CAddr)
{
    ...
    //U_WBC_ME_HLCOEFAD WBC_ME_HLCOEFAD;
    //U_WBC_ME_HCCOEFAD WBC_ME_HCCOEFAD;
  //  U_WBC_ME_VLCOEFAD WBC_ME_VLCOEFAD;
//    U_WBC_ME_VCCOEFAD WBC_ME_VCCOEFAD;
...
HI_VOID  VDP_WBC_SetCscEnable  (VDP_LAYER_WBC_E enLayer, HI_U32 enCSC)
{
    ...
    if((enLayer == VDP_LAYER_WBC_HD0)||(enLayer == VDP_LAYER_WBC_FI)||(enLayer == VDP_LAYER_WBC_ME)||(enLayer == VDP_LAYER_WBC_BMP))
    {

        WBC_DHD0_CSCIDC.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_CSCIDC.u32)+ enLayer * WBC_OFFSET));
        WBC_DHD0_CSCIDC.bits.csc_en = enCSC;
        VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_DHD0_CSCIDC.u32)+ enLayer * WBC_OFFSET), WBC_DHD0_CSCIDC.u32);
    }
#if WBC_GP0_EN
    else if(enLayer == VDP_LAYER_WBC_GP0)
    {
...
HI_VOID VDP_WBC_SetCscDcCoef(VDP_LAYER_WBC_E enLayer,VDP_CSC_DC_COEF_S stCscCoef)
{
    ...
    if((enLayer == VDP_LAYER_WBC_HD0)||(enLayer == VDP_LAYER_WBC_FI)||(enLayer == VDP_LAYER_WBC_ME)||(enLayer == VDP_LAYER_WBC_BMP))
    {
        ...
        WBC_DHD0_CSCODC.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_CSCODC.u32)+ enLayer * WBC_OFFSET));
        ...
        VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_DHD0_CSCODC.u32)+ enLayer * WBC_OFFSET), WBC_DHD0_CSCODC.u32);
    }
    else if(enLayer == VDP_LAYER_WBC_GP0)
    {
        U_GP0_CSC_IDC  GP0_CSC_IDC;
...
HI_VOID VDP_WBC_SetCscCoef(VDP_LAYER_WBC_E enLayer,VDP_CSC_COEF_S stCscCoef)
{
    ...
    if((enLayer == VDP_LAYER_WBC_HD0)||(enLayer == VDP_LAYER_WBC_FI)||(enLayer == VDP_LAYER_WBC_ME)||(enLayer == VDP_LAYER_WBC_BMP))
    {
        WBC_DHD0_CSCP0.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_CSCP0.u32)+ enLayer * WBC_OFFSET));
        WBC_DHD0_CSCP0.bits.cscp00 = stCscCoef.csc_coef00;
        WBC_DHD0_CSCP0.bits.cscp01 = stCscCoef.csc_coef01;
        VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_DHD0_CSCP0.u32)+ enLayer * WBC_OFFSET), WBC_DHD0_CSCP0.u32);

        WBC_DHD0_CSCP1.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_CSCP1.u32)+ enLayer * WBC_OFFSET));
        WBC_DHD0_CSCP1.bits.cscp02 = stCscCoef.csc_coef02;
        WBC_DHD0_CSCP1.bits.cscp10 = stCscCoef.csc_coef10;
        VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_DHD0_CSCP1.u32)+ enLayer * WBC_OFFSET), WBC_DHD0_CSCP1.u32);

        WBC_DHD0_CSCP2.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_CSCP2.u32)+ enLayer * WBC_OFFSET));
        WBC_DHD0_CSCP2.bits.cscp11 = stCscCoef.csc_coef11;
        WBC_DHD0_CSCP2.bits.cscp12 = stCscCoef.csc_coef12;
        VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_DHD0_CSCP2.u32)+ enLayer * WBC_OFFSET), WBC_DHD0_CSCP2.u32);

        WBC_DHD0_CSCP3.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_CSCP3.u32)+ enLayer * WBC_OFFSET));
        WBC_DHD0_CSCP3.bits.cscp20 = stCscCoef.csc_coef20;
        WBC_DHD0_CSCP3.bits.cscp21 = stCscCoef.csc_coef21;
        VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_DHD0_CSCP3.u32)+ enLayer * WBC_OFFSET), WBC_DHD0_CSCP3.u32);

        WBC_DHD0_CSCP4.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_CSCP4.u32)+ enLayer * WBC_OFFSET));
        WBC_DHD0_CSCP4.bits.cscp22 = stCscCoef.csc_coef22;
        VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_DHD0_CSCP4.u32)+ enLayer * WBC_OFFSET), WBC_DHD0_CSCP4.u32);
    }
    else if(enLayer == VDP_LAYER_WBC_GP0)
    {
...
HI_U32 VDP_WBC_GetCmpFrameSize(VDP_LAYER_WBC_E enLayer)
{
    U_WBC_FI_CMP_FRAME_SIZE  WBC_FI_CMP_FRAME_SIZE;
    if(enLayer == VDP_LAYER_WBC_FI)
    {
        WBC_FI_CMP_FRAME_SIZE.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_FI_CMP_FRAME_SIZE.u32)));
        return WBC_FI_CMP_FRAME_SIZE.u32;
    }
    else
    {
        HI_PRINT("Error,VDP_WBC_SetCmpFrameSize() Select a Wrong layer!\n");
...
HI_U32  VDP_WBC_GetBmpSum(VDP_LAYER_WBC_E enLayer)
{
    U_WBC_BMP_SUM  WBC_BMP_SUM;
    if(enLayer == VDP_LAYER_WBC_BMP)
    {
        WBC_BMP_SUM.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_BMP_SUM.u32)));
        return (HI_U32)(WBC_BMP_SUM.bits.bmp_sum);
    }
    else
    {
        HI_PRINT("Error,VDP_WBC_GetBmpSum() Select a Wrong layer!\n");
        return 0;
    }
}

HI_VOID VDP_SetGfxMasterSel(HI_BOOL bOffLine)
{
    U_G0_CTRL  G0_CTRL;

    /* G0 */
    G0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->G0_CTRL.u32)));
    G0_CTRL.bits.ofl_master = bOffLine;
    VDP_RegWrite((HI_U32)(&(pVdpReg->G0_CTRL.u32)), G0_CTRL.u32);

    /* G1 */
    G0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->G0_CTRL.u32)+ 1*GFX_OFFSET));
    G0_CTRL.bits.ofl_master = bOffLine;
    VDP_RegWrite((HI_U32)(&(pVdpReg->G0_CTRL.u32)+ 1*GFX_OFFSET), G0_CTRL.u32);

    /* G2 */
    G0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->G0_CTRL.u32)+ 2*GFX_OFFSET));
    G0_CTRL.bits.ofl_master = bOffLine;
    VDP_RegWrite((HI_U32)(&(pVdpReg->G0_CTRL.u32)+ 2*GFX_OFFSET), G0_CTRL.u32);
}


HI_VOID VDP_SetWbcMasterSel(HI_BOOL bOffLine)
{
    U_WBC_DHD0_CTRL  WBC_DHD0_CTRL;

    /* DHD0 WBC */
    WBC_DHD0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_CTRL.u32)));
    WBC_DHD0_CTRL.bits.ofl_master = bOffLine;
    VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_DHD0_CTRL.u32)), WBC_DHD0_CTRL.u32);

    /* WBC GP */
    WBC_DHD0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_CTRL.u32)+ 1*WBC_OFFSET));
    WBC_DHD0_CTRL.bits.ofl_master = bOffLine;
    VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_DHD0_CTRL.u32)+ 1*WBC_OFFSET), WBC_DHD0_CTRL.u32);

    /* WBC G0 */
    WBC_DHD0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_CTRL.u32)+ 2*WBC_OFFSET));
    WBC_DHD0_CTRL.bits.ofl_master = bOffLine;
    VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_DHD0_CTRL.u32)+ 2*WBC_OFFSET), WBC_DHD0_CTRL.u32);
}



HI_VOID VDP_SetVideoMasterSel(HI_BOOL bOffLine)
{
    U_V0_CTRL  V0_CTRL;

    /* Video0 */
    V0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_CTRL.u32)));
    V0_CTRL.bits.ofl_master = bOffLine;
    VDP_RegWrite((HI_U32)(&(pVdpReg->V0_CTRL.u32)), V0_CTRL.u32);

    /* Video1 */
    V0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_CTRL.u32)+ 1*VID_OFFSET));
    V0_CTRL.bits.ofl_master = bOffLine;
    VDP_RegWrite((HI_U32)(&(pVdpReg->V0_CTRL.u32)+ 1*VID_OFFSET), V0_CTRL.u32);
}


HI_VOID VDP_SetMeFiMasterSel(HI_BOOL bOffLine)
{
    U_WBC_FI_CTRL  WBC_FI_CTRL;
    ...
    WBC_ME_CTRL.bits.ofl_master = bOffLine;
    VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_ME_CTRL.u32)), WBC_ME_CTRL.u32);

    /* FI Wbc Master */
    WBC_FI_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_FI_CTRL.u32)));
    WBC_FI_CTRL.bits.ofl_master = bOffLine;
    VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_FI_CTRL.u32)), WBC_FI_CTRL.u32);
}
...
HI_VOID VDP_WBC_SetMasterSel  (HI_U32 u32Data, HI_U32 u32MasterNum)
{
    ...
    U_WBC_DHD0_CTRL WBC_DHD0_CTRL;
    WBC_DHD0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_CTRL.u32) + u32Data * WBC_OFFSET));
    ...
    VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_DHD0_CTRL.u32) + u32Data * WBC_OFFSET), WBC_DHD0_CTRL.u32);
...
HI_VOID VDP_WBC_CDS_init(VDP_LAYER_WBC_E wbc_enlayer)
{
    ...
    VDP_WBC_SetCdsFirEnable(wbc_enlayer, HI_FALSE);//need to chang
    VDP_WBC_SetCdsMidEnable(wbc_enlayer, HI_FALSE);//need to chang
    VDP_WBC_SetCdsCoef(wbc_enlayer, s32CdsCoef);
}

#if 0
HI_VOID VDP_WBC_ZmeCoefSel(VDP_LAYER_WBC_E wbc_layer, VDP_DISP_RECT_S  wbc_stRect, VDP_VID_ZME_COEF_S  VID_ZME_COEF)
{
   //水平系数
   if( (wbc_stRect.u32OWth*ZME_HPREC/(wbc_stRect.u32IWth)) > ZME_HPREC)
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_HOR, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l8c4_1);
   }
   else if( (wbc_stRect.u32OWth*ZME_HPREC/(wbc_stRect.u32IWth)) == ZME_HPREC)
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_HOR, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l8c4_equal1);
   }
   else if( (wbc_stRect.u32OWth*ZME_HPREC/(wbc_stRect.u32IWth)) >= ZME_HPREC*3/4)
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_HOR, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l8c4_075);
   }
   else if( (wbc_stRect.u32OWth*ZME_HPREC/(wbc_stRect.u32IWth)) >= ZME_HPREC/2)
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_HOR, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l8c4_05);
   }
   else if( (wbc_stRect.u32OWth*ZME_HPREC/(wbc_stRect.u32IWth)) >= ZME_HPREC/3)
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_HOR, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l8c4_033);
   }
   else if( (wbc_stRect.u32OWth*ZME_HPREC/(wbc_stRect.u32IWth)) >= ZME_HPREC/4)
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_HOR, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l8c4_025);
   }
   else
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_HOR, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l8c4_0);
   }

   //垂直系数
   if( (wbc_stRect.u32OHgt*ZME_VPREC/(wbc_stRect.u32IHgt)) > ZME_VPREC)
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_VER, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l6c4_1);
   }
   else if( (wbc_stRect.u32OHgt*ZME_VPREC/(wbc_stRect.u32IHgt)) == ZME_VPREC)
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_VER, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l6c4_equal1);
   }
   else if( (wbc_stRect.u32OHgt*ZME_VPREC/(wbc_stRect.u32IHgt)) >= ZME_VPREC*3/4)
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_VER, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l6c4_075);
   }
   else if( (wbc_stRect.u32OHgt*ZME_VPREC/(wbc_stRect.u32IHgt)) >= ZME_VPREC/2)
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_VER, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l6c4_05);
   }
   else if( (wbc_stRect.u32OHgt*ZME_VPREC/(wbc_stRect.u32IHgt)) >= ZME_VPREC/3)
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_VER, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l6c4_033);
   }
   else if( (wbc_stRect.u32OHgt*ZME_VPREC/(wbc_stRect.u32IHgt)) >= ZME_VPREC/4)
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_VER, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l6c4_025);
   }
   else
   {
        VDP_WBC_SetZmeCoefAddr(wbc_layer, VDP_WBC_PARA_ZME_VER, VID_ZME_COEF.stCoefAddr.coef_addr_tap_l6c4_0);
   }
