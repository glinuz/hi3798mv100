...
#define HISI_SEC_BASE 0xF9230200

typedef enum
{
    SEC_REG_ADDR_IDLES_COUNT  = 0x4,
    SEC_REG_ADDR_SWITCH  = 0x0,
    SEC_REG_ADDR_STATUS = 0x8,
    SEC_REG_ADDR_SIZE = 0x0100,
} crg_reg_addr_sec_addr;
...
typedef enum
{
	...
	PMC_REG_ADDR_TEMPERATURE = 0x0030, /*PERI_PMC12*/
