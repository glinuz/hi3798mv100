...
int vfmw_read_proc_info(struct seq_file *p, void *v)
{
    ...
    if (1 < MAX_VDH_NUM)
    {
        ...
        seq_printf(p, "%-45s :%d.%d%%\n", "VDH 0 Cycle load", g_VfmwGlobalStat[0].u32VaVdmCycleLoad / 10, g_VfmwGlobalStat[0].u32VaVdmCycleLoad % 10);
#endif
#ifdef VDH1_EN
        seq_printf(p, "%-45s :%d.%d%%\n", "VDH 1 load", g_VfmwGlobalStat[1].u32VaVdmLoad / 10, g_VfmwGlobalStat[1].u32VaVdmLoad % 10);
        seq_printf(p, "%-45s :%d.%d%%\n", "VDH 1 Cycle load", g_VfmwGlobalStat[1].u32VaVdmCycleLoad / 10, g_VfmwGlobalStat[1].u32VaVdmCycleLoad % 10);
#endif
#ifdef VDH2_EN
        seq_printf(p, "%-45s :%d.%d%%\n", "VDH 2 load", g_VfmwGlobalStat[2].u32VaVdmLoad / 10, g_VfmwGlobalStat[2].u32VaVdmLoad % 10);
        seq_printf(p, "%-45s :%d.%d%%\n", "VDH 2 Cycle load", g_VfmwGlobalStat[2].u32VaVdmCycleLoad / 10, g_VfmwGlobalStat[2].u32VaVdmCycleLoad % 10);
#endif
#else
        seq_printf(p, "%-45s :%d.%d%%\n", "VDH 0 load", g_VfmwGlobalStat[0].u32VaVdmLoad / 10, g_VfmwGlobalStat[0].u32VaVdmLoad % 10);
        seq_printf(p, "%-45s :%d.%d%%\n", "VDH 1 load", g_VfmwGlobalStat[1].u32VaVdmLoad / 10, g_VfmwGlobalStat[1].u32VaVdmLoad % 10);
...
int vfmw_read_proc_dec(struct seq_file *p, void *v)
{
    ...
    for (i = 0; i < MAX_VDH_NUM; i++)
    {
        ...
        seq_printf(p, "%s%-10d :%d.%d%%\n", "Cycle load VDH ", i, g_VfmwGlobalStat[0].u32VaVdmCycleLoad / 10, g_VfmwGlobalStat[0].u32VaVdmCycleLoad % 10);
