...
} HEVC_TECHNICOLOR_HDR_SEQ_PARAMS;//"static" parameters

typedef struct
{
    UINT32 BA; //Used to compute the content of the P_LUT, once per picture
} HEVC_TECHNICOLOR_HDR_FRM_PARAMS;//"danamic" parameters
...
typedef struct
{
    ...
    UINT8 IsValid;
    HEVC_TECHNICOLOR_HDR_SEQ_PARAMS TCH_HDR_StaticParms;
    HEVC_TECHNICOLOR_HDR_FRM_PARAMS TCH_HDR_DanamicParms;
