...
#else
#define av_log(ptr, level, ...) av_log_hw_nothing()
#endif
...
#ifndef  HI_ADVCA_FUNCTION_RELEASE
#define av_log(ptr, level, ...) av_log_private(__FILE__, __LINE__, __FUNCTION__, ptr, level, ##__VA_ARGS__)
#else
#define av_log(ptr, level, ...) av_log_nothing()
#endif
