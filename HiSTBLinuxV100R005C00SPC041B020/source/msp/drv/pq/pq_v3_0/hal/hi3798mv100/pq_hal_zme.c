...
/* Explanation: 
   ...
   */
static HI_U32 VpssZmeLoadCoefHL(VZME_COEF_RATIO_E enCoefRatio, HI_U32* pu32Addr)
{
    ZME_COEF_BITARRAY_S stArray;
    ...
    memcpy(pu32Addr, stArray.s32CoefAttr, stArray.u32Size); /* function memcpy unit is Byte */
...
static HI_U32 VpssZmeLoadCoefHC(VZME_COEF_RATIO_E enCoefRatio, HI_U32* pu32Addr)
{
    ZME_COEF_BITARRAY_S stArray;
...
/* Modify start d00241380 2014-12-10; for logic when LTI and CTI enable, it must set to fither mode
   ...
   */
    ...
    pstZmeRtlPara->bZmeMdVL = 1;
    pstZmeRtlPara->bZmeMdVC = 1;
/* Modify end d00241380 2014-12-10 */
