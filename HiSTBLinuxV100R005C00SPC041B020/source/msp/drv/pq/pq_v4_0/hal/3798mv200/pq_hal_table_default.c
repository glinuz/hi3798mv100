...
static PQ_PHY_REG_S sg_stPhyRegDefault[PHY_REG_MAX] =
{
    ...
    {0x3808,        12,     17,     2,      4,      HI_PQ_MODULE_TNR,       18},    //cmdgain
    {0x3808,        6,      11,     2,      4,      HI_PQ_MODULE_TNR,       3},     //ymdcore
    {0x3808,        0,      5,      2,      4,      HI_PQ_MODULE_TNR,       18},    //ymdgain
    {0x3808,        18,     23,     2,      5,      HI_PQ_MODULE_TNR,       0},     //cmdcore
    {0x3808,        12,     17,     2,      5,      HI_PQ_MODULE_TNR,       48},    //cmdgain
    {0x3808,        6,      11,     2,      5,      HI_PQ_MODULE_TNR,       0},     //ymdcore
    {0x3808,        0,      5,      2,      5,      HI_PQ_MODULE_TNR,       48},    //ymdgain
    /***********************************************ACC***********************************************/
    /*VHDACCTHD1*/
    ...
    {0x621c,    10,      19,        0,      4,      HI_PQ_MODULE_SHARPNESS, 64},     //edge_gain
    {0x621c,     0,       9,        0,      4,      HI_PQ_MODULE_SHARPNESS, 160},     //peak_gain
    {0x621c,    10,      19,        0,      5,      HI_PQ_MODULE_SHARPNESS, 64},     //edge_gain
    {0x621c,     0,       9,        0,      5,      HI_PQ_MODULE_SHARPNESS, 160},     //peak_gain
    /************************************* ZME DS *****************************************/
    /* SHOOTCTRL_HL */
