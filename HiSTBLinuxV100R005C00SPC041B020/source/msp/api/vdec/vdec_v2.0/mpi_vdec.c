...
HI_VOID HI_VDEC_SetDefaultCapLevel(VDEC_INST_S* pstVdec, HI_CHIP_TYPE_E ChipType, HI_CHIP_VERSION_E ChipVersion)
{
...
HI_S32 HI_MPI_VDEC_AllocChan(HI_HANDLE *phHandle, const HI_UNF_AVPLAY_OPEN_OPT_S *pstMaxCapbility)
{
    ...
    if (HI_NULL == pstMaxCapbility)
    {
        ...
        HI_VDEC_SetDefaultCapLevel(pstVdec, ChipType, ChipVersion);
    }
    else
    {
...
static VDEC_PRE_CAP_E HI_MPI_VDEC_GetPreCap_256(HI_VOID)
{
    VDEC_PRE_CAP_E ePreCap;

    if (1 == HI_VIDEO_PRE_CAP_1080P_IN_256)
    {
        ePreCap = VDEC_PRE_CAP_1080P;
    }
    else if (1 == HI_VIDEO_PRE_CAP_MVC_IN_256)
    {
        ePreCap = VDEC_PRE_CAP_MVC;
    }
    else if (1 == HI_VIDEO_PRE_CAP_2160P_IN_256)
    {
        ePreCap = VDEC_PRE_CAP_2160P;
    }
    else if (1 == HI_VIDEO_PRE_CAP_4K_IN_256)
    {
        ePreCap = VDEC_PRE_CAP_4K;
    }
    else
    {
        ePreCap = VDEC_PRE_CAP_BUTT;
    }

    return ePreCap;
}

static VDEC_PRE_CAP_E HI_MPI_VDEC_GetPreCap_512(HI_VOID)
{
    VDEC_PRE_CAP_E ePreCap;
...
static VDEC_PRE_CAP_E HI_MPI_VDEC_GetPreCap_768(HI_VOID)
{
    VDEC_PRE_CAP_E ePreCap;
...
static VDEC_PRE_CAP_E HI_MPI_VDEC_GetPreCap_1024(HI_VOID)
{
    VDEC_PRE_CAP_E ePreCap;
...
static VDEC_PRE_CAP_E HI_MPI_VDEC_GetPreCap_2048(HI_VOID)
{
    VDEC_PRE_CAP_E ePreCap;
...
HI_S32 HI_MPI_VDEC_GetPreCap(VDEC_PRE_CAP_E* peCapType)
{
    ...
    else
    {
        ...
        {
            case 256:
                *peCapType = HI_MPI_VDEC_GetPreCap_256();
                if (*peCapType == VDEC_PRE_CAP_BUTT)
                {
                    return HI_FAILURE;
                }
                break;
            ...
            case 512:
                *peCapType = HI_MPI_VDEC_GetPreCap_512();
                if (*peCapType == VDEC_PRE_CAP_BUTT)
                {
                    return HI_FAILURE;
                }
            ...
            case 768:
                *peCapType = HI_MPI_VDEC_GetPreCap_768();
                if (*peCapType == VDEC_PRE_CAP_BUTT)
                {
                    return HI_FAILURE;
                }
            ...
            case 2048:
                *peCapType = HI_MPI_VDEC_GetPreCap_2048();
                if (*peCapType == VDEC_PRE_CAP_BUTT)
                {
                    return HI_FAILURE;
                }
            ...
            case 1024:
            default:
                *peCapType = HI_MPI_VDEC_GetPreCap_1024();
                if (*peCapType == VDEC_PRE_CAP_BUTT)
                {
                    return HI_FAILURE;
                }
