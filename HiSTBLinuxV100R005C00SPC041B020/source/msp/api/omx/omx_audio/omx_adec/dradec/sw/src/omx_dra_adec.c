...
#define SIZE_IN_BUFFERS_DRA  16*1024     // Input  Buffers Size
static const HI_CHAR* g_szHA_DRADecoder = "libHA.AUDIO.DRA.decode.so";



OMX_ERRORTYPE HI_OMX_DRA_GetParameter(OMX_IN OMX_HANDLETYPE hComponent,
                                      ...
                                      OMX_INOUT OMX_PTR     ComponentParameterStructure)
{
    ...
    switch (nParamIndex)
    {
        ...
        case OMX_IndexParamAudioAndroidDra:
            OMX_OSAL_Trace(OMX_OSAL_TRACE_DEBUG, "%s -> OMX_IndexParamAudioAndroidDra\n", __FUNCTION__);
            memcpy(ComponentParameterStructure, (OMX_AUDIO_PARAM_ANDROID_DRATYPE*)pHAData->pCodecParam, sizeof(OMX_AUDIO_PARAM_ANDROID_DRATYPE));
            break;
...
OMX_ERRORTYPE HI_OMX_DRA_SetParameter(OMX_IN OMX_HANDLETYPE hComponent,
                                      ...
                                      OMX_IN OMX_PTR        ComponentParameterStructure)
{
    ...
    switch (nIndex)
    {
        ...
        case OMX_IndexParamAudioAndroidDra:
            OMX_OSAL_Trace(OMX_OSAL_TRACE_DEBUG, "%s -> OMX_IndexParamAudioAndroidDra\n", __FUNCTION__);
            memcpy((OMX_AUDIO_PARAM_ANDROID_DRATYPE*)pHAData->pCodecParam, ComponentParameterStructure,
                   sizeof(OMX_AUDIO_PARAM_ANDROID_DRATYPE));
            break;
...
OMX_ERRORTYPE HI_OMX_DRA_ComponentRoleEnum(OMX_IN OMX_HANDLETYPE hComponent,
...
OMX_ERRORTYPE component_init(OMX_HANDLETYPE phandle, OMX_STRING comp_name)
{
    ...
    pHAData->pCodecParam = (OMX_AUDIO_PARAM_ANDROID_DRATYPE*)OMX_OSAL_Malloc(sizeof(OMX_AUDIO_PARAM_ANDROID_DRATYPE));
    ...
    memset(pHAData->pCodecParam, 0x0, sizeof(OMX_AUDIO_PARAM_ANDROID_DRATYPE));
    ...
    p_Component->GetParameter           = HI_OMX_DRA_GetParameter;
    p_Component->SetParameter           = HI_OMX_DRA_SetParameter;
    p_Component->ComponentRoleEnum      = HI_OMX_DRA_ComponentRoleEnum;
    ...
    pHAData->sInPortDef.format.audio.eEncoding = OMX_AUDIO_CodingAndroidDRA;
    ...
    pHAData->sInPortDef.nBufferSize = (OMX_U32)(SIZE_IN_BUFFERS_DRA);
    ...
    OMX_OSAL_Trace(OMX_OSAL_TRACE_ERROR, "HA_DRA_DecGetOpenParam_MultichPcm\n");
    HA_DRA_DecGetOpenParam_MultichPcm(&pHAData->stAdec.sOpenPram);

    pHAData->stAdec.pstHA = HA_OMX_RegisterDecoderLib(g_szHA_DRADecoder);
    ...
    OMX_CONF_INIT_STRUCT_PTR((OMX_AUDIO_PARAM_ANDROID_DRATYPE*)pHAData->pCodecParam, OMX_AUDIO_PARAM_ANDROID_DRATYPE);
    //Default values for DRA audio param port
    ((OMX_AUDIO_PARAM_ANDROID_DRATYPE*)pHAData->pCodecParam)->nPortIndex      = 0x0;
    ((OMX_AUDIO_PARAM_ANDROID_DRATYPE*)pHAData->pCodecParam)->nChannels       = 2;
    ((OMX_AUDIO_PARAM_ANDROID_DRATYPE*)pHAData->pCodecParam)->nBitRate        = 0;
    ((OMX_AUDIO_PARAM_ANDROID_DRATYPE*)pHAData->pCodecParam)->nSampleRate     = 48000;
