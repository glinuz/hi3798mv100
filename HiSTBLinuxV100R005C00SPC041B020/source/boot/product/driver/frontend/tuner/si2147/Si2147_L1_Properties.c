...
/*****************************************************************************************
 NAME: Si2147_downloadATVProperties
  DESCRIPTION: Setup Si2147 ATV properties configuration
...
int  Si2147_downloadATVProperties         (L1_Si2147_Context *api) {
  SiTRACE("Si2147_downloadATVProperties\n");
#ifdef    Si2147_ATV_AFC_RANGE_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_AFC_RANGE_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_AFC_RANGE_PROP */
#ifdef    Si2147_ATV_AGC_SPEED_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_AGC_SPEED_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_AGC_SPEED_PROP */
#ifdef    Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP */
#ifdef    Si2147_ATV_ARTIFICIAL_SNOW_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_ARTIFICIAL_SNOW_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_ARTIFICIAL_SNOW_PROP */
#ifdef    Si2147_ATV_CONFIG_IF_PORT_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_CONFIG_IF_PORT_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_CONFIG_IF_PORT_PROP */
#ifdef    Si2147_ATV_EXT_AGC_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_EXT_AGC_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_EXT_AGC_PROP */
#ifdef    Si2147_ATV_HSYNC_OUT_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_HSYNC_OUT_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_HSYNC_OUT_PROP */
#ifdef    Si2147_ATV_IEN_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_IEN_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_IEN_PROP */
#ifdef    Si2147_ATV_INT_SENSE_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_INT_SENSE_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_INT_SENSE_PROP */
#ifdef    Si2147_ATV_LIF_FREQ_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_LIF_FREQ_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_LIF_FREQ_PROP */
#ifdef    Si2147_ATV_LIF_OUT_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_LIF_OUT_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_LIF_OUT_PROP */
#ifdef    Si2147_ATV_PGA_TARGET_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_PGA_TARGET_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_PGA_TARGET_PROP */
#ifdef    Si2147_ATV_RF_TOP_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_RF_TOP_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_RF_TOP_PROP */
#ifdef    Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP */
#ifdef    Si2147_ATV_VIDEO_MODE_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_VIDEO_MODE_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_ATV_VIDEO_MODE_PROP */
#ifdef    Si2147_ATV_VSNR_CAP_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_ATV_VSNR_CAP_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
...
#ifdef    Si2147_DTV_RESERVED0_PROP
  if (Si2147_L1_SetProperty2(api, Si2147_DTV_RESERVED0_PROP_CODE               ) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_DTV_RESERVED0_PROP */
...
int  Si2147_downloadTUNERProperties       (L1_Si2147_Context *api) {
  ...
  if (Si2147_L1_SetProperty2(api, Si2147_WIDE_BAND_ATT_THRS_PROP_CODE) != NO_Si2147_ERROR) {return ERROR_Si2147_SENDING_COMMAND;}
#endif /* Si2147_WIDE_BAND_ATT_THRS_PROP */
return NO_Si2147_ERROR;
}
int Si2147_downloadAllProperties         (L1_Si2147_Context *api) {
  Si2147_downloadATVProperties         (api);
...
unsigned char Si2147_PackProperty            (Si2147_PropObj   *prop, unsigned int prop_code, int *data) {
    switch (prop_code) {
    #ifdef        Si2147_ATV_AFC_RANGE_PROP
     case         Si2147_ATV_AFC_RANGE_PROP_CODE:
      *data = (prop->atv_afc_range.range_khz & Si2147_ATV_AFC_RANGE_PROP_RANGE_KHZ_MASK) << Si2147_ATV_AFC_RANGE_PROP_RANGE_KHZ_LSB ;
     break;
    #endif /*     Si2147_ATV_AFC_RANGE_PROP */
    #ifdef        Si2147_ATV_AGC_SPEED_PROP
     case         Si2147_ATV_AGC_SPEED_PROP_CODE:
      *data = (prop->atv_agc_speed.if_agc_speed & Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK) << Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB ;
     break;
    #endif /*     Si2147_ATV_AGC_SPEED_PROP */
    #ifdef        Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP
     case         Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_CODE:
      *data = (prop->atv_agc_speed_low_rssi.if_agc_speed & Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_MASK) << Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_LSB  |
              (prop->atv_agc_speed_low_rssi.thld         & Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_THLD_MASK        ) << Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_THLD_LSB ;
     break;
    #endif /*     Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP */
    #ifdef        Si2147_ATV_ARTIFICIAL_SNOW_PROP
     case         Si2147_ATV_ARTIFICIAL_SNOW_PROP_CODE:
      *data = (prop->atv_artificial_snow.gain   & Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_MASK  ) << Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_LSB  |
              (prop->atv_artificial_snow.period & Si2147_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_MASK) << Si2147_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_LSB  |
              (prop->atv_artificial_snow.offset & Si2147_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_MASK) << Si2147_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_LSB ;
     break;
    #endif /*     Si2147_ATV_ARTIFICIAL_SNOW_PROP */
    #ifdef        Si2147_ATV_CONFIG_IF_PORT_PROP
     case         Si2147_ATV_CONFIG_IF_PORT_PROP_CODE:
      *data = (prop->atv_config_if_port.atv_out_type   & Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_MASK  ) << Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_LSB  |
              (prop->atv_config_if_port.atv_agc_source & Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_MASK) << Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_LSB ;
     break;
    #endif /*     Si2147_ATV_CONFIG_IF_PORT_PROP */
    #ifdef        Si2147_ATV_EXT_AGC_PROP
     case         Si2147_ATV_EXT_AGC_PROP_CODE:
      *data = (prop->atv_ext_agc.min_10mv & Si2147_ATV_EXT_AGC_PROP_MIN_10MV_MASK) << Si2147_ATV_EXT_AGC_PROP_MIN_10MV_LSB  |
              (prop->atv_ext_agc.max_10mv & Si2147_ATV_EXT_AGC_PROP_MAX_10MV_MASK) << Si2147_ATV_EXT_AGC_PROP_MAX_10MV_LSB ;
     break;
    #endif /*     Si2147_ATV_EXT_AGC_PROP */
    #ifdef        Si2147_ATV_HSYNC_OUT_PROP
     case         Si2147_ATV_HSYNC_OUT_PROP_CODE:
      *data = (prop->atv_hsync_out.gpio_sel & Si2147_ATV_HSYNC_OUT_PROP_GPIO_SEL_MASK) << Si2147_ATV_HSYNC_OUT_PROP_GPIO_SEL_LSB  |
              (prop->atv_hsync_out.width    & Si2147_ATV_HSYNC_OUT_PROP_WIDTH_MASK   ) << Si2147_ATV_HSYNC_OUT_PROP_WIDTH_LSB  |
              (prop->atv_hsync_out.offset   & Si2147_ATV_HSYNC_OUT_PROP_OFFSET_MASK  ) << Si2147_ATV_HSYNC_OUT_PROP_OFFSET_LSB ;
     break;
    #endif /*     Si2147_ATV_HSYNC_OUT_PROP */
    #ifdef        Si2147_ATV_IEN_PROP
     case         Si2147_ATV_IEN_PROP_CODE:
      *data = (prop->atv_ien.chlien & Si2147_ATV_IEN_PROP_CHLIEN_MASK) << Si2147_ATV_IEN_PROP_CHLIEN_LSB  |
              (prop->atv_ien.pclien & Si2147_ATV_IEN_PROP_PCLIEN_MASK) << Si2147_ATV_IEN_PROP_PCLIEN_LSB ;
     break;
    #endif /*     Si2147_ATV_IEN_PROP */
    #ifdef        Si2147_ATV_INT_SENSE_PROP
     case         Si2147_ATV_INT_SENSE_PROP_CODE:
      *data = (prop->atv_int_sense.chlnegen & Si2147_ATV_INT_SENSE_PROP_CHLNEGEN_MASK) << Si2147_ATV_INT_SENSE_PROP_CHLNEGEN_LSB  |
              (prop->atv_int_sense.pclnegen & Si2147_ATV_INT_SENSE_PROP_PCLNEGEN_MASK) << Si2147_ATV_INT_SENSE_PROP_PCLNEGEN_LSB  |
              (prop->atv_int_sense.chlposen & Si2147_ATV_INT_SENSE_PROP_CHLPOSEN_MASK) << Si2147_ATV_INT_SENSE_PROP_CHLPOSEN_LSB  |
              (prop->atv_int_sense.pclposen & Si2147_ATV_INT_SENSE_PROP_PCLPOSEN_MASK) << Si2147_ATV_INT_SENSE_PROP_PCLPOSEN_LSB ;
     break;
    #endif /*     Si2147_ATV_INT_SENSE_PROP */
    #ifdef        Si2147_ATV_LIF_FREQ_PROP
     case         Si2147_ATV_LIF_FREQ_PROP_CODE:
      *data = (prop->atv_lif_freq.offset & Si2147_ATV_LIF_FREQ_PROP_OFFSET_MASK) << Si2147_ATV_LIF_FREQ_PROP_OFFSET_LSB ;
     break;
    #endif /*     Si2147_ATV_LIF_FREQ_PROP */
    #ifdef        Si2147_ATV_LIF_OUT_PROP
     case         Si2147_ATV_LIF_OUT_PROP_CODE:
      *data = (prop->atv_lif_out.offset & Si2147_ATV_LIF_OUT_PROP_OFFSET_MASK) << Si2147_ATV_LIF_OUT_PROP_OFFSET_LSB  |
              (prop->atv_lif_out.amp    & Si2147_ATV_LIF_OUT_PROP_AMP_MASK   ) << Si2147_ATV_LIF_OUT_PROP_AMP_LSB ;
     break;
    #endif /*     Si2147_ATV_LIF_OUT_PROP */
    #ifdef        Si2147_ATV_PGA_TARGET_PROP
     case         Si2147_ATV_PGA_TARGET_PROP_CODE:
      *data = (prop->atv_pga_target.pga_target      & Si2147_ATV_PGA_TARGET_PROP_PGA_TARGET_MASK     ) << Si2147_ATV_PGA_TARGET_PROP_PGA_TARGET_LSB  |
              (prop->atv_pga_target.override_enable & Si2147_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_MASK) << Si2147_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_LSB ;
     break;
    #endif /*     Si2147_ATV_PGA_TARGET_PROP */
    #ifdef        Si2147_ATV_RF_TOP_PROP
     case         Si2147_ATV_RF_TOP_PROP_CODE:
      *data = (prop->atv_rf_top.atv_rf_top & Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_MASK) << Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_LSB ;
     break;
    #endif /*     Si2147_ATV_RF_TOP_PROP */
    #ifdef        Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP
     case         Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_CODE:
      *data = (prop->atv_rsq_rssi_threshold.lo & Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK) << Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB  |
              (prop->atv_rsq_rssi_threshold.hi & Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_MASK) << Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_LSB ;
     break;
    #endif /*     Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2147_ATV_VIDEO_MODE_PROP
     case         Si2147_ATV_VIDEO_MODE_PROP_CODE:
      *data = (prop->atv_video_mode.video_sys       & Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_MASK      ) << Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_LSB  |
              (prop->atv_video_mode.color           & Si2147_ATV_VIDEO_MODE_PROP_COLOR_MASK          ) << Si2147_ATV_VIDEO_MODE_PROP_COLOR_LSB  |
              (prop->atv_video_mode.invert_spectrum & Si2147_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_MASK) << Si2147_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_LSB ;
     break;
    #endif /*     Si2147_ATV_VIDEO_MODE_PROP */
    #ifdef        Si2147_ATV_VSNR_CAP_PROP
     case         Si2147_ATV_VSNR_CAP_PROP_CODE:
      *data = (prop->atv_vsnr_cap.atv_vsnr_cap & Si2147_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_MASK) << Si2147_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_LSB ;
     break;
    #endif /*     Si2147_ATV_VSNR_CAP_PROP */
    #ifdef        Si2147_CRYSTAL_TRIM_PROP
    ...
    #endif /*     Si2147_TUNER_RETURN_LOSS_PROP */
    #ifdef        Si2147_WIDE_BAND_ATT_THRS_PROP
     case         Si2147_WIDE_BAND_ATT_THRS_PROP_CODE:
      *data = (prop->wide_band_att_thrs.wb_att_thrs & Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_MASK) << Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_LSB ;
     break;
    #endif /*     Si2147_WIDE_BAND_ATT_THRS_PROP */
    #ifdef        Si2147_XOUT_PROP
...
unsigned char Si2147_UnpackProperty          (Si2147_PropObj   *prop, unsigned int prop_code, int  data) {
    ...
    #ifdef        Si2147_ATV_AFC_RANGE_PROP
     case         Si2147_ATV_AFC_RANGE_PROP_CODE:
               prop->atv_afc_range.range_khz = (data >> Si2147_ATV_AFC_RANGE_PROP_RANGE_KHZ_LSB) & Si2147_ATV_AFC_RANGE_PROP_RANGE_KHZ_MASK;
     break;
    #endif /*     Si2147_ATV_AFC_RANGE_PROP */
    #ifdef        Si2147_ATV_AGC_SPEED_PROP
     case         Si2147_ATV_AGC_SPEED_PROP_CODE:
               prop->atv_agc_speed.if_agc_speed = (data >> Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB) & Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK;
     break;
    #endif /*     Si2147_ATV_AGC_SPEED_PROP */
    #ifdef        Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP
     case         Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_CODE:
               prop->atv_agc_speed_low_rssi.if_agc_speed = (data >> Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_LSB) & Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_MASK;
               prop->atv_agc_speed_low_rssi.thld         = (data >> Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_THLD_LSB        ) & Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_THLD_MASK;
     break;
    #endif /*     Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP */
    #ifdef        Si2147_ATV_ARTIFICIAL_SNOW_PROP
     case         Si2147_ATV_ARTIFICIAL_SNOW_PROP_CODE:
               prop->atv_artificial_snow.gain   = (data >> Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_LSB  ) & Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_MASK;
               prop->atv_artificial_snow.period = (data >> Si2147_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_LSB) & Si2147_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_MASK;
               prop->atv_artificial_snow.offset = (data >> Si2147_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_LSB) & Si2147_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_MASK;
     break;
    #endif /*     Si2147_ATV_ARTIFICIAL_SNOW_PROP */
    #ifdef        Si2147_ATV_CONFIG_IF_PORT_PROP
     case         Si2147_ATV_CONFIG_IF_PORT_PROP_CODE:
               prop->atv_config_if_port.atv_out_type   = (data >> Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_LSB  ) & Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_MASK;
               prop->atv_config_if_port.atv_agc_source = (data >> Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_LSB) & Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_MASK;
     break;
    #endif /*     Si2147_ATV_CONFIG_IF_PORT_PROP */
    #ifdef        Si2147_ATV_EXT_AGC_PROP
     case         Si2147_ATV_EXT_AGC_PROP_CODE:
               prop->atv_ext_agc.min_10mv = (data >> Si2147_ATV_EXT_AGC_PROP_MIN_10MV_LSB) & Si2147_ATV_EXT_AGC_PROP_MIN_10MV_MASK;
               prop->atv_ext_agc.max_10mv = (data >> Si2147_ATV_EXT_AGC_PROP_MAX_10MV_LSB) & Si2147_ATV_EXT_AGC_PROP_MAX_10MV_MASK;
     break;
    #endif /*     Si2147_ATV_EXT_AGC_PROP */
    #ifdef        Si2147_ATV_HSYNC_OUT_PROP
     case         Si2147_ATV_HSYNC_OUT_PROP_CODE:
               prop->atv_hsync_out.gpio_sel = (data >> Si2147_ATV_HSYNC_OUT_PROP_GPIO_SEL_LSB) & Si2147_ATV_HSYNC_OUT_PROP_GPIO_SEL_MASK;
               prop->atv_hsync_out.width    = (data >> Si2147_ATV_HSYNC_OUT_PROP_WIDTH_LSB   ) & Si2147_ATV_HSYNC_OUT_PROP_WIDTH_MASK;
               prop->atv_hsync_out.offset   = (data >> Si2147_ATV_HSYNC_OUT_PROP_OFFSET_LSB  ) & Si2147_ATV_HSYNC_OUT_PROP_OFFSET_MASK;
     break;
    #endif /*     Si2147_ATV_HSYNC_OUT_PROP */
    #ifdef        Si2147_ATV_IEN_PROP
     case         Si2147_ATV_IEN_PROP_CODE:
               prop->atv_ien.chlien = (data >> Si2147_ATV_IEN_PROP_CHLIEN_LSB) & Si2147_ATV_IEN_PROP_CHLIEN_MASK;
               prop->atv_ien.pclien = (data >> Si2147_ATV_IEN_PROP_PCLIEN_LSB) & Si2147_ATV_IEN_PROP_PCLIEN_MASK;
     break;
    #endif /*     Si2147_ATV_IEN_PROP */
    #ifdef        Si2147_ATV_INT_SENSE_PROP
     case         Si2147_ATV_INT_SENSE_PROP_CODE:
               prop->atv_int_sense.chlnegen = (data >> Si2147_ATV_INT_SENSE_PROP_CHLNEGEN_LSB) & Si2147_ATV_INT_SENSE_PROP_CHLNEGEN_MASK;
               prop->atv_int_sense.pclnegen = (data >> Si2147_ATV_INT_SENSE_PROP_PCLNEGEN_LSB) & Si2147_ATV_INT_SENSE_PROP_PCLNEGEN_MASK;
               prop->atv_int_sense.chlposen = (data >> Si2147_ATV_INT_SENSE_PROP_CHLPOSEN_LSB) & Si2147_ATV_INT_SENSE_PROP_CHLPOSEN_MASK;
               prop->atv_int_sense.pclposen = (data >> Si2147_ATV_INT_SENSE_PROP_PCLPOSEN_LSB) & Si2147_ATV_INT_SENSE_PROP_PCLPOSEN_MASK;
     break;
    #endif /*     Si2147_ATV_INT_SENSE_PROP */
    #ifdef        Si2147_ATV_LIF_FREQ_PROP
     case         Si2147_ATV_LIF_FREQ_PROP_CODE:
               prop->atv_lif_freq.offset = (data >> Si2147_ATV_LIF_FREQ_PROP_OFFSET_LSB) & Si2147_ATV_LIF_FREQ_PROP_OFFSET_MASK;
     break;
    #endif /*     Si2147_ATV_LIF_FREQ_PROP */
    #ifdef        Si2147_ATV_LIF_OUT_PROP
     case         Si2147_ATV_LIF_OUT_PROP_CODE:
               prop->atv_lif_out.offset = (data >> Si2147_ATV_LIF_OUT_PROP_OFFSET_LSB) & Si2147_ATV_LIF_OUT_PROP_OFFSET_MASK;
               prop->atv_lif_out.amp    = (data >> Si2147_ATV_LIF_OUT_PROP_AMP_LSB   ) & Si2147_ATV_LIF_OUT_PROP_AMP_MASK;
     break;
    #endif /*     Si2147_ATV_LIF_OUT_PROP */
    #ifdef        Si2147_ATV_PGA_TARGET_PROP
     case         Si2147_ATV_PGA_TARGET_PROP_CODE:
               prop->atv_pga_target.pga_target      = (data >> Si2147_ATV_PGA_TARGET_PROP_PGA_TARGET_LSB     ) & Si2147_ATV_PGA_TARGET_PROP_PGA_TARGET_MASK;
               prop->atv_pga_target.override_enable = (data >> Si2147_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_LSB) & Si2147_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_MASK;
     break;
    #endif /*     Si2147_ATV_PGA_TARGET_PROP */
    #ifdef        Si2147_ATV_RF_TOP_PROP
     case         Si2147_ATV_RF_TOP_PROP_CODE:
               prop->atv_rf_top.atv_rf_top = (data >> Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_LSB) & Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_MASK;
     break;
    #endif /*     Si2147_ATV_RF_TOP_PROP */
    #ifdef        Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP
     case         Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_CODE:
               prop->atv_rsq_rssi_threshold.lo = (data >> Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB) & Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK;
               prop->atv_rsq_rssi_threshold.hi = (data >> Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_LSB) & Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_MASK;
     break;
    #endif /*     Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2147_ATV_VIDEO_MODE_PROP
     case         Si2147_ATV_VIDEO_MODE_PROP_CODE:
               prop->atv_video_mode.video_sys       = (data >> Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_LSB      ) & Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_MASK;
               prop->atv_video_mode.color           = (data >> Si2147_ATV_VIDEO_MODE_PROP_COLOR_LSB          ) & Si2147_ATV_VIDEO_MODE_PROP_COLOR_MASK;
               prop->atv_video_mode.invert_spectrum = (data >> Si2147_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_LSB) & Si2147_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_MASK;
     break;
    #endif /*     Si2147_ATV_VIDEO_MODE_PROP */
    #ifdef        Si2147_ATV_VSNR_CAP_PROP
     case         Si2147_ATV_VSNR_CAP_PROP_CODE:
               prop->atv_vsnr_cap.atv_vsnr_cap = (data >> Si2147_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_LSB) & Si2147_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_MASK;
     break;
    #endif /*     Si2147_ATV_VSNR_CAP_PROP */
    #ifdef        Si2147_CRYSTAL_TRIM_PROP
     case         Si2147_CRYSTAL_TRIM_PROP_CODE:
    ...
    #ifdef        Si2147_WIDE_BAND_ATT_THRS_PROP
     case         Si2147_WIDE_BAND_ATT_THRS_PROP_CODE:
               prop->wide_band_att_thrs.wb_att_thrs = (data >> Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_LSB) & Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_MASK;
     break;
    #endif /*     Si2147_WIDE_BAND_ATT_THRS_PROP */
    #ifdef        Si2147_XOUT_PROP
     case         Si2147_XOUT_PROP_CODE:
...
void          Si2147_storePropertiesDefaults(Si2147_PropObj   *prop) {
...
#ifdef    Si2147_ATV_AGC_SPEED_PROP
  prop->atv_agc_speed.if_agc_speed           = Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_AUTO ; /* (default 'AUTO') */
#endif /* Si2147_ATV_AGC_SPEED_PROP */

#ifdef    Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP
  prop->atv_agc_speed_low_rssi.if_agc_speed  = Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_158 ; /* (default '158') */
  prop->atv_agc_speed_low_rssi.thld          =  -128; /* (default  -128) */
#endif /* Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP */

#ifdef    Si2147_ATV_ARTIFICIAL_SNOW_PROP
  prop->atv_artificial_snow.gain             = Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_AUTO   ; /* (default 'AUTO') */
  prop->atv_artificial_snow.period           = Si2147_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_LONG ; /* (default 'LONG') */
  prop->atv_artificial_snow.offset           =     0; /* (default     0) */
#endif /* Si2147_ATV_ARTIFICIAL_SNOW_PROP */

#ifdef    Si2147_ATV_CONFIG_IF_PORT_PROP
  prop->atv_config_if_port.atv_out_type      = Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_LIF_DIFF_IF1   ; /* (default 'LIF_DIFF_IF1') */
  prop->atv_config_if_port.atv_agc_source    = Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_INTERNAL     ; /* (default 'INTERNAL') */
#endif /* Si2147_ATV_CONFIG_IF_PORT_PROP */
...
#ifdef    Si2147_ATV_HSYNC_OUT_PROP
  prop->atv_hsync_out.gpio_sel               = Si2147_ATV_HSYNC_OUT_PROP_GPIO_SEL_NONE ; /* (default 'NONE') */
  prop->atv_hsync_out.width                  =    42; /* (default    42) */
  prop->atv_hsync_out.offset                 =     0; /* (default     0) */
#endif /* Si2147_ATV_HSYNC_OUT_PROP */

#ifdef    Si2147_ATV_IEN_PROP
  prop->atv_ien.chlien                       = Si2147_ATV_IEN_PROP_CHLIEN_ENABLE  ; /* (default 'ENABLE') */
  prop->atv_ien.pclien                       = Si2147_ATV_IEN_PROP_PCLIEN_DISABLE ; /* (default 'DISABLE') */
#endif /* Si2147_ATV_IEN_PROP */

#ifdef    Si2147_ATV_INT_SENSE_PROP
  prop->atv_int_sense.chlnegen               = Si2147_ATV_INT_SENSE_PROP_CHLNEGEN_DISABLE ; /* (default 'DISABLE') */
  prop->atv_int_sense.pclnegen               = Si2147_ATV_INT_SENSE_PROP_PCLNEGEN_DISABLE ; /* (default 'DISABLE') */
  prop->atv_int_sense.chlposen               = Si2147_ATV_INT_SENSE_PROP_CHLPOSEN_ENABLE  ; /* (default 'ENABLE') */
  prop->atv_int_sense.pclposen               = Si2147_ATV_INT_SENSE_PROP_PCLPOSEN_ENABLE  ; /* (default 'ENABLE') */
#endif /* Si2147_ATV_INT_SENSE_PROP */
  ...
  prop->atv_pga_target.override_enable       = Si2147_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_DISABLE ; /* (default 'DISABLE') */
#endif /* Si2147_ATV_PGA_TARGET_PROP */

#ifdef    Si2147_ATV_RF_TOP_PROP
  prop->atv_rf_top.atv_rf_top                = Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_AUTO ; /* (default 'AUTO') */
#endif /* Si2147_ATV_RF_TOP_PROP */
...
#ifdef    Si2147_ATV_VIDEO_MODE_PROP
  prop->atv_video_mode.video_sys             = Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_B              ; /* (default 'B') */
  prop->atv_video_mode.color                 = Si2147_ATV_VIDEO_MODE_PROP_COLOR_PAL_NTSC           ; /* (default 'PAL_NTSC') */
  prop->atv_video_mode.invert_spectrum       = Si2147_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_INVERTED ; /* (default 'INVERTED') */
#endif /* Si2147_ATV_VIDEO_MODE_PROP */
...
#ifdef    Si2147_WIDE_BAND_ATT_THRS_PROP
  prop->wide_band_att_thrs.wb_att_thrs       = Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_AUTO ; /* (default 'AUTO') */
#endif /*     Si2147_WIDE_BAND_ATT_THRS_PROP */
