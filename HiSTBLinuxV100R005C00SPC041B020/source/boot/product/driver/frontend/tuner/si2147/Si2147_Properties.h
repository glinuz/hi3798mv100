...
/* Si2147 ATV_AFC_RANGE property definition */
#define   Si2147_ATV_AFC_RANGE_PROP 0x0610

#ifdef    Si2147_ATV_AFC_RANGE_PROP
  #define Si2147_ATV_AFC_RANGE_PROP_CODE 0x000610


    typedef struct { /* Si2147_ATV_AFC_RANGE_PROP_struct */
      unsigned int    range_khz;
   } Si2147_ATV_AFC_RANGE_PROP_struct;

   /* ATV_AFC_RANGE property, RANGE_KHZ field definition (NO TITLE)*/
   #define  Si2147_ATV_AFC_RANGE_PROP_RANGE_KHZ_LSB         0
   #define  Si2147_ATV_AFC_RANGE_PROP_RANGE_KHZ_MASK        0xffff
   #define  Si2147_ATV_AFC_RANGE_PROP_RANGE_KHZ_DEFAULT    1000
    #define Si2147_ATV_AFC_RANGE_PROP_RANGE_KHZ_RANGE_KHZ_MIN  0
    #define Si2147_ATV_AFC_RANGE_PROP_RANGE_KHZ_RANGE_KHZ_MAX  65535

#endif /* Si2147_ATV_AFC_RANGE_PROP */

/* Si2147 ATV_AGC_SPEED property definition */
#define   Si2147_ATV_AGC_SPEED_PROP 0x0611

#ifdef    Si2147_ATV_AGC_SPEED_PROP
  #define Si2147_ATV_AGC_SPEED_PROP_CODE 0x000611


    typedef struct { /* Si2147_ATV_AGC_SPEED_PROP_struct */
      unsigned char   if_agc_speed;
   } Si2147_ATV_AGC_SPEED_PROP_struct;

   /* ATV_AGC_SPEED property, IF_AGC_SPEED field definition (NO TITLE)*/
   #define  Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB         0
   #define  Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK        0xff
   #define  Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_DEFAULT    0
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_AUTO    0
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_89      89
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_105     105
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_121     121
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_137     137
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_158     158
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_172     172
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_178     178
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_185     185
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_196     196
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_206     206
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_216     216
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_219     219
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_222     222
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_223     223
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_248     248
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_250     250
    #define Si2147_ATV_AGC_SPEED_PROP_IF_AGC_SPEED_251     251

#endif /* Si2147_ATV_AGC_SPEED_PROP */

/* Si2147 ATV_AGC_SPEED_LOW_RSSI property definition */
#define   Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP 0x0623

#ifdef    Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP
  #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_CODE 0x000623


    typedef struct { /* Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_struct */
      unsigned char   if_agc_speed;
               char   thld;
   } Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_struct;

   /* ATV_AGC_SPEED_LOW_RSSI property, IF_AGC_SPEED field definition (NO TITLE)*/
   #define  Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_LSB         0
   #define  Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_MASK        0xff
   #define  Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_DEFAULT    158
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_89      89
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_105     105
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_121     121
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_137     137
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_158     158
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_172     172
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_178     178
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_185     185
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_196     196
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_206     206
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_216     216
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_219     219
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_222     222
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_223     223
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_248     248
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_250     250
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_IF_AGC_SPEED_251     251

   /* ATV_AGC_SPEED_LOW_RSSI property, THLD field definition (NO TITLE)*/
   #define  Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_THLD_LSB         8
   #define  Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_THLD_MASK        0xff
   #define  Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_THLD_DEFAULT    -128
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_THLD_THLD_MIN  -128
    #define Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_THLD_THLD_MAX  127

#endif /* Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP */

/* Si2147 ATV_ARTIFICIAL_SNOW property definition */
#define   Si2147_ATV_ARTIFICIAL_SNOW_PROP 0x0624

#ifdef    Si2147_ATV_ARTIFICIAL_SNOW_PROP
  #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_CODE 0x000624


    typedef struct { /* Si2147_ATV_ARTIFICIAL_SNOW_PROP_struct */
      unsigned char   gain;
               char   offset;
      unsigned char   period;
   } Si2147_ATV_ARTIFICIAL_SNOW_PROP_struct;

   /* ATV_ARTIFICIAL_SNOW property, GAIN field definition (NO TITLE)*/
   #define  Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_LSB         0
   #define  Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_MASK        0x0f
   #define  Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_DEFAULT    0
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_AUTO  0
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_0DB   1
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_6DB   2
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_12DB  3
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_18DB  4
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_24DB  5
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_30DB  6
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_36DB  7
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_42DB  8
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_GAIN_OFF   9

   /* ATV_ARTIFICIAL_SNOW property, OFFSET field definition (NO TITLE)*/
   #define  Si2147_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_LSB         8
   #define  Si2147_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_MASK        0xff
   #define  Si2147_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_DEFAULT    0
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_OFFSET_MIN  -128
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_OFFSET_MAX  127

   /* ATV_ARTIFICIAL_SNOW property, PERIOD field definition (NO TITLE)*/
   #define  Si2147_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_LSB         7
   #define  Si2147_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_MASK        0x01
   #define  Si2147_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_DEFAULT    0
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_LONG   0
    #define Si2147_ATV_ARTIFICIAL_SNOW_PROP_PERIOD_SHORT  1

#endif /* Si2147_ATV_ARTIFICIAL_SNOW_PROP */

/* Si2147 ATV_CONFIG_IF_PORT property definition */
#define   Si2147_ATV_CONFIG_IF_PORT_PROP 0x0603

#ifdef    Si2147_ATV_CONFIG_IF_PORT_PROP
  #define Si2147_ATV_CONFIG_IF_PORT_PROP_CODE 0x000603


    typedef struct { /* Si2147_ATV_CONFIG_IF_PORT_PROP_struct */
      unsigned char   atv_agc_source;
      unsigned char   atv_out_type;
   } Si2147_ATV_CONFIG_IF_PORT_PROP_struct;

   /* ATV_CONFIG_IF_PORT property, ATV_AGC_SOURCE field definition (NO TITLE)*/
   #define  Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_LSB         8
   #define  Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_MASK        0x07
   #define  Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_DEFAULT    0
    #define Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_INTERNAL  0
    #define Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_AGC1_3DB  1
    #define Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_AGC2_3DB  2

   /* ATV_CONFIG_IF_PORT property, ATV_OUT_TYPE field definition (NO TITLE)*/
   #define  Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_LSB         0
   #define  Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_MASK        0x0f
   #define  Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_DEFAULT    8
    #define Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_LIF_DIFF_IF1  8
    #define Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_LIF_DIFF_IF2  10
    #define Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_LIF_SE_IF1A   12
    #define Si2147_ATV_CONFIG_IF_PORT_PROP_ATV_OUT_TYPE_LIF_SE_IF2A   14

#endif /* Si2147_ATV_CONFIG_IF_PORT_PROP */

/* Si2147 ATV_EXT_AGC property definition */
#define   Si2147_ATV_EXT_AGC_PROP 0x0607

#ifdef    Si2147_ATV_EXT_AGC_PROP
  #define Si2147_ATV_EXT_AGC_PROP_CODE 0x000607


    typedef struct { /* Si2147_ATV_EXT_AGC_PROP_struct */
      unsigned char   max_10mv;
      unsigned char   min_10mv;
   } Si2147_ATV_EXT_AGC_PROP_struct;

   /* ATV_EXT_AGC property, MAX_10MV field definition (NO TITLE)*/
   #define  Si2147_ATV_EXT_AGC_PROP_MAX_10MV_LSB         8
   #define  Si2147_ATV_EXT_AGC_PROP_MAX_10MV_MASK        0xff
   #define  Si2147_ATV_EXT_AGC_PROP_MAX_10MV_DEFAULT    200
    #define Si2147_ATV_EXT_AGC_PROP_MAX_10MV_MAX_10MV_MIN  0
    #define Si2147_ATV_EXT_AGC_PROP_MAX_10MV_MAX_10MV_MAX  255

   /* ATV_EXT_AGC property, MIN_10MV field definition (NO TITLE)*/
   #define  Si2147_ATV_EXT_AGC_PROP_MIN_10MV_LSB         0
   #define  Si2147_ATV_EXT_AGC_PROP_MIN_10MV_MASK        0xff
   #define  Si2147_ATV_EXT_AGC_PROP_MIN_10MV_DEFAULT    50
    #define Si2147_ATV_EXT_AGC_PROP_MIN_10MV_MIN_10MV_MIN  0
    #define Si2147_ATV_EXT_AGC_PROP_MIN_10MV_MIN_10MV_MAX  255

#endif /* Si2147_ATV_EXT_AGC_PROP */

/* Si2147 ATV_HSYNC_OUT property definition */
#define   Si2147_ATV_HSYNC_OUT_PROP 0x0627

#ifdef    Si2147_ATV_HSYNC_OUT_PROP
  #define Si2147_ATV_HSYNC_OUT_PROP_CODE 0x000627


    typedef struct { /* Si2147_ATV_HSYNC_OUT_PROP_struct */
      unsigned char   gpio_sel;
               char   offset;
      unsigned char   width;
   } Si2147_ATV_HSYNC_OUT_PROP_struct;

   /* ATV_HSYNC_OUT property, GPIO_SEL field definition (NO TITLE)*/
   #define  Si2147_ATV_HSYNC_OUT_PROP_GPIO_SEL_LSB         0
   #define  Si2147_ATV_HSYNC_OUT_PROP_GPIO_SEL_MASK        0x03
   #define  Si2147_ATV_HSYNC_OUT_PROP_GPIO_SEL_DEFAULT    0
    #define Si2147_ATV_HSYNC_OUT_PROP_GPIO_SEL_NONE   0
    #define Si2147_ATV_HSYNC_OUT_PROP_GPIO_SEL_GPIO1  1
    #define Si2147_ATV_HSYNC_OUT_PROP_GPIO_SEL_GPIO2  2

   /* ATV_HSYNC_OUT property, OFFSET field definition (NO TITLE)*/
   #define  Si2147_ATV_HSYNC_OUT_PROP_OFFSET_LSB         8
   #define  Si2147_ATV_HSYNC_OUT_PROP_OFFSET_MASK        0xff
   #define  Si2147_ATV_HSYNC_OUT_PROP_OFFSET_DEFAULT    0
    #define Si2147_ATV_HSYNC_OUT_PROP_OFFSET_OFFSET_MIN  -128
    #define Si2147_ATV_HSYNC_OUT_PROP_OFFSET_OFFSET_MAX  127

   /* ATV_HSYNC_OUT property, WIDTH field definition (NO TITLE)*/
   #define  Si2147_ATV_HSYNC_OUT_PROP_WIDTH_LSB         2
   #define  Si2147_ATV_HSYNC_OUT_PROP_WIDTH_MASK        0x3f
   #define  Si2147_ATV_HSYNC_OUT_PROP_WIDTH_DEFAULT    42
    #define Si2147_ATV_HSYNC_OUT_PROP_WIDTH_WIDTH_MIN  0
    #define Si2147_ATV_HSYNC_OUT_PROP_WIDTH_WIDTH_MAX  51

#endif /* Si2147_ATV_HSYNC_OUT_PROP */

/* Si2147 ATV_IEN property definition */
#define   Si2147_ATV_IEN_PROP 0x0601

#ifdef    Si2147_ATV_IEN_PROP
  #define Si2147_ATV_IEN_PROP_CODE 0x000601


    typedef struct { /* Si2147_ATV_IEN_PROP_struct */
      unsigned char   chlien;
      unsigned char   pclien;
   } Si2147_ATV_IEN_PROP_struct;

   /* ATV_IEN property, CHLIEN field definition (NO TITLE)*/
   #define  Si2147_ATV_IEN_PROP_CHLIEN_LSB         0
   #define  Si2147_ATV_IEN_PROP_CHLIEN_MASK        0x01
   #define  Si2147_ATV_IEN_PROP_CHLIEN_DEFAULT    1
    #define Si2147_ATV_IEN_PROP_CHLIEN_DISABLE  0
    #define Si2147_ATV_IEN_PROP_CHLIEN_ENABLE   1

   /* ATV_IEN property, PCLIEN field definition (NO TITLE)*/
   #define  Si2147_ATV_IEN_PROP_PCLIEN_LSB         1
   #define  Si2147_ATV_IEN_PROP_PCLIEN_MASK        0x01
   #define  Si2147_ATV_IEN_PROP_PCLIEN_DEFAULT    0
    #define Si2147_ATV_IEN_PROP_PCLIEN_DISABLE  0
    #define Si2147_ATV_IEN_PROP_PCLIEN_ENABLE   1

#endif /* Si2147_ATV_IEN_PROP */

/* Si2147 ATV_INT_SENSE property definition */
#define   Si2147_ATV_INT_SENSE_PROP 0x0613

#ifdef    Si2147_ATV_INT_SENSE_PROP
  #define Si2147_ATV_INT_SENSE_PROP_CODE 0x000613


    typedef struct { /* Si2147_ATV_INT_SENSE_PROP_struct */
      unsigned char   chlnegen;
      unsigned char   chlposen;
      unsigned char   pclnegen;
      unsigned char   pclposen;
   } Si2147_ATV_INT_SENSE_PROP_struct;

   /* ATV_INT_SENSE property, CHLNEGEN field definition (NO TITLE)*/
   #define  Si2147_ATV_INT_SENSE_PROP_CHLNEGEN_LSB         0
   #define  Si2147_ATV_INT_SENSE_PROP_CHLNEGEN_MASK        0x01
   #define  Si2147_ATV_INT_SENSE_PROP_CHLNEGEN_DEFAULT    0
    #define Si2147_ATV_INT_SENSE_PROP_CHLNEGEN_DISABLE  0
    #define Si2147_ATV_INT_SENSE_PROP_CHLNEGEN_ENABLE   1

   /* ATV_INT_SENSE property, CHLPOSEN field definition (NO TITLE)*/
   #define  Si2147_ATV_INT_SENSE_PROP_CHLPOSEN_LSB         8
   #define  Si2147_ATV_INT_SENSE_PROP_CHLPOSEN_MASK        0x01
   #define  Si2147_ATV_INT_SENSE_PROP_CHLPOSEN_DEFAULT    1
    #define Si2147_ATV_INT_SENSE_PROP_CHLPOSEN_DISABLE  0
    #define Si2147_ATV_INT_SENSE_PROP_CHLPOSEN_ENABLE   1

   /* ATV_INT_SENSE property, PCLNEGEN field definition (NO TITLE)*/
   #define  Si2147_ATV_INT_SENSE_PROP_PCLNEGEN_LSB         1
   #define  Si2147_ATV_INT_SENSE_PROP_PCLNEGEN_MASK        0x01
   #define  Si2147_ATV_INT_SENSE_PROP_PCLNEGEN_DEFAULT    0
    #define Si2147_ATV_INT_SENSE_PROP_PCLNEGEN_DISABLE  0
    #define Si2147_ATV_INT_SENSE_PROP_PCLNEGEN_ENABLE   1

   /* ATV_INT_SENSE property, PCLPOSEN field definition (NO TITLE)*/
   #define  Si2147_ATV_INT_SENSE_PROP_PCLPOSEN_LSB         9
   #define  Si2147_ATV_INT_SENSE_PROP_PCLPOSEN_MASK        0x01
   #define  Si2147_ATV_INT_SENSE_PROP_PCLPOSEN_DEFAULT    1
    #define Si2147_ATV_INT_SENSE_PROP_PCLPOSEN_DISABLE  0
    #define Si2147_ATV_INT_SENSE_PROP_PCLPOSEN_ENABLE   1

#endif /* Si2147_ATV_INT_SENSE_PROP */

/* Si2147 ATV_LIF_FREQ property definition */
#define   Si2147_ATV_LIF_FREQ_PROP 0x060c

#ifdef    Si2147_ATV_LIF_FREQ_PROP
  #define Si2147_ATV_LIF_FREQ_PROP_CODE 0x00060c


    typedef struct { /* Si2147_ATV_LIF_FREQ_PROP_struct */
      unsigned int    offset;
   } Si2147_ATV_LIF_FREQ_PROP_struct;

   /* ATV_LIF_FREQ property, OFFSET field definition (NO TITLE)*/
   #define  Si2147_ATV_LIF_FREQ_PROP_OFFSET_LSB         0
   #define  Si2147_ATV_LIF_FREQ_PROP_OFFSET_MASK        0xffff
   #define  Si2147_ATV_LIF_FREQ_PROP_OFFSET_DEFAULT    5000
    #define Si2147_ATV_LIF_FREQ_PROP_OFFSET_OFFSET_MIN  0
    #define Si2147_ATV_LIF_FREQ_PROP_OFFSET_OFFSET_MAX  7000

#endif /* Si2147_ATV_LIF_FREQ_PROP */

/* Si2147 ATV_LIF_OUT property definition */
#define   Si2147_ATV_LIF_OUT_PROP 0x060d

#ifdef    Si2147_ATV_LIF_OUT_PROP
  #define Si2147_ATV_LIF_OUT_PROP_CODE 0x00060d


    typedef struct { /* Si2147_ATV_LIF_OUT_PROP_struct */
      unsigned char   amp;
      unsigned char   offset;
   } Si2147_ATV_LIF_OUT_PROP_struct;

   /* ATV_LIF_OUT property, AMP field definition (NO TITLE)*/
   #define  Si2147_ATV_LIF_OUT_PROP_AMP_LSB         8
   #define  Si2147_ATV_LIF_OUT_PROP_AMP_MASK        0xff
   #define  Si2147_ATV_LIF_OUT_PROP_AMP_DEFAULT    100
    #define Si2147_ATV_LIF_OUT_PROP_AMP_AMP_MIN  0
    #define Si2147_ATV_LIF_OUT_PROP_AMP_AMP_MAX  255

   /* ATV_LIF_OUT property, OFFSET field definition (NO TITLE)*/
   #define  Si2147_ATV_LIF_OUT_PROP_OFFSET_LSB         0
   #define  Si2147_ATV_LIF_OUT_PROP_OFFSET_MASK        0xff
   #define  Si2147_ATV_LIF_OUT_PROP_OFFSET_DEFAULT    148
    #define Si2147_ATV_LIF_OUT_PROP_OFFSET_OFFSET_MIN  0
    #define Si2147_ATV_LIF_OUT_PROP_OFFSET_OFFSET_MAX  255

#endif /* Si2147_ATV_LIF_OUT_PROP */

/* Si2147 ATV_PGA_TARGET property definition */
#define   Si2147_ATV_PGA_TARGET_PROP 0x0617

#ifdef    Si2147_ATV_PGA_TARGET_PROP
  #define Si2147_ATV_PGA_TARGET_PROP_CODE 0x000617


    typedef struct { /* Si2147_ATV_PGA_TARGET_PROP_struct */
      unsigned char   override_enable;
               char   pga_target;
   } Si2147_ATV_PGA_TARGET_PROP_struct;

   /* ATV_PGA_TARGET property, OVERRIDE_ENABLE field definition (NO TITLE)*/
   #define  Si2147_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_LSB         8
   #define  Si2147_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_MASK        0x01
   #define  Si2147_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_DEFAULT    0
    #define Si2147_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_DISABLE  0
    #define Si2147_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_ENABLE   1

   /* ATV_PGA_TARGET property, PGA_TARGET field definition (NO TITLE)*/
   #define  Si2147_ATV_PGA_TARGET_PROP_PGA_TARGET_LSB         0
   #define  Si2147_ATV_PGA_TARGET_PROP_PGA_TARGET_MASK        0xff
   #define  Si2147_ATV_PGA_TARGET_PROP_PGA_TARGET_DEFAULT    0
    #define Si2147_ATV_PGA_TARGET_PROP_PGA_TARGET_PGA_TARGET_MIN  -13
    #define Si2147_ATV_PGA_TARGET_PROP_PGA_TARGET_PGA_TARGET_MAX  7

#endif /* Si2147_ATV_PGA_TARGET_PROP */

/* Si2147 ATV_RF_TOP property definition */
#define   Si2147_ATV_RF_TOP_PROP 0x0612

#ifdef    Si2147_ATV_RF_TOP_PROP
  #define Si2147_ATV_RF_TOP_PROP_CODE 0x000612


    typedef struct { /* Si2147_ATV_RF_TOP_PROP_struct */
      unsigned char   atv_rf_top;
   } Si2147_ATV_RF_TOP_PROP_struct;

   /* ATV_RF_TOP property, ATV_RF_TOP field definition (NO TITLE)*/
   #define  Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_LSB         0
   #define  Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_MASK        0xff
   #define  Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_DEFAULT    0
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_AUTO   0
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_P2DB   4
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_P1DB   5
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_0DB    6
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_M1DB   7
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_M2DB   8
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_M3DB   9
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_M4DB   10
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_M5DB   11
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_M6DB   12
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_M7DB   13
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_M8DB   14
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_M9DB   15
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_M10DB  16
    #define Si2147_ATV_RF_TOP_PROP_ATV_RF_TOP_M11DB  17

#endif /* Si2147_ATV_RF_TOP_PROP */

/* Si2147 ATV_RSQ_RSSI_THRESHOLD property definition */
#define   Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP 0x0605

#ifdef    Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP
  #define Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_CODE 0x000605


    typedef struct { /* Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_struct */
               char   hi;
               char   lo;
   } Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_struct;

   /* ATV_RSQ_RSSI_THRESHOLD property, HI field definition (NO TITLE)*/
   #define  Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_LSB         8
   #define  Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_MASK        0xff
   #define  Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_DEFAULT    0
    #define Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_HI_MIN  -128
    #define Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_HI_HI_MAX  127

   /* ATV_RSQ_RSSI_THRESHOLD property, LO field definition (NO TITLE)*/
   #define  Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB         0
   #define  Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK        0xff
   #define  Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_DEFAULT    -70
    #define Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_LO_MIN  -128
    #define Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_LO_LO_MAX  127

#endif /* Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP */

/* Si2147 ATV_VIDEO_MODE property definition */
#define   Si2147_ATV_VIDEO_MODE_PROP 0x0604

#ifdef    Si2147_ATV_VIDEO_MODE_PROP
  #define Si2147_ATV_VIDEO_MODE_PROP_CODE 0x000604


    typedef struct { /* Si2147_ATV_VIDEO_MODE_PROP_struct */
      unsigned char   color;
      unsigned char   invert_spectrum;
      unsigned char   video_sys;
   } Si2147_ATV_VIDEO_MODE_PROP_struct;

   /* ATV_VIDEO_MODE property, COLOR field definition (NO TITLE)*/
   #define  Si2147_ATV_VIDEO_MODE_PROP_COLOR_LSB         4
   #define  Si2147_ATV_VIDEO_MODE_PROP_COLOR_MASK        0x01
   #define  Si2147_ATV_VIDEO_MODE_PROP_COLOR_DEFAULT    0
    #define Si2147_ATV_VIDEO_MODE_PROP_COLOR_PAL_NTSC  0
    #define Si2147_ATV_VIDEO_MODE_PROP_COLOR_SECAM     1

   /* ATV_VIDEO_MODE property, INVERT_SPECTRUM field definition (NO TITLE)*/
   #define  Si2147_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_LSB         9
   #define  Si2147_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_MASK        0x01
   #define  Si2147_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_DEFAULT    1
    #define Si2147_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_NORMAL    0
    #define Si2147_ATV_VIDEO_MODE_PROP_INVERT_SPECTRUM_INVERTED  1

   /* ATV_VIDEO_MODE property, VIDEO_SYS field definition (NO TITLE)*/
   #define  Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_LSB         0
   #define  Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_MASK        0x07
   #define  Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_DEFAULT    0
    #define Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_B   0
    #define Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_GH  1
    #define Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_M   2
    #define Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_N   3
    #define Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_I   4
    #define Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_DK  5
    #define Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_L   6
    #define Si2147_ATV_VIDEO_MODE_PROP_VIDEO_SYS_LP  7

#endif /* Si2147_ATV_VIDEO_MODE_PROP */

/* Si2147 ATV_VSNR_CAP property definition */
#define   Si2147_ATV_VSNR_CAP_PROP 0x0616

#ifdef    Si2147_ATV_VSNR_CAP_PROP
  #define Si2147_ATV_VSNR_CAP_PROP_CODE 0x000616


    typedef struct { /* Si2147_ATV_VSNR_CAP_PROP_struct */
      unsigned char   atv_vsnr_cap;
   } Si2147_ATV_VSNR_CAP_PROP_struct;

   /* ATV_VSNR_CAP property, ATV_VSNR_CAP field definition (NO TITLE)*/
   #define  Si2147_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_LSB         0
   #define  Si2147_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_MASK        0xff
   #define  Si2147_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_DEFAULT    0
    #define Si2147_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_ATV_VSNR_CAP_MIN  0
    #define Si2147_ATV_VSNR_CAP_PROP_ATV_VSNR_CAP_ATV_VSNR_CAP_MAX  127

#endif /* Si2147_ATV_VSNR_CAP_PROP */
...
#define   Si2147_DTV_CONFIG_IF_PORT_PROP 0x0702
  ...
  #define Si2147_DTV_CONFIG_IF_PORT_PROP_CODE 0x000702
   ...
   #define  Si2147_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_DEFAULT    1
...
/* Si2147 WIDE_BAND_ATT_THRS property definition */
#define   Si2147_WIDE_BAND_ATT_THRS_PROP 0x0503

#ifdef    Si2147_WIDE_BAND_ATT_THRS_PROP
  #define Si2147_WIDE_BAND_ATT_THRS_PROP_CODE 0x000503


    typedef struct { /* Si2147_WIDE_BAND_ATT_THRS_PROP_struct */
      unsigned char   wb_att_thrs;
   } Si2147_WIDE_BAND_ATT_THRS_PROP_struct;

   /* WIDE_BAND_ATT_THRS property, WB_ATT_THRS field definition (NO TITLE)*/
   #define  Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_LSB         0
   #define  Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_MASK        0xff
   #define  Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_DEFAULT    0
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_AUTO    0
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_P6DBM    6
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_P5DBM    7
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_P4DBM    8
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_P3DBM    9
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_P2DBM    10
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_P1DBM    11
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_0DBM    12
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M1DBM   13
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M2DBM   14
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M3DBM   15
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M4DBM   16
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M5DBM   17
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M6DBM   18
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M7DBM   19
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M8DBM   20
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M9DBM   21
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M10DBM  22
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M11DBM  23
    #define Si2147_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_M12DBM  24

#endif /* Si2147_WIDE_BAND_ATT_THRS_PROP */
...
/* _properties_struct_insertion_start */
  ...
  typedef struct {
    #ifdef    Si2147_ATV_AFC_RANGE_PROP
              Si2147_ATV_AFC_RANGE_PROP_struct                 atv_afc_range;
    #endif /* Si2147_ATV_AFC_RANGE_PROP */
    #ifdef    Si2147_ATV_AGC_SPEED_PROP
              Si2147_ATV_AGC_SPEED_PROP_struct                 atv_agc_speed;
    #endif /* Si2147_ATV_AGC_SPEED_PROP */
    #ifdef    Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP
              Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP_struct        atv_agc_speed_low_rssi;
    #endif /* Si2147_ATV_AGC_SPEED_LOW_RSSI_PROP */
    #ifdef    Si2147_ATV_ARTIFICIAL_SNOW_PROP
              Si2147_ATV_ARTIFICIAL_SNOW_PROP_struct           atv_artificial_snow;
    #endif /* Si2147_ATV_ARTIFICIAL_SNOW_PROP */
    #ifdef    Si2147_ATV_CONFIG_IF_PORT_PROP
              Si2147_ATV_CONFIG_IF_PORT_PROP_struct            atv_config_if_port;
    #endif /* Si2147_ATV_CONFIG_IF_PORT_PROP */
    #ifdef    Si2147_ATV_EXT_AGC_PROP
              Si2147_ATV_EXT_AGC_PROP_struct                   atv_ext_agc;
    #endif /* Si2147_ATV_EXT_AGC_PROP */
    #ifdef    Si2147_ATV_HSYNC_OUT_PROP
              Si2147_ATV_HSYNC_OUT_PROP_struct                 atv_hsync_out;
    #endif /* Si2147_ATV_HSYNC_OUT_PROP */
    #ifdef    Si2147_ATV_IEN_PROP
              Si2147_ATV_IEN_PROP_struct                       atv_ien;
    #endif /* Si2147_ATV_IEN_PROP */
    #ifdef    Si2147_ATV_INT_SENSE_PROP
              Si2147_ATV_INT_SENSE_PROP_struct                 atv_int_sense;
    #endif /* Si2147_ATV_INT_SENSE_PROP */
    #ifdef    Si2147_ATV_LIF_FREQ_PROP
              Si2147_ATV_LIF_FREQ_PROP_struct                  atv_lif_freq;
    #endif /* Si2147_ATV_LIF_FREQ_PROP */
    #ifdef    Si2147_ATV_LIF_OUT_PROP
              Si2147_ATV_LIF_OUT_PROP_struct                   atv_lif_out;
    #endif /* Si2147_ATV_LIF_OUT_PROP */
    #ifdef    Si2147_ATV_PGA_TARGET_PROP
              Si2147_ATV_PGA_TARGET_PROP_struct                atv_pga_target;
    #endif /* Si2147_ATV_PGA_TARGET_PROP */
    #ifdef    Si2147_ATV_RF_TOP_PROP
              Si2147_ATV_RF_TOP_PROP_struct                    atv_rf_top;
    #endif /* Si2147_ATV_RF_TOP_PROP */
    #ifdef    Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP
              Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP_struct        atv_rsq_rssi_threshold;
    #endif /* Si2147_ATV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef    Si2147_ATV_VIDEO_MODE_PROP
              Si2147_ATV_VIDEO_MODE_PROP_struct                atv_video_mode;
    #endif /* Si2147_ATV_VIDEO_MODE_PROP */
    #ifdef    Si2147_ATV_VSNR_CAP_PROP
              Si2147_ATV_VSNR_CAP_PROP_struct                  atv_vsnr_cap;
    #endif /* Si2147_ATV_VSNR_CAP_PROP */
    #ifdef    Si2147_CRYSTAL_TRIM_PROP
    ...
    #endif /* Si2147_TUNER_RETURN_LOSS_PROP */
    #ifdef    Si2147_WIDE_BAND_ATT_THRS_PROP
              Si2147_WIDE_BAND_ATT_THRS_PROP_struct            wide_band_att_thrs;
    #endif /* Si2147_WIDE_BAND_ATT_THRS_PROP */
    #ifdef    Si2147_XOUT_PROP
