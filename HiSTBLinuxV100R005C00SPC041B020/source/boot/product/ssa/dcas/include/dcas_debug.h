...
#ifndef __DCAS_DEBUG_H__
#define __DCAS_DEBUG_H__
...
#if SSA_D_LOG_ENABLE
#define SSA_DEBUG(pszFormat...)             printf("[%s][%u]", __FUNCTION__, __LINE__);printf(pszFormat)
#define SSA_INFO(pszFormat...)              printf("[%s][%u]", __FUNCTION__, __LINE__);printf(pszFormat)
#define SSA_WARN(pszFormat...)              printf("[%s][%u]", __FUNCTION__, __LINE__);printf(pszFormat)
#define SSA_ERROR(pszFormat...)             printf("[%s][%u]", __FUNCTION__, __LINE__);printf(pszFormat)
#define SSA_FATAL(pszFormat...)             printf("[%s][%u]", __FUNCTION__, __LINE__);printf(pszFormat)
#define SSA_PRINT(pszFormat...)             printf(pszFormat)
#else
