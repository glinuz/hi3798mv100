...
void cdc_eth_before_probe(void);
int cdc_eth_probe(struct usb_device *dev, unsigned int ifnum,
		      struct ueth_data *ss);
int cdc_eth_get_info(struct usb_device *dev, struct ueth_data *ss,
		      struct eth_device *eth);
