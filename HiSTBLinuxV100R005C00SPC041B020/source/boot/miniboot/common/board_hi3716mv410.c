...
static int hi3716mv410_phyinf[] = {/* array index is the hw config */
	[0] = ETH_PHY_MII,
	[1] = ETH_PHY_RMII,
	[3] = ETH_PHY_UNKNOWN,
};
...
static void set_hi3716mv410_eth_phyintf(void)
{
	uint32 regval;
	uint32 phy0intf;
	...
	snprintf(eth_config.phyintf, sizeof(eth_config.phyintf), "%s,%s",
		 ethphy_intfname(hi3716mv410_phyinf[phy0intf]),
		 "none");
}
