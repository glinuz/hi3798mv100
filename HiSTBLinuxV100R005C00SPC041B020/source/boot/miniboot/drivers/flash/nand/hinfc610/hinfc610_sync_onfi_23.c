...
static int hinfc610_onfi_enable_sync(struct hinfc_host *host)
{
...
static int hinfc610_onfi_disable_sync(struct hinfc_host *host)
{
	unsigned char micron_sync_param[4] = {
		0x00, 0x00, 0x00, 0x00,
	};
