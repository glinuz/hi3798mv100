...
static void config_allocate( void )
{
    int i, usage_length = 0;
     ...
     dfb_config->mmx                      = true;
     dfb_config->vt                       = false;  //default no Virtual Terminal
     dfb_config->vt_num                   = -1;
     dfb_config->vt_switch                = false;  //default no Virtual Terminal
     dfb_config->vt_switching             = false;  //default no Virtual Terminal
