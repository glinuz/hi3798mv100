...
HI_IR_MAP g_stIrMap[HI_KEY_NUM] =
{
	...
	{0x2dd2ff00, HI_KEY_DOWN},
	{0x6699ff00, HI_KEY_LEFT},
	{0x3ec1ff00, HI_KEY_RIGHT},
	{0x31ceff00, HI_KEY_ENTER}, //ok
...
HI_IR_MAPENTRY g_stIrArray[HI_KEY_NUM] =
{
...
static void* keyboardEventThread( DirectThread *thread, void *driver_data )
{
	...
	while ( pstData)
	{
		...
		for(i = 0; i < HI_KEY_NUM; i++)
		{
			if(g_stIrMap[i].s32Code == pu64KeyId )
			{
