...
typedef struct GNU_PACKED _TXWI_XMAC {
	...
	UINT32 AMPDU:1;
	UINT32 MpduDensity:3;
	UINT32 txop:2;		/*FOR "THIS" frame. 0:HT TXOP rule , 1:PIFS TX ,2:Backoff,
						3:sifs only when previous frame exchange is successful. */
	UINT32 NDPSndRate:2;	/* 0 : MCS0, 1: MCS8, 2: MCS16, 3: reserved */
	UINT32 NDPSndBW:1;	/* NDP sounding BW */
	UINT32 Autofallback:1;	/* TX rate auto fallback disable */
	UINT32 TXRPT:1;
...
/* GeK: no 0x2A4~0x2AC CR defined in MT7662_E5_TOP_MAC_REG, while 0x02B0 now is
 * SEMAPHORE_00, NOT HT_MAC_BSSID_DW1.
 */
