...
static void _DtvCC_DelayTimerCallback(HI_U32 u32Param)
{
    HI_U8 u8ModuleId = (HI_U8)u32Param;
...
{
    HI_U32 u32ModuleID = (HI_U32)u8ModuleID;
    (HI_VOID)CCTimer_Open(CCTIMER_ID_708DELAY, _DtvCC_DelayTimerCallback, u32ModuleID);
}
...
static inline HI_VOID _DtvCC_EndPacket(HI_VOID)
{
    ...
    {
        memset(pstPacket->au8PacketData,0,sizeof(pstPacket->au8PacketData));
