...
/* BEGIN_SME: Added by liurongliang(l00180035), issue_002, 2014/11/29 */
int ff_hevc_decode_extradata(void* ctx);
int ff_hevc_get_resolution_and_pixfmt(void* ctx, int* width, int* height, int* pixfmt);
/* END:   Added by liurongliang(l00180035), 2014/11/29 */
