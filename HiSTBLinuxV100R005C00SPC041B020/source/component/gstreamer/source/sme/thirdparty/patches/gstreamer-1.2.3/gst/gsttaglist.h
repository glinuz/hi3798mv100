 ...
 *
 * Information about the sample rate of audio track
 *
 */
#define GST_TAG_AUDIO_SAMPLERATE                  "audio-samplerate"
/**
 * GST_TAG_AUDIO_CHANNELNUM:
 *
 * Information about the channel numbers of audio track
 *
 */
#define GST_TAG_AUDIO_CHANNELNUM                  "audio-channelnum"
