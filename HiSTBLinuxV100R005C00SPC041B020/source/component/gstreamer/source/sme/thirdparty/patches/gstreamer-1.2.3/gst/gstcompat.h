...
/*
 * Caps is referenced in "gst_event_new_caps":
 *  it will increase the reference count of the mini-object(GstCaps * caps).
 *  See function gst_mini_object_ref() in gstminiobject.c
 */
