...
//#define GST_AUDIO_DECODER_MULTI_OUTPUT
...
#if defined (GST_AUDIO_DECODER_MULTI_OUTPUT)
GstFlowReturn     gst_audio_decoder_pad_output (GstAudioDecoder * dec,
                                                GstPad *pad,
                                                GstBuffer * buf,
                                                gint frames);

gboolean          gst_audio_decoder_default_src_query (GstPad * pad,
                                                       GstObject * parent,
                                                       GstQuery * query);

gboolean          gst_audio_decoder_default_src_event (GstPad * pad,
                                                       GstObject * parent,
                                                       GstEvent * event);
#endif
