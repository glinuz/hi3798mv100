...
enum AVCodecID {
    ...
    AV_CODEC_ID_BLURAY_MVCD= MKBETAG('M','V','C','D'),
    AV_CODEC_ID_BLURAY_MVC = MKBETAG('M','V','C','0'),
...
#define AV_CODEC_ID_H265 AV_CODEC_ID_HEVC
    ...
    AV_CODEC_ID_DRA        = MKBETAG('D','R','A','1'),
    ...
    AV_CODEC_ID_TTML       = MKBETAG('T','T','M','L'),
...
// BEGIN_SME
/** BEGIN: Added for DTS2015082904200  by baihaili(b00311320), issue_030, 2015/8/29 */
#define AV_PKT_FLAG_CODEC_CHANGED 0x0004 ///< The packet codec is changed
/* END:   Added by baihaili(b00311320), 2015/8/29 */

#define AV_PKT_FLAG_I_FRAME_NOT_IDR     0x0008 ///< The packet contains a I frame, but not IDR frame.
// END_SME
...
#define FF_COMPRESSION_DEFAULT -1
    ...
    /** BEGIN_SME: Added for DTS2015082904200  by baihaili(b00311320), 2015/8/29 */
    int extradata_changed_flag;
    /* END_SME:   Added by baihaili(b00311320), 2015/8/29 */
...
#define FF_CODEC_PROPERTY_CLOSED_CAPTIONS 0x00000002
    /* changed: */
    /*! Raw m1v or m2v I frame time stamp */
    int64_t dwIframeTimeStamp;
    /*! Raw m1v or m2v last time stamp */
