...
_priv_gst_tag_initialize (void)
{
  ...
  gst_tag_register_static (GST_TAG_AUDIO_SAMPLERATE, GST_TAG_FLAG_META,
      G_TYPE_UINT,
      _("audio-samplerate"),
      _("Information about the sample rate of audio track"),
      NULL);
  gst_tag_register_static (GST_TAG_AUDIO_CHANNELNUM, GST_TAG_FLAG_META,
      G_TYPE_UINT,
      _("audio-channelnum"),
      _("Information about the channel numbers of audio track"),
      NULL);
}
