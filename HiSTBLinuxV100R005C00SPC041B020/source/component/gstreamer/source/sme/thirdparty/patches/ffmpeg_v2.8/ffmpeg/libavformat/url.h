...
typedef struct URLContext {
    ...
    char *moved_url;            /**< added by hisi, 302 Moved Temporarily keep host name string */
    void *parent;               /**< added by hisi, record parent context */
    int flags;
 ...
 * report the event.
 */
int ff_report_event(AVIOInterruptCB *cb, int event, void *param);
