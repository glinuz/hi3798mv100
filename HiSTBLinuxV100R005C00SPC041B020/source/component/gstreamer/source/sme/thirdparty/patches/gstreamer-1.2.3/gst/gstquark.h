...
typedef enum _GstQuarkId
{
  ...
  GST_QUARK_MESSAGE_NEW_BANDWIDTH = 170,
  GST_QUARK_BANDWIDTH = 171,
  GST_QUARK_RESOLUTION = 172,
  GST_QUARK_WIDTH = 173,
  GST_QUARK_HEIGHT = 174,
  GST_QUARK_MESSAGE_NEW_HTTP_ERR = 175,
  GST_QUARK_STATUS_CODE = 176,
  GST_QUARK_MAX = 177,
} GstQuarkId;
