...
LOCAL_MODULE := libsme_gst_benchmark

LOCAL_SRC_FILES := sme_benchmark.cpp
...
LOCAL_C_INCLUDES += $(TOPDIR)/source/sme/source/osal/inc \
    ...
    $(TOPDIR)/source/sme/source/player \
    $(TOPDIR)/source/sme/source/plugins/common

ifeq ($(CFG_ENABLE_DVB), y)
LOCAL_C_INCLUDES += $(TOPDIR)/source/sme/source/dvbplayer
LOCAL_CFLAGS += -D_SUPPORT_SME_DVBPLAYER
LOCAL_CPPFLAGS += -D_SUPPORT_SME_DVBPLAYER
endif
