...
else ifeq ($(CFG_PROJECT_NAME), HiSTBLinux.$(CFG_HI_CHIP_TYPE))
SDK_DIR := $(TOPDIR)/$(CFG_RT_HI_SDK_DIR)
-include $(SDK_DIR)/base.mak
endif
...
ifneq ($(CFG_PROJECT_NAME), HiSTBLinux.$(CFG_HI_CHIP_TYPE))
...
ifeq ($(CFG_PROJECT_NAME), HiSTBLinux.$(CFG_HI_CHIP_TYPE))
