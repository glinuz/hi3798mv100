...
static struct of_dev_auxdata hi3716mv410_auxdata_lookup[] __initdata = {
...
static int __init hi3716mv410_device_tree_init(void)
{
	of_platform_populate(NULL, of_default_bus_match_table, hi3716mv410_auxdata_lookup, NULL);
	return 0;
}
postcore_initcall(hi3716mv410_device_tree_init);
