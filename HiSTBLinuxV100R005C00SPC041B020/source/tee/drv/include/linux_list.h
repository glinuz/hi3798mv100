 ...
 */
 INLINE void __list_add(struct list_head * const pstrunew,
 ...
 */
 INLINE void list_add(struct list_head * const pstrunew, struct list_head *head)
{
 ...
 */
 INLINE void list_add_tail(struct list_head * const pstrunew, struct list_head *head)
{
 ...
 */
 INLINE int list_empty(struct list_head const * const head)
{
    return (head->next == head);
}

 INLINE void __list_splice(const struct list_head * const list,
 ...
 */
 INLINE void list_splice(const struct list_head * const list,
                            struct list_head * const head)
{
    if (!list_empty(list))
