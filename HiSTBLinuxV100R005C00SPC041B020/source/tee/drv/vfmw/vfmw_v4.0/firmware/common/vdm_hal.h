...
typedef struct hiVDMHAL_FUN_PTR_S
{
    ...
    VOID (*pfun_VDMHAL_GetHalMemSize)(VDMHAL_MEM_SIZE_S *pVDMHALMemSize);
...
#define VDMHAL_GetHalMemSize(pVDMHLMemSize) \
	(g_vdm_hal_fun_ptr.pfun_VDMHAL_GetHalMemSize? \
		g_vdm_hal_fun_ptr.pfun_VDMHAL_GetHalMemSize(pVDMHLMemSize): \
		VDMHAL_NULL_FUN_PTR)
