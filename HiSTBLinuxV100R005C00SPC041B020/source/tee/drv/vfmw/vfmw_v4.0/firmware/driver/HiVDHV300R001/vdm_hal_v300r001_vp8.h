...
fg7WZI21mDg3zZP5SApPdA9JQPldVSTFjsh6rqxsfUXBCTWLt2pK0xyLfEURKZrbZpOo6ma/
TYP03wTzUWekoE5iby94YBz46U/yDCutiUdyclZ+uPH8wgUEai2KPkbnEI7Iiw==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
...
#ifndef __VDM_HAL_V300R001_VP8_HERAER__
#define __VDM_HAL_V300R001_VP8_HERAER__
...
typedef struct  {
    ...
    USIGN reserved:                             29;
} VP8_V300R001_PICDNMSG_D0;

typedef struct  {
	USIGN use_bilinear_mc_filter:                1;
	USIGN full_pixel:                            1;
    USIGN reserved:                             30;
} VP8_V300R001_PICDNMSG_D1;
...
typedef struct  {
    ...
    USIGN reserved:                              7;
} VP8_V300R001_PICDNMSG_D6;

typedef struct {
	USIGN base_qindex:							 7;
	USIGN reserved:                              25;
} VP8_V300R001_PICDNMSG_D7;


typedef struct {
	USIGN value:                              	32;
} VP8_V300R001_PICDNMSG_D8;
...
typedef struct  {
    ...
    USIGN count:                                 6;
	USIGN reserved1:                            10;
} VP8_V300R001_PICDNMSG_D9;


typedef struct  {
    USIGN bit_len_0:                           25;
    USIGN bit_offset_0:                         7;
} VP8_V300R001_PICDNMSG_D16;

typedef struct  {
    USIGN bit_stream_addr_0:                   24;
    USIGN reserved:                             8;
} VP8_V300R001_PICDNMSG_D17;

typedef struct  {
    USIGN bit_len_1:                           25;
    USIGN bit_offset_1:                        7;
} VP8_V300R001_PICDNMSG_D18;

typedef struct  {
    USIGN bit_stream_addr_1:                   24;
    USIGN reserved:                             8;
} VP8_V300R001_PICDNMSG_D19;
...
} VP8_V300R001_PICDNMSG_D24;

typedef struct  {
    USIGN curr_rcn_addr:                        32;
} VP8_V300R001_PICDNMSG_D32;                                 

typedef struct  {
    USIGN alt_ref_addr:                         32;
} VP8_V300R001_PICDNMSG_D33;

typedef struct  {
    USIGN golden_ref_addr:                      32;
} VP8_V300R001_PICDNMSG_D34;

typedef struct  {
    USIGN last_ref_addr:                        32;
} VP8_V300R001_PICDNMSG_D35;

typedef struct  {
    USIGN sed_top_addr:                         32;
} VP8_V300R001_PICDNMSG_D36;

typedef struct  {
    USIGN pmv_top_addr:                         32;
} VP8_V300R001_PICDNMSG_D37;

typedef struct  {
    USIGN rcn_top_addr:                         32;
} VP8_V300R001_PICDNMSG_D38;

typedef struct  {
    USIGN tab_addr:                             32;
} VP8_V300R001_PICDNMSG_D39;

typedef struct {
	USIGN dblk_top_addr:                        32;
} VP8_V300R001_PICDNMSG_D40;
...
typedef struct  {
    USIGN bitn_len:                          	25;
    USIGN bitn_offset:                        	7;
} VP8_V300R001_BITSTREAM_LEN_OFFSET;

typedef struct  {
    USIGN bitn_stream_addr:                  	24;
    USIGN reserved:                             8;
} VP8_V300R001_BITSTREAM_ADDR;
...
SINT32 VP8HAL_V300R001_InitHal(SINT32 CodeTabAddr);
SINT32 VP8HAL_V300R001_CfgReg(VP8_DEC_PARAM_S *pVp8DecParam, VDMHAL_HWMEM_S *pHwMem , SINT32 VdhId);
SINT32 VP8HAL_V300R001_StartDec(VP8_DEC_PARAM_S *pVp8DecParam, SINT32 VdhId);
SINT32 VP8HAL_V300R001_CfgDnMsg(VP8_DEC_PARAM_S *pVp8DecParam, VDMHAL_HWMEM_S *pHwMem, SINT32 VdhId);
#ifdef __cplusplus
}
#endif
