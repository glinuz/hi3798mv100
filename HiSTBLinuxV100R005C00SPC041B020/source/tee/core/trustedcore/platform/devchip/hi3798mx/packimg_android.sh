...
TASK_GLOBAL_PATH=${IMG_PATH}/${TASK_GLOBAL_NAME}_intermediates/${TASK_GLOBAL_NAME}
...
if [ $SUPPORT_HISI_DEMO -gt 0 ];then
	...
	TASK_HISI_DEMO_PATH=${IMG_PATH}/${TASK_HISI_DEMO_NAME%.*}_intermediates/${TASK_HISI_DEMO_NAME}
...
if [ $SUPPORT_SEC_MMZ -gt 0 ];then
	...
	TASK_SEC_MMZ_PATH=${IMG_PATH}/${TASK_SEC_MMZ_NAME%.*}_intermediates/${TASK_SEC_MMZ_NAME}
...
if [ $SUPPORT_HDMI -gt 0 ];then
	...
	TASK_HDMI_PATH=${IMG_PATH}/${TASK_HDMI_NAME%.*}_intermediates/${TASK_HDMI_NAME}
...
if [ $SUPPORT_VFMW -gt 0 ];then
	...
	TASK_HISI_VFMW_PATH=${IMG_PATH}/${TASK_HISI_VFMW_NAME%.*}_intermediates/${TASK_HISI_VFMW_NAME}
...
if [ $SUPPORT_VPSS -gt 0 ];then
	...
	TASK_HISI_VPSS_PATH=${IMG_PATH}/${TASK_HISI_VPSS_NAME%.*}_intermediates/${TASK_HISI_VPSS_NAME}
...
if [ $SUPPORT_SMMU -gt 0 ];then
	...
	TASK_SMMU_PATH=${IMG_PATH}/${TASK_SMMU_NAME%.*}_intermediates/${TASK_SMMU_NAME}
...
if [ $SUPPORT_HISI_TEST -gt 0 ];then
	...
	TASK_HISI_TEST_PATH=${IMG_PATH}/${TASK_HISI_TEST_NAME%.*}_intermediates/${TASK_HISI_TEST_NAME}
...
if [ $SUPPORT_DMX -gt 0 ];then
	...
	TASK_DMX_UUID="10101010101010101010101010101010"
        TASK_DMX_PATH=${IMG_PATH}/${TASK_DMX_NAME%.*}_intermediates/${TASK_DMX_NAME}
...
if [ $SUPPORT_PVR -gt 0 ];then
	...
	TASK_HISI_PVR_UUID="11111111111111111111111111111111"
        TASK_HISI_PVR_PATH=${IMG_PATH}/${TASK_HISI_PVR_NAME%.*}_intermediates/${TASK_HISI_PVR_NAME}
...
if [ $SUPPORT_WIDEVINE -gt 0 ];then
	...
	TASK_WIDEVINE_PATH=${IMG_PATH}/${TASK_WIDEVINE_NAME%.*}_intermediates/${TASK_WIDEVINE_NAME}
...
if [ $SUPPORT_HISI_VDP -gt 0 ];then
	...
	TASK_HISI_VDP_PATH=${IMG_PATH}/${TASK_HISI_VDP_NAME%.*}_intermediates/${TASK_HISI_VDP_NAME}
...
if [ $SUPPORT_VMX_ULTRA -gt 0 ];then
        ...
        TASK_STB_VMX_ULTRA_VMXTA_PATH=${IMG_PATH}/${TASK_STB_VMX_ULTRA_VMXTA_NAME%.*}_intermediates/${TASK_STB_VMX_ULTRA_VMXTA_NAME}
        ...
        TASK_STB_VMX_ULTRA_VIDEOMARKTA_PATH=${IMG_PATH}/${TASK_STB_VMX_ULTRA_VIDEOMARKTA_NAME%.*}_intermediates/${TASK_STB_VMX_ULTRA_VIDEOMARKTA_NAME}
...
if [ $SUPPORT_VMX_ULTRA_VMXTAC_TEST -gt 0 ];then
        ...
        TASK_STB_VMX_ULTRA_CLIENTID2TA_PATH=${IMG_PATH}/${TASK_STB_VMX_ULTRA_CLIENTID2TA_NAME%.*}_intermediates/${TASK_STB_VMX_ULTRA_CLIENTID2TA_NAME}
        ...
        TASK_STB_VMX_ULTRA_CLIENTID3TA_PATH=${IMG_PATH}/${TASK_STB_VMX_ULTRA_CLIENTID3TA_NAME%.*}_intermediates/${TASK_STB_VMX_ULTRA_CLIENTID3TA_NAME}
...
TASK_GLOBAL_ELF=${IMG_PATH}/${TASK_GLOBAL_NAME}_intermediates/${TASK_GLOBAL_NAME}.elf
GLOBAL_SYMTAB_OFFSET=$(ls -l ${TASK_GLOBAL_PATH}| awk '{print $5}')
${ANDROID_PRODUCT_OUT}/elf_extract "globaltask" ${TASK_GLOBAL_ELF} ${TASK_GLOBAL_PATH}
...
rm ${KERNEL_PATH}
rm ${IMG_PATH}/${TASK_GLOBAL_NAME}_intermediates/${TASK_GLOBAL_NAME}
