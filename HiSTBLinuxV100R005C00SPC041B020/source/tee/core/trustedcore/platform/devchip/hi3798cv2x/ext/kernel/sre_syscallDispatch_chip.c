...
#ifdef WITH_HISI_AVPLAY
        SYSCALL_PERMISSION(SW_SYSCALL_AVPLAY_REE_TO_TEE_MEMCPY, permissions, GENERAL_GROUP_PERMISSION)
            uwRet = TEE_DRV_AVPLAY_Ree2TeeMemCopy((HI_U32)regs->r0, (HI_U32)regs->r1, (HI_U32)regs->r2);
            regs->r0 = uwRet;
            SYSCALL_END;
#endif
