...
// History       :  fangqiubin 00179307 2016/01/20 11:29:39 Create file
// ******************************************************************************
...
typedef struct
{
    ...
    volatile unsigned int           reserved_6[9]                     ; /* 0x13c~0x15c */
    volatile U_PERI_TIANLA_ADAC2    PERI_TIANLA_ADAC2        ; /* 0x160 */
    volatile unsigned int           reserved_7[20]                     ; /* 0x164~0x1b0 */
